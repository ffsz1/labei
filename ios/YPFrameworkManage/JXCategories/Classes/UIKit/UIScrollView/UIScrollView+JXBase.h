...
typedef NS_ENUM(NSInteger, JXUIScrollViewScrollDirection) { ///<
    JXUIScrollViewScrollDirectionVertical,
    JXUIScrollViewScrollDirectionHorizontal
};

@interface UIScrollView (JXBase)
 ...
 */
@property (nonatomic, readonly) UIEdgeInsets jx_contentInset;

/**
 显示滚动指示器(同时设置Horizontal及Vertical指示器)
 */
@property (nonatomic, assign) BOOL jx_showsScrollIndicator;

@property (nonatomic, readonly) BOOL jx_isScrolledToTop;    ///< 是否已滑动至顶部
@property (nonatomic, readonly) BOOL jx_isScrolledToLeft;   ///< 是否已滑动至左边
@property (nonatomic, readonly) BOOL jx_isScrolledToBottom; ///< 是否已滑动至底部
@property (nonatomic, readonly) BOOL jx_isScrolledToRight;  ///< 是否已滑动至右边
