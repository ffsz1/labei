//
//  NSObject+JXKeyValueObserving.h
//  Pods
//
...
@interface NSObject (JXKeyValueObserving)
...
/**
 停止并释放KeyPath对应的所有KVO回调事件(通过jx_addObserverBlockForKeyPath:block:添加)
...
/**
 停止并释放所有KVO回调事件(通过jx_addObserverBlockForKeyPath:block:添加)
 */
