//
//  NSAttributedString+JXParagraphStyleAttributes.h
//  Pods
//
...
@interface NSAttributedString (JXParagraphStyleAttributes)
 ...
 */
- (BOOL)jx_allowsDefaultTighteningForTruncationAtIndex:(NSUInteger)index NS_AVAILABLE(10_11, 9_0);

@end


@interface NSMutableAttributedString (JXParagraphStyleAttributes)
...
/**
 ...
 @param range 设置范围
 */
- (void)jx_setAllowsDefaultTighteningForTruncation:(BOOL)allowsDefaultTighteningForTruncation range:(NSRange)range NS_AVAILABLE(10_11, 9_0);
...
/**
 ...
 @param allowsDefaultTighteningForTruncation 默认收缩字符间距允许截断值
 */
- (void)jx_setAllowsDefaultTighteningForTruncation:(BOOL)allowsDefaultTighteningForTruncation NS_AVAILABLE(10_11, 9_0);
...
/**
 ...
 @param range 设置范围
 */
- (void)jx_addAllowsDefaultTighteningForTruncation:(BOOL)allowsDefaultTighteningForTruncation range:(NSRange)range NS_AVAILABLE(10_11, 9_0);
...
/**
 ...
 @param allowsDefaultTighteningForTruncation 默认收缩字符间距允许截断值
 */
- (void)jx_addAllowsDefaultTighteningForTruncation:(BOOL)allowsDefaultTighteningForTruncation NS_AVAILABLE(10_11, 9_0);
...
/**
 ...
 @param range 移除范围
 */
- (void)jx_removeAllowsDefaultTighteningForTruncationInRange:(NSRange)range NS_AVAILABLE(10_11, 9_0);

/**
 移除NSMutableAttributedString的ParagraphStyle的默认收缩字符间距允许截断属性(默认值)
 */
- (void)jx_removeAllowsDefaultTighteningForTruncation NS_AVAILABLE(10_11, 9_0);
