...
#import "NSParagraphStyle+JXBase.h"
#import <CoreText/CoreText.h>

@implementation NSParagraphStyle (JXBase)

#pragma mark - Base
+ (NSParagraphStyle *)jx_paragraphstyleWithCTParagraphStyle:(CTParagraphStyleRef)CTParagraphStyle {
...
+ (instancetype)jx_paragraphStyleWithLineHeight:(CGFloat)lineHeight {
        return [self jx_paragraphStyleWithLineHeight:lineHeight lineBreakMode:NSLineBreakByWordWrapping textAlignment:NSTextAlignmentLeft];
}

+ (instancetype)jx_paragraphStyleWithLineHeight:(CGFloat)lineHeight lineBreakMode:(NSLineBreakMode)lineBreakMode {
        return [self jx_paragraphStyleWithLineHeight:lineHeight lineBreakMode:lineBreakMode textAlignment:NSTextAlignmentLeft];
}

+ (instancetype)jx_paragraphStyleWithLineHeight:(CGFloat)lineHeight lineBreakMode:(NSLineBreakMode)lineBreakMode textAlignment:(NSTextAlignment)textAlignment {
...
@implementation NSMutableParagraphStyle (JXBase)
