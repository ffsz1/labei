...
@implementation NSData (JXCrypto)

#pragma mark - Base64
static const char jx_base64EncodingTable[64] // char -> 1字节
= "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

static const short jx_base64DecodingTable[256] = // short -> 2字节(32位/64位机器)
{
...
- (NSString *)jx_base64EncodedString {
    ...
    for (i = 0; i < length; i += 3) {
        ...
        output[index + 0] = jx_base64EncodingTable[(value >> 18) & 0x3F];
        output[index + 1] = jx_base64EncodingTable[(value >> 12) & 0x3F];
        output[index + 2] = ((i + 1) < length)
        ? jx_base64EncodingTable[(value >> 6) & 0x3F]
        : '=';
        output[index + 3] = ((i + 2) < length)
        ? jx_base64EncodingTable[(value >> 0) & 0x3F]
        : '=';
    }
...
+ (NSData *)jx_dataWithBase64EncodedString:(NSString *)base64EncodedString {
    ...
    while (inputPoint < length) {
        ...
        output[outputPoint++] = (jx_base64DecodingTable[i0] << 2)
        | (jx_base64DecodingTable[i1] >> 4);
        if (outputPoint < outputLength) {
            output[outputPoint++] = ((jx_base64DecodingTable[i1] & 0xf) << 4)
            | (jx_base64DecodingTable[i2] >> 2);
        }
        if (outputPoint < outputLength) {
            output[outputPoint++] = ((jx_base64DecodingTable[i2] & 0x3) << 6)
            | jx_base64DecodingTable[i3];
        }
    }
    return data;
}
...
/**
 ...
 @return 加密后的data字符串
 */
- (NSString *)_jx_hmacStringUsingAlgorithm:(CCHmacAlgorithm)algorithm withKey:(NSString *)key {
    size_t size;
    switch (algorithm) {
...
/**
 ...
 @return 加密后的data
 */
- (NSData *)_jx_hmacDataUsingAlgorithm:(CCHmacAlgorithm)algorithm withKey:(NSData *)key {
    size_t size;
    switch (algorithm) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)jx_MD5StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)jx_MD5DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgMD5 withKey:key];
}
...
- (NSString *)jx_SHA1StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)jx_SHA1DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgSHA1 withKey:key];
}
...
- (NSString *)jx_SHA224StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)jx_SHA224DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgSHA224 withKey:key];
}
...
- (NSString *)jx_SHA256StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)jx_SHA256DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgSHA256 withKey:key];
}
...
- (NSString *)jx_SHA384StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)jx_SHA384DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgSHA384 withKey:key];
}
...
- (NSString *)jx_SHA512StringWithKey:(NSString *)key {
    return [self _jx_hmacStringUsingAlgorithm:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)jx_SHA512DataWithKey:(NSData *)key {
    return [self _jx_hmacDataUsingAlgorithm:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)_jx_crypt:(CCOperation)operation usingAlgorithm:(CCAlgorithm)algorithm withKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)jx_AES256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCEncrypt usingAlgorithm:kCCAlgorithmAES128 withKey:key iv:iv];
}
...
- (NSData *)jx_AES256DecryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCDecrypt usingAlgorithm:kCCAlgorithmAES128 withKey:key iv:iv];
}
...
- (NSData *)jx_DESEncryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCEncrypt usingAlgorithm:kCCAlgorithmDES withKey:key iv:iv];
}
...
- (NSData *)jx_DESDecryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCDecrypt usingAlgorithm:kCCAlgorithmDES withKey:key iv:iv];
}

#pragma mark - 3DES
- (NSData *)jx_3DESEncryptWithKey:(NSString *)key {
    return [self jx_3DESEncryptWithKey:[key dataUsingEncoding:NSUTF8StringEncoding] iv:nil];
}

- (NSData *)jx_3DESEncryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCEncrypt usingAlgorithm:kCCAlgorithmDES withKey:key iv:iv];
}

- (NSData *)jx_3DESDecryptWithKey:(NSString *)key {
    return [self jx_3DESDecryptWithKey:[key dataUsingEncoding:NSUTF8StringEncoding] iv:nil];
}

- (NSData *)jx_3DESDecryptWithKey:(NSData *)key iv:(NSData *)iv {
    return [self _jx_crypt:kCCDecrypt usingAlgorithm:kCCAlgorithm3DES withKey:key iv:iv];
}
