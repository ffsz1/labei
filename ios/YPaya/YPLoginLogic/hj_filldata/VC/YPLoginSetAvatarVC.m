...
@interface YPLoginSetAvatarVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@implementation YPLoginSetAvatarVC
...
{
    if (num ==0) return _isMan?@"yp_login_setAvatar_man1":@"yp_login_setAvatar_woman1";
    if (num ==1) return _isMan?@"yp_login_setAvatar_man2":@"yp_login_setAvatar_woman2";
    if (num ==2) return _isMan?@"yp_login_setAvatar_man3":@"yp_login_setAvatar_woman3";
    if (num ==3) return _isMan?@"yp_login_setAvatar_man4":@"yp_login_setAvatar_woman4";
    if (num ==4) return _isMan?@"yp_login_setAvatar_man5":@"yp_login_setAvatar_woman5";
    return _isMan?@"yp_login_setAvatar_man6":@"yp_login_setAvatar_woman6";
}

- (NSString *)getSelImageByNum:(NSInteger)num
{
    if (num ==0) return _isMan?@"yp_login_setAvatar_man1_sel":@"yp_login_setAvatar_woman1_sel";
    if (num ==1) return _isMan?@"yp_login_setAvatar_man2_sel":@"yp_login_setAvatar_woman2_sel";
    if (num ==2) return _isMan?@"yp_login_setAvatar_man3_sel":@"yp_login_setAvatar_woman3_sel";
    if (num ==3) return _isMan?@"yp_login_setAvatar_man4_sel":@"yp_login_setAvatar_woman4_sel";
    if (num ==4) return _isMan?@"yp_login_setAvatar_man5_sel":@"yp_login_setAvatar_woman5_sel";
    return _isMan?@"yp_login_setAvatar_man6_sel":@"yp_login_setAvatar_woman6_sel";
}
...
- (IBAction)finishBtnAction:(id)sender {
    ...
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"yp_login_setAvatar_woman%ld",self.sel+1]];
//     if (self.isMan) image = [UIImage imageNamed:[NSString stringWithFormat:@"yp_login_setAvatar_man%ld_sel",self.sel+1]];
    if (self.isMan) image = [UIImage imageNamed:[NSString stringWithFormat:@"yp_login_setAvatar_man%ld",self.sel+1]];
