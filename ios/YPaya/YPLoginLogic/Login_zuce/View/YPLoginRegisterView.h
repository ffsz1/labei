...
@interface YPLoginRegisterView : UIView
...
@property (weak, nonatomic) IBOutlet GGImageView *confirmPassImgView;
@property (weak, nonatomic) IBOutlet UITextField *againPasswordTF;

@property (weak, nonatomic) IBOutlet UIButton *againSecuteBtn;
