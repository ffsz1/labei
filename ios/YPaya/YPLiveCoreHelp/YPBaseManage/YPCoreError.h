...
#define CORE_ERROR(d, c, m) [[YPCoreError alloc] initWithDomain:d code:c message:m]
#define CORE_API_ERROR(d, c, m) [[YPCoreError alloc] initWithDomain:d resCode:c resMessage:m]
#define CORE_SDK_ERROR(d, c) [[YPCoreError alloc] initWithDomain:d sdkCode:c]
