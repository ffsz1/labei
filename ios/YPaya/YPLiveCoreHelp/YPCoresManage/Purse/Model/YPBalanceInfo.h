...
@interface YPBalanceInfo : YPBaseObject
...
@end
//提现页面用户信息模型
@interface DrawExchangeModel : YPBaseObject
@property(nonatomic, assign)UserID uid;
@property(nonatomic, copy)NSString *diamondNum;
...
@end
@interface redPacketcashModel : YPBaseObject
@property(nonatomic, assign)UserID uid;
@property(nonatomic, assign)double packetNum;
@end
@interface ChargeGoldModel : YPBaseObject
@property(nonatomic, assign)UserID uid;
...
@interface HJFinancialAccountDataModel : YPBaseObject
@property(nonatomic, assign)UserID uid;
