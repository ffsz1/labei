//
//  YPIMRequestManager+PublicRoom.h
//  HJLive
//
...
typedef void(^JXIMRequestPublicRoomMembersSuccessHander)(YPIMPublicRoomInfo *roomInfo);

@interface YPIMRequestManager (PublicRoom)
