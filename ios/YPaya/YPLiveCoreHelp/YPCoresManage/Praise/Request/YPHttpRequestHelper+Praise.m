...
@implementation YPHttpRequestHelper (Praise)
                      ...
                      failure:(void (^)(NSNumber *resCode, NSString *message))failure
{
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        NSArray *userInfos = [NSArray yy_modelArrayWithClass:[YPAttention class] json:data];
        if (success) {
            success(userInfos);
        }
    } failure:^(NSNumber *resCode, NSString *message) {
...
+ (void)getFansListWithUid:(UserID)uid page:(NSInteger)page success:(void (^)(NSArray *))success failure:(void (^)(NSNumber *, NSString *))failure {
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        @try {
            NSArray *userInfos = [NSArray yy_modelArrayWithClass:[YPAttention class] json:data[@"fansList"]];
            if (success) {
                success(userInfos);
            }
        } @catch(NSException *e) {
