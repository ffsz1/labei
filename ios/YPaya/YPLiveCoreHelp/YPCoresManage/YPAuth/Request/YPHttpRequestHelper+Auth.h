...
@interface YPHttpRequestHelper (Auth)
...
+ (void)loginWithWeChatOpenID:(NSString *)openID
                 ...
                 validateCode:(NSString *)validateCode
                      success:(void (^)(YPAccountInfo *accountInfo))success
                      failure:(void (^)(NSNumber *resCode, NSString *message))failure;
...
/**
 ...
 @param failure 失败
 */
+ (void)getVisitor:(void (^)(YPAccountInfo *accountInfo))success
           failure:(void (^)(NSNumber *resCode, NSString *message))failure;
...
+ (void)requestTicket:(NSString *)accessToken
              success:(void (^)(YPTicketListInfo *YPTicketInfo))success
              failure:(void (^)(NSNumber *resCode, NSString *message))failure;
