...
@implementation YPHttpRequestHelper (Family)
...
+ (void)familyGetListWithFamilyId:(NSString *)familyId page:(NSInteger)page success:(void (^)(NSMutableDictionary *data))success failure:(void (^)(NSNumber *code, NSString *msg))failure {
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSArray *dataArr = [NSArray yy_modelArrayWithClass:[YPFamilyModel class] json:data[@"familyList"]];
        YPFamilyModel *model = [YPFamilyModel yy_modelWithJSON:data[@"familyTeam"]];
...
+ (void)familyCreateFamilyTeamWithBgImg:(NSString *)bgImg
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[@"uid"] = [GetCore(YPAuthCoreHelp) getUid];
    params[@"userId"] = [GetCore(YPAuthCoreHelp) getUid];
    params[@"ticket"] = [GetCore(YPAuthCoreHelp) getTicket];
    params[@"bgImg"] = bgImg;
    params[@"logo"] = logo;
    params[@"name"] = name;
...
+ (void)familyGetJoinFamilyInfoWithSuccess:(void (^)(id data))success
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSLog(@"%@",data);
        YPFamilyInfoDetail *model = [YPFamilyInfoDetail yy_modelWithJSON:data];
...
+ (void)familyGetFamilyTeamJoinWithFamilyId:(NSString *)familyId
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSArray *tmpArr = [NSArray yy_modelArrayWithClass:[YPFamilyInfoDetail class] json:[data objectForKey:@"familyTeamJoinDTOS"]];
        
        YPFamilyMemberModel *model = [YPFamilyMemberModel yy_modelWithJSON:data];
...
+ (void)familyGetFamilyMessageWithFamilyId:(NSString *)familyId
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSArray *dataArr = [NSArray yy_modelArrayWithClass:[YPFamilyMessage class] json:data];
        if (success) {
            success(dataArr);
        }
    } failure:^(NSNumber *resCode, NSString *message) {
...
+ (void)homeV2FamilyBannerWithSuccess:(void (^)(NSArray *dataArr))success
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        NSArray *arr = [NSArray yy_modelArrayWithClass:[YPBannerInfo class] json:data];
