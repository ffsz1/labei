...
@implementation YPHttpRequestHelper (Room)
...
+ (void)managerUpdateRoomInfo:(UserID)uid title:(NSString *)title roomDesc:(NSString *)roomDesc roomNotice:(NSString *)roomNotice backPic:(NSString *)backPic roomPassword:(NSString *)roomPassword playInfo:(NSString *)playInfo tag:(int)tag giftEffectSwitch:(BOOL)giftEffectSwitch giftCardSwitch:(BOOL)giftCardSwitch publicChatSwitch:(BOOL)publicChatSwitch success:(void (^)(YPChatRoomInfo *))success failure:(void (^)(NSNumber *, NSString *))failure
{
    ...
    UserID roomUid = GetCore(YPImRoomCoreV2).currentRoomInfo.uid;
    ...
    [YPHttpRequestHelper POST:method params:params success:^(id data) {
        YPChatRoomInfo *roomInfo = [YPChatRoomInfo yy_modelWithDictionary:data];
        if (roomInfo != nil) {
            success(roomInfo);
        } else {
            failure(@(10), @"ticket为空");
...
#pragma mark - 开房&关房
//开竞拍房
+ (void) rewardForRoom:(UserID)uid servDura:(NSInteger)servDura rewardMonye:(NSInteger)rewardMonye success:(void (^)(YPRewardInfo *))success failure:(void (^)(NSNumber *, NSString *))failure
{
    ...
    [YPHttpRequestHelper POST:method params:params success:^(id data) {
        YPRewardInfo *rewardInfo = [YPRewardInfo yy_modelWithDictionary:data];
        if (rewardInfo != nil) {
            success(rewardInfo);
        } else {
            failure(@(10), @"ticket为空");
...
//开房
+ (void)openRoom:(UserID)uid type:(RoomType)type title:(NSString *)title roomDesc:(NSString *)roomDesc backPic:(NSString *)backPic rewardId:(NSString *)rewardId success:(void (^)(YPChatRoomInfo *))success failure:(void (^)(NSNumber *, NSString *))failure
{
    ...
    if (title.length <= 0) {
        NSString *nick = [GetCore(YPUserCoreHelp) getUserInfoInDB:uid].nick;
...
//获取房间信息
+ (void)getRoomInfo:(UserID)uid success:(void (^)(YPChatRoomInfo *))success failure:(void (^)(NSNumber *, NSString *))failure
{
    NSString *method = @"room/get";
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    [params setObject:@(uid) forKey:@"uid"];
    params[@"visitorUid"] = GetCore(YPAuthCoreHelp).getUid;
    NSString *ticket = [GetCore(YPAuthCoreHelp) getTicket ];
    [params setObject:ticket forKey:@"ticket"];
...
//获取房间信息
+ (void)getRoomInfoByUids:(NSArray *)uids success:(void (^)(NSArray<YPChatRoomInfo *> *))success failure:(void (^)(NSNumber *, NSString *))failure {
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        for (NSDictionary *item in data) {
            YPChatRoomInfo *roominfo = [YPChatRoomInfo yy_modelWithDictionary:item];
...
+ (void)requestUserInRoomInfoBy:(UserID)uid Success:(void (^)(YPChatRoomInfo *roomInfo))success failure:(void (^)(NSNumber *resCode, NSString *message))failure {
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        YPChatRoomInfo *info = [YPChatRoomInfo yy_modelWithJSON:data];
        success(info);
    } failure:^(NSNumber *resCode, NSString *message) {
        failure(resCode, message);
    }];
...
+ (void)requestRoomBounsListSuccess:(void (^)(NSMutableArray *))success failure:(void (^)(NSNumber *, NSString *))failure {
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    NSString *roomUid = [NSString stringWithFormat:@"%lld",GetCore(YPImRoomCoreV2).currentRoomInfo.uid];
    [params setObject:roomUid forKey:@"uid"];
    
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        NSArray *arr = [NSArray yy_modelArrayWithClass:[YPRoomBounsListInfo class] json:data];
...
+ (void)getRoomCallForUser:(YPDaCallIntoModel *)model
    ...
    [YPHttpRequestHelper POST:method params:params success:^(id data) {
        YPDaCallModel* model = [YPDaCallModel yy_modelWithDictionary:data];
        success(model);
    } failure:^(NSNumber *resCode, NSString *message) {
        failure(resCode, message);
    }];
...
+ (void)inviteUpMicroWithUid:(UserID)uid position:(int)position roomId:(int)roomId success:(void (^)(BOOL))success failure:(void (^)(NSNumber *, NSString *))failure {
    ...
    NSString *ticket = [GetCore(YPAuthCoreHelp) getTicket];
    NSString *ownerUid = [GetCore(YPAuthCoreHelp) getUid];
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
...
//请求麦序
+ (void)requestMicroList:(UserID)roomOwnerUid success:(void (^)(YPMicroListInfo *))success failure:(void (^)(NSNumber *, NSString *))failure
{
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        YPMicroListInfo *microListInfo = [YPMicroListInfo yy_modelWithJSON:data];
...
//        [NSArray yy_modelArrayWithClass:[UserInfo class] json:data];
        [userList addObjectsFromArray:[NSArray yy_modelArrayWithClass:[YPMicroUserListInfo class] json:data]];
        NSMutableArray *finallyUserList = [NSMutableArray array];
        
        for (YPMicroUserListInfo *info in userList) {
            if (info.status == 2) {
...
+ (void)userGiftPurseGetRankWithType:(NSInteger)type
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        [dataList addObjectsFromArray:[NSArray yy_modelArrayWithClass:[YPGiftPurseRank class] json:data]];
...
+ (void)userGiftPurseRecordWithPageNum:(NSInteger)pageNum
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        NSMutableArray *dataList = [NSMutableArray array];
        [dataList addObjectsFromArray:[NSArray yy_modelArrayWithClass:[YPGiftPurseRecord class] json:data]];
...
+ (void)roomBgListWithRoomId:(NSInteger)roomId
    ...
    [YPHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSArray *arr = [NSArray yy_modelArrayWithClass:[YPRoomBgModel class] json:data];
        if (success) {
            success(arr);
        }
    } failure:^(NSNumber *resCode, NSString *message) {
