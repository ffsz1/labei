...
@implementation YPCarSysCore

- (void)sendCarWithCarId:(NSString *)carId
               targetUid:(NSString *)targetUid {
    [YPHttpRequestHelper sendCarWithCarId:carId targetUid:targetUid Success:^(id json) {
...
- (void)getCarSysListWithPageNum:(NSString *)pageNum PageSize:(NSString *)pageSize {
    ...
    [YPHttpRequestHelper getCarSysListWithPageNum:pageNum withPageSize:pageSize userId:uid success:^(NSArray *list) {
...
- (void)getUserCarSysList:(UserID)userId
    ...
    if (userId > 0) {
        [YPHttpRequestHelper getUserCarList:userId PageNum:pageNum PageSize:pageSize success:^(NSArray *list) {
...
- (void)getUserHeadList:(UserID)userId
               ...
               PageSize:(NSString *)pageSize {
    if (userId > 0) {
        [YPHttpRequestHelper getUserHeadList:userId PageNum:pageNum PageSize:pageSize success:^(NSArray *list) {
