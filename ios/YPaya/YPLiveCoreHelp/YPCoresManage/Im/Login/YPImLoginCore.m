...
#import "YPNIMKitCore.h"

#import "YPIMRequestManager+Login.h"


@interface YPImLoginCore()<HJAuthCoreClient, NIMLoginManagerDelegate,HJWebSocketCoreClient>
@property (nonatomic, strong) NSData *apnsToken;
@end

@implementation YPImLoginCore
- (instancetype)init
{
    self = [super init];
    if (self) {
...
//        [[NIMSDK sharedSDK] registerWithAppID:@"e655919f13b02388594d43451b801560" cerName:@"erbanproduct"];
        ...
        [GetCore(YPNIMKitCore)initCustomerMsgDecoder];
        [self registerAPNs];
    }
    return self;
}
...
- (void)onLoginSuccess
{
    ...
    NSString *token = [GetCore(YPAuthCoreHelp) getNetEaseToken];
    
    [YPIMRequestManager loginWithUid:uid ticket:ticket success:^{
