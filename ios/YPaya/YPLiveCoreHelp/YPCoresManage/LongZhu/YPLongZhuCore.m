...
#import "YPHttpRequestHelper+LongZhu.h"

@interface YPLongZhuCore ()<HJImMessageCoreClient,HJImMessageSendCoreClient>

@end

@implementation YPLongZhuCore
...
- (void)getStateWithRoomId:(NSInteger)roomId {
    ...
    [YPHttpRequestHelper getStateWithRoomId:roomId success:^(NSDictionary *result) {
...
- (void)cancelChooseResultWithRoomId:(NSInteger)roomId
    ...
    [YPHttpRequestHelper cancelChooseResultWithRoomId:roomId type:type result:reStr success:^(NSInteger state) {
...
- (void)getChooseResultWithRoomId:(NSInteger)roomId
    ...
    [YPHttpRequestHelper getChooseResultWithRoomId:roomId type:type result:result success:^(NSInteger state) {
...
- (void)confirmResult:(NSString *)result
    ...
    [YPHttpRequestHelper confirmResult:reStr roomId:roomId type:type success:^{
        ...
        if (obj.attachment != nil && [obj.attachment isKindOfClass:[YPAttachment class]]) {
            ...
            if (attachment.first == Custom_Noti_Header_LongZhu) {
                if (attachment.second == Custom_Noti_Sub_LongZhu_Supei || attachment.second == Custom_Noti_Sub_LongZhu_Choose) {
                    YPRoomLongZhuMsgModel *model = [YPRoomLongZhuMsgModel yy_modelWithJSON:attachment.data];
