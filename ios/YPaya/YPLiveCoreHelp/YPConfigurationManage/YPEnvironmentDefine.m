...
//NSString *const JX_HOST_URL_DEBUG = @"http://118.178.122.227:80"; ///< test
//NSString *const JX_HOST_URL_RELEASE = @"http://api.tianxinyuewan.com:80"; ///< distribute
//
//NSString *const JX_IM_WSS_SOCKET_URL_DEBUG = @"ws://118.178.122.227:3006/"; ///< 测试服
//NSString *const JX_IM_WS_SOCKET_URL_DEBUG = @"ws://118.178.122.227:3006/"; ///< 测试服
//
//NSString *const JX_IM_WS_SOCKET_URL_RELEASE = @"ws://api.haijiaoxingqiu.cn:3006/"; ///< 正式服
//NSString *const JX_IM_WSS_SOCKET_URL_RELEASE = @"ws://api.haijiaoxingqiu.cn:3006/"; ///< 正式服

NSString *const JX_HOST_URL_DEBUG = @"http://test.haijiaoxingqiu.cn:80"; ///< test
NSString *const JX_HOST_URL_RELEASE = @"http://api.haijiaoxingqiu.cn:80"; ///< distribute

NSString *const JX_IM_WSS_SOCKET_URL_DEBUG = @"ws://test.haijiaoxingqiu.cn:3006/"; ///< 测试服
NSString *const JX_IM_WS_SOCKET_URL_DEBUG = @"ws://test.haijiaoxingqiu.cn:3006/"; ///< 测试服
...
NSString *const JX_QN_AK_KEY = @"F8V---cUo1AK3M0hTQA1HZQYjwKrzUytpx7RRjnO"; ///< 七牛AK Key
NSString *const JX_QN_SK_KEY = @"EybTYBJb4tscjEG2FAlSEEpHU6-OIx1TFUD-YoYu"; ///< 七牛NK Key
NSString *const JX_QN_BUCKET_NAME = @"tianyalive"; ///< 七牛buncket名

// 图片
//NSString *const JX_IMAGE_HOST_URL = @"http://q1rfo38x4.bkt.clouddn.com"; ///< 图片地址
NSString *const JX_IMAGE_HOST_URL = @"http://pic.zoudewu.com"; ///< 图片地址
...
NSString *const JX_WE_CHAT_APP_ID = @"wxfdccf7c83108ee43"; ///< We Chat AppId
//NSString *const JX_WE_CHAT_APP_SECRET = @"2a2a8b08e7c5ddeae631a29987e5c885"; ///< We Chat AppSecret
NSString *const JX_WE_CHAT_APP_SECRET = @"9862b4d052b38d6c4e490722a29d4dca";
...
NSString *const JX_QQ_APP_ID = @"101909591"; ///< Q Q AppId   101894511

//NSString *const JX_QQ_APP_SECRET = @"3e18a9e1c09c4d7ff5cdcb6762b26408"; ///< Q Q AppSecret
NSString *const JX_QQ_APP_SECRET = @"9862b4d052b38d6c4e490722a29d4dca"; ///< Q Q AppSecret
NSString *const JX_QQ_SEXADECIMAL = @"QQ4215631D";
