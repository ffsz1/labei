...
@property (weak, nonatomic) IBOutlet YPSDCycleScrollView *bannerContainerView;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *yp_jiaoyou_trailing_layout;
