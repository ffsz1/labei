...
@interface YPSearchHistoryFooterView ()
...
@implementation YPSearchHistoryFooterView
...
- (UIButton *)clearBtn {
    ...
    if (!_clearBtn) {
        ...
        [_clearBtn setImage:[UIImage imageNamed:@"yp_lajitong"] forState:UIControlStateNormal];
