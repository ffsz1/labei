...
@class YPHomeFollowCell;
NS_ASSUME_NONNULL_BEGIN

@interface YPHomeFollowCell : UITableViewCell
...
@property  (nonatomic, copy)  void(^clickVoiceBtnBlock)(UserInfo* followModel, YPHomeFollowCell* voiceCell ) ;
@end
