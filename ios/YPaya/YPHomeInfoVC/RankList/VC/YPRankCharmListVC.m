...
@interface YPRankCharmListVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YPRankCharmListVC
...
//    self.avatarImageView3.hidden = !hasThird;
    self.avatarImageView1.image = [UIImage imageNamed:@"yp_room_rank_empty_rich"];
    self.avatarImageView2.image = [UIImage imageNamed:@"yp_room_rank_empty_rich"];
    self.avatarImageView3.image = [UIImage imageNamed:@"yp_room_rank_empty_rich"];
...
- (void)getData
{
    ...
    [YPHttpRequestHelper getCharmRankData:self.daySelType+1 success:^(NSArray * _Nonnull list) {
