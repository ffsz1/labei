...
@implementation YPHomeCommonTopCell
...
- (void)tapAction
{
    YPHomePageInfo *room = [self.roomArr safeObjectAtIndex:0];
...
- (void)tapAction2
{
    ...
    YPHomePageInfo *room = [self.roomArr safeObjectAtIndex:1];
    [self pushRoom:room.uid];
}
...
- (void)tapAction3
{
    ...
    YPHomePageInfo *room = [self.roomArr safeObjectAtIndex:2];
    [self pushRoom:room.uid];
}
...
- (void)pushToH5
{
    ...
    NSString *urlSting = [NSString stringWithFormat:@"%@/front/rmExplain/index.html",[YPHttpRequestHelper getHostUrl]];
...
- (UIImageView *)shadowImageView
{
    if (!_shadowImageView) {
        ...
        _shadowImageView.image = [UIImage imageNamed:@"yp_home_common_shadow"];
...
- (UIImageView *)shadowImageView2
{
    if (!_shadowImageView2) {
        ...
        _shadowImageView2.image = [UIImage imageNamed:@"yp_home_common_shadow"];
...
- (UIImageView *)shadowImageView3
{
    if (!_shadowImageView3) {
        ...
        _shadowImageView3.image = [UIImage imageNamed:@"yp_home_common_shadow"];
