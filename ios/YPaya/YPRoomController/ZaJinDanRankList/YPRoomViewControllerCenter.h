...
@interface YPRoomViewControllerCenter : NSObject
...
- (void)presentRoomViewWithRoomOwnerUid:(UserID) ownerUid
                                   succ:(void (^)(YPChatRoomInfo *roomInfo))succBlock
                                   fail:(void (^)(NSString *errorMsg))failBlock;  //根据房主id进入房间


- (void)presentRoomViewWithRoomInfo:(YPChatRoomInfo *)roomInfo;//根据房间info present房间
