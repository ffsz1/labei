...
@interface YPGiftSpringAnimateView()
...
@implementation YPGiftSpringAnimateView

+ (instancetype)loadFromNib {
    return [[NSBundle mainBundle]loadNibNamed:@"YPGiftSpringAnimateView" owner:self options:nil].lastObject;
}
