...
#import "YPPlayingFaceMessageCell.h"
...
- (void)setMessage:(YPIMMessage *)message {
    ...
    if (obj.attachment != nil && [obj.attachment isKindOfClass:[YPAttachment class]]) {
        ...
        for (int i = 0; i< arr.count; i++) {
            ...
            UIColor *whiteColor = [[YPYYDefaultTheme defaultTheme]colorWithHexString:@"#FFFFFF" alpha:1.0];
            ...
            YPFaceInfo *info = [GetCore(YPFaceCore)findFaceInfoById:item.faceId];
