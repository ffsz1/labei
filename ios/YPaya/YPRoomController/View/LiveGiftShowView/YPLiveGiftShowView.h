...
static CGFloat const kViewWidth = 250.0;//背景宽
static CGFloat const kViewHeight = 50.0;//背景高

@interface YPLiveGiftShowView : UIView
...
@property (nonatomic ,strong) YPLiveGiftShowModel * model;

@property (nonatomic ,weak) YPLiveGiftShowNumberView * numberView;
...
@property (nonatomic ,copy) void(^HJLiveGiftShowViewTimeOut)(YPLiveGiftShowView *);
