...
@implementation YPRoomNoticeView

+ (void)show:(NSString *)title content:(NSString *)content
{
    YPRoomNoticeView *shareView = [[NSBundle mainBundle]loadNibNamed:@"YPRoomNoticeView" owner:self options:nil][0];
