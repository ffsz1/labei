...
@implementation YPRoomPKSureView
...
- (IBAction)sureAction:(id)sender {
    ...
    [YPHttpRequestHelper pk_confirmJoinPk:recordID choose:choose success:^(id  _Nonnull data) {
...
- (void)setJoinModel:(YPRoomPKJoinModel *)joinModel
{
