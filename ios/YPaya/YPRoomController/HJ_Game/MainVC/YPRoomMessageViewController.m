...
@interface YPRoomMessageViewController ()

@property (nonatomic, strong) UIView *bV;
@property (nonatomic, strong) UIView *cover;
@end

@implementation YPRoomMessageViewController
...
- (void)viewDidLoad {
    ...
    YPMessageListView *listView = [[NSBundle mainBundle] loadNibNamed:@"YPMessageListView" owner:nil options:nil][0];
...
//        @strongify(self);
    ...
    YPSessionListViewController *vc = [[YPSessionListViewController alloc] init];
...
//        }
    ...
    YPRoomSquareMsgVC *squareVC = YPRoomStoryBoard(@"YPRoomSquareMsgVC");
