...
@implementation YPGameRoomVC (Constraint)
...
//        make.top.mas_equalTo(self.view).offset(125 +(XC_Height_NavBar-64));
        make.top.mas_equalTo(self.view).offset(158 +(XC_Height_NavBar-64));
...
//        make.centerY.mas_equalTo(self.view).mas_offset(-10);
        make.top.mas_equalTo(self.positionView.mas_bottom).mas_offset(8);
        make.trailing.mas_equalTo(self.positionView).mas_offset(-12);
