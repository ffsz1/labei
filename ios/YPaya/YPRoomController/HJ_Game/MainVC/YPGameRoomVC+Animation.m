...
@interface YPGameRoomVC ()<HJRippleAnimationDelagte>

@end

@implementation YPGameRoomVC (Animation)
...
//        }
//
//        YPRippleAnimationView *animationView = [[YPRippleAnimationView alloc]initWithFrame:CGRectMake(0, 0, self.mainPositionSpeakingAnimationImageView.width, self.mainPositionSpeakingAnimationImageView.height) gender:roomOwnerGender];
//
