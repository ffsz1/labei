...
@implementation YPRoomOnlineCell

- (IBAction)deleteAction:(id)sender {
    self.upMicBlock(self.indexPath);
}

- (void)setModel:(YPChatRoomMember *)model
{
    _model = model;
    ...
    if (model) {
        ...
        self.sexImageView.image = [UIImage imageNamed:model.gender==1?@"yp_home_attend_man":@"yp_home_attend_woman"];
