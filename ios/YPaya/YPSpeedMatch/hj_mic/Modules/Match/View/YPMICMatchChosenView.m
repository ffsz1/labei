...
@interface YPMICMatchChosenView ()
...
@implementation YPMICMatchChosenView
...
- (void)configureWithType:(XCMICMatchChosenType)type connectionInfo:(id)connectionInfo {
    ...
    if (type == XCMICMatchChosenTypeDislike) {
        backgroundName = @"yp_match_buxihuan";
    } else {
        backgroundName = @"yp_match_xihuan";
        showCenter = YES;
    }
...
- (UIImageView *)backgroundView {
    if (!_backgroundView) {
        ...
        _backgroundView.image = [UIImage imageNamed:@"yp_match_buxihuan"];
...
- (UIImageView *)centerView {
    if (!_centerView) {
        ...
        _centerView.image = [UIImage imageNamed:@"yp_mic_icon_heart"];
