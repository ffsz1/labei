...
#import "YPMICRecordView.h"
#import "YPMICRecordInfoView.h"

#import "YPMICRecordInfoModel.h"

@interface YPMICRecordView ()

@property (nonatomic, strong) UIImageView *backgroudView;
@property (nonatomic, strong) UIButton *changeButton;
@property (nonatomic, strong) UIButton *doneButton;
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) YPMICRecordInfoView *recordInfoView;
...
@implementation YPMICRecordView
    ...
    if (self.recordButton.isSelected == YES) {
        ...
        if ([_recordLabel.text isEqualToString:@"正在录制"]) {
            ...
            _recordLabel.text = @"正在录制";
             [_recordButton setBackgroundImage:[UIImage imageNamed:@"yp_music_luyin_bg"] forState:UIControlStateNormal];
...
- (void)configureWithRecordInfo:(YPMICRecordInfoModel *)recordInfo {
    BOOL showPlay = NO;
    BOOL animated = NO;
    ...
    switch (recordInfo.state) {
        ...
        {
            playImage = @"yp_match_shiting_ing";
            showPlay = YES;
            animationState = HJMICRecordInfoViewAnimationStateStart;
        }
            break;
...
- (void)setSaveState:(BOOL)saveState {
    ...
    if (saveState) {
        ...
        [_recordButton setImage:[UIImage imageNamed:@"yp_music_luyin_icon"] forState:UIControlStateNormal];
...
- (void)setRecordInfo:(YPMICRecordInfoModel *)recordInfo {
...
- (UIButton *)changeButton {
    if (!_changeButton) {
        ...
        [_changeButton setImage:[UIImage imageNamed:@"yp_music_change"] forState:UIControlStateNormal];
...
- (YPMICRecordInfoView *)recordInfoView {
    if (!_recordInfoView) {
        _recordInfoView = [YPMICRecordInfoView new];
...
//        [_recordButton setImage:[UIImage imageNamed:@"yp_match_luyin"] forState:UIControlStateNormal];
//        [_recordButton setImage:[UIImage imageNamed:@"yp_match_baochun"] forState:UIControlStateSelected];
         [_recordButton setImage:[UIImage imageNamed:@"yp_music_luyin_icon"] forState:UIControlStateNormal];
         [_recordButton setBackgroundImage:[UIImage imageNamed:@"yp_music_luyin_bg"] forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"yp_match_chonglu"] forState:UIControlStateNormal];
...
- (UIButton *)playButton {
    if (!_playButton) {
        ...
        [_playButton setImage:[UIImage imageNamed:@"yp_match_shiting_ing"] forState:UIControlStateNormal];
