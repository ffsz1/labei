...
typedef __kindof UIView * _Nullable (^JCCardViewGetItemViewBlock)(YPJCCardView *cardView, NSInteger idx);
typedef void (^JCCardViewItemOptionBlock)(YPJCCardView *cardView, __kindof UIView *itemView, NSInteger idx);
typedef BOOL (^JCCardViewCanAnimationBlock)(YPJCCardView *cardView, __kindof UIView *itemView, NSInteger idx, JCCardViewSwipeDirection direction);
typedef void (^JCCardViewItemHandleBlock)(YPJCCardView *cardView, __kindof UIView *itemView, NSInteger idx, JCCardViewSwipeDirection direction);
typedef void (^JCCardViewProgressingBlock)(YPJCCardView *cardView, __kindof UIView *itemView, NSInteger idx, CGFloat progress);


@interface YPJCCardView : UIView
...
/**
 是否能相应滑动手势
 */
@property (nonatomic, assign) BOOL canPanState;
@property (nonatomic, copy) void (^canPan)(void);
