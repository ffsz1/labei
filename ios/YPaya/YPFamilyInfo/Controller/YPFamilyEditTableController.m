...
@interface YPFamilyEditTableController ()<UITextViewDelegate,HJFileCoreClient, UINavigationControllerDelegate, UIImagePickerControllerDelegate,HJFamilyCoreClient>
...
@implementation YPFamilyEditTableController
