...
#import "YPFamilyTextTagViewLabel.h"
...
@interface YPFamilyManagerSettingCell ()
    
    @property (nonatomic, strong) UIImageView *iconView;
    @property (nonatomic, strong) UILabel *nameLabel;
    @property (nonatomic, strong) YPFamilyTextTagViewLabel *tagView;
...
@implementation YPFamilyManagerSettingCell
...
- (UIButton *)actionButon {
    if (!_actionButon) {
        ...
        [_actionButon setImage:[UIImage imageNamed:@"yp_family_icon_tick_normal"] forState:UIControlStateNormal];
        [_actionButon setImage:[UIImage imageNamed:@"yp_family_icon_tick_selected"] forState:UIControlStateSelected];
    ...
    - (UIButton *)deleteButton {
        if (!_deleteButton) {
            ...
            [_deleteButton setImage:[UIImage imageNamed:@"yp_family_icon_delete"] forState:UIControlStateNormal];
            @weakify(self);
...
- (YPFamilyTextTagViewLabel *)tagView {
    if (!_tagView) {
        _tagView = [YPFamilyTextTagViewLabel new];
    }
    return _tagView;
}
