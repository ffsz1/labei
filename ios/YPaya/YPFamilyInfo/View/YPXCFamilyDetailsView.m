...
#import "YPXCFamilyDetailsView.h"
...
@interface YPXCFamilyDetailsView ()
...
@implementation YPXCFamilyDetailsView
...
- (void)configureWithDetails:(YPFamilyModel *)detailsInfo {
...
- (UIButton *)photoButton {
    if (!_photoButton) {
        ...
        [_photoButton setImage:[UIImage imageNamed:@"yp_family_creat_photography_white"] forState:UIControlStateNormal];
...
- (UIButton *)logoPhotoButton {
    if (!_logoPhotoButton) {
        ...
        [_logoPhotoButton setImage:[UIImage imageNamed:@"yp_family_creat_photography"] forState:UIControlStateNormal];
...
- (UIImageView *)infoCardView {
    if (!_infoCardView) {
        ...
        _infoCardView.image = [UIImage imageNamed:@"yp_family_my_bg"];
    }
...
- (UIButton *)chatButton {
    if (!_chatButton) {
        ...
        [_chatButton setBackgroundImage:[UIImage imageNamed:@"yp_family_bg_chat"] forState:UIControlStateNormal];
