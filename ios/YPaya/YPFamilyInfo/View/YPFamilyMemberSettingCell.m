...
NSString *const HJFamilyMemberSettingCellID = @"HJFamilyMemberSettingCellID";

@interface YPFamilyMemberSettingCell ()
...
@implementation YPFamilyMemberSettingCell
...
- (UIButton *)actionButon {
    if (!_actionButon) {
        ...
        [_actionButon setImage:[UIImage imageNamed:@"yp_family_icon_delete"] forState:UIControlStateNormal];
        @weakify(self);
