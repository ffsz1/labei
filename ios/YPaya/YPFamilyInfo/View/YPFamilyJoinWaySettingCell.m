...
@interface YPFamilyJoinWaySettingCell ()
...
@implementation YPFamilyJoinWaySettingCell
...
- (UIImageView *)tickView {
    if (!_tickView) {
        ...
        _tickView.image = [UIImage imageNamed:@"yp_family_icon_tick_selected"];
