...
#import "YPGGHomeTagCCell.h"

@implementation YPGGHomeTagCCell
...
- (NSString *)getLogoImg
{
    ...
    if (title) {
        NSString *name = @"yp_home_iocn_moren_shibie";
        if ([title isEqualToString:@"关注"]) {
            name = @"yp_home_icon_guangzhumoren";
        }
        
        if ([title isEqualToString:@"热门"]) {
            name = @"yp_home_iocn_remen_normal";
        }
        
        if ([title isEqualToString:@"新秀"]) {
            name = @"yp_home_icon_xinxiumoren";
        }
        
        if ([title isEqualToString:@"交友"]) {
            name = @"yp_home_icon_jiaoyoumoren";
        }
        
        if ([title isEqualToString:@"陪玩"]) {
            name = @"yp_home_icon_peiwanmoren";
        }
        
        if ([title isEqualToString:@"男神"]) {
            name = @"yp_home_icon_nanshenmoren";
        }
        
        if ([title isEqualToString:@"女神"]) {
            name = @"yp_home_icon_nvshenmoren";
        }
        ...
        if (self.tagID == 9) {
            ...
            name = @"yp_home_icon_diantaimoren";
        } else if (self.tagID == 7) {
            name = @"yp_home_icon_yulemoren";
        }
...
- (NSString *)getSelLogoImg
{
    NSString *title = self.nameLabel.text;
    if (title) {
        NSString *name = @"yp_home_iocn_moren";
        if ([title isEqualToString:@"关注"]) {
            name = @"yp_home_icon_guangzhu";
        }
        
        if ([title isEqualToString:@"热门"]) {
            name = @"yp_home_icon_remen";
        }
        
        if ([title isEqualToString:@"新秀"]) {
            name = @"yp_home_icon_xinxiu";
        }
        
        if ([title isEqualToString:@"交友"]) {
            name = @"yp_home_icon_jiaoyou";
        }
        
        if ([title isEqualToString:@"陪玩"]) {
            name = @"yp_home_icon_pewna";
        }
        
        if ([title isEqualToString:@"男神"]) {
            name = @"yp_home_icon_nanshen";
        }
        
        if ([title isEqualToString:@"女神"]) {
            name = @"yp_home_icon_nvshen";
        }
        ...
        if (self.tagID == 9) {
            ...
            name = @"yp_home_icon_diantai";
        } else if (self.tagID == 7) {
            name = @"yp_home_icon_yule";
        }
