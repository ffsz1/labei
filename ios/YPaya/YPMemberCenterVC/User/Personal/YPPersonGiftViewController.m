...
#import "YPPersonGiftViewController.h"
#import "YPGiftReceiveCollectionViewCell.h"
#import "YPUserGift.h"
#import "HJUserCoreClient.h"
#import "YPUserCoreHelp.h"
#import "UIView+XCToast.h"

@interface YPPersonGiftViewController ()<HJUserCoreClient>

@property (nonatomic, strong) NSMutableArray *userGiftList;

@end

@implementation YPPersonGiftViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"YPGiftReceiveCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"YPGiftReceiveCollectionViewCell"];
}
...
- (void)updateData {
    if (!self.userGiftList.count) {
        [GetCore(YPUserCoreHelp) getReceiveGift:self.userID orderType:2 type:0];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    YPGiftReceiveCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"YPGiftReceiveCollectionViewCell" forIndexPath:indexPath];
    cell.giftImage.contentMode = UIViewContentModeScaleAspectFit;
    YPUserGift *gift = [self.userGiftList safeObjectAtIndex:indexPath.row];
    if (gift.picUrl) {
