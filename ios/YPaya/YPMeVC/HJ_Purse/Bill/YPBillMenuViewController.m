...
@interface YPBillMenuViewController ()<UIScrollViewDelegate>
...
@implementation YPBillMenuViewController
...
//                          normalStyle1,
    ...
    YPPurseSwitchTitleView *titleView = [[YPPurseSwitchTitleView alloc] initWithFrame:CGRectMake(0, 0, XC_SCREE_W, 44) titleArr:titleArr styleArr:styleArr currentButton:0 didClickButtonBlock:^(NSInteger index) {
...
- (void)setupChildenController {
    ...
    YPBillListController *vc2 = (YPBillListController *)[[YPPurseViewControllerFactory sharedFactory] instantiateBillListViewController];
    vc2.type = BillType_GiftOut;
    [self addChildViewController:vc2];
    
    YPBillListController *vc3 = (YPBillListController *)[[YPPurseViewControllerFactory sharedFactory]instantiateBillListViewController];
