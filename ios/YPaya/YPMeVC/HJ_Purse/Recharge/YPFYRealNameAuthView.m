...
@interface YPFYRealNameAuthView()
...
@end
@implementation YPFYRealNameAuthView


+ (void)show:(RealNameAuthBlock)menuBlock
{
    YPFYRealNameAuthView *shareView = [[NSBundle mainBundle]loadNibNamed:@"YPFYRealNameAuthView" owner:self options:nil][0];
