...
@interface YPFYSetBankInfoVC ()<UITableViewDelegate,UITableViewDataSource>
...
@property (strong, nonatomic) YPFYBankInfoListModel* banklistModel;

@end

@implementation YPFYSetBankInfoVC
- (void)viewDidLoad {
    [super viewDidLoad];
    self.tableview.delegate = self;
    self.tableview.dataSource = self;
     [self.tableview registerNib:[UINib nibWithNibName:@"YPFYBankInfoCell" bundle:nil] forCellReuseIdentifier:@"YPFYBankInfoCell"];
    ...
    //获取银行卡信息列表
      [GetCore(YPPurseCore) requestBankList];
...
//    static NSString *ID = @"YPFYBankInfoCell";
//       UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
//       if (cell == nil) {
//           cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
//       }
     YPFYBankInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"YPFYBankInfoCell" forIndexPath:indexPath];
    
       cell.selectionStyle = UITableViewCellSelectionStyleNone;
      YPFYBankInfoListModel* model = self.bankInfoArray[indexPath.row];
...
- (IBAction)confirmBtnAction:(id)sender {
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionary];
     ...
     [params setObject:self.realNameTF.text forKey:@"bankCardName"];
      ...
      [GetCore(YPPurseCore) requestWithDrawBankCardBindWith:params];
