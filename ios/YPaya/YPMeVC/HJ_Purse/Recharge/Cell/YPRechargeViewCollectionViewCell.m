//
//  YPRechargeViewCollectionViewCell.m
//  HJLive
//
...
@interface YPRechargeViewCollectionViewCell()

@end

@implementation YPRechargeViewCollectionViewCell
...
//    self.bgView.layer.borderColor = [UIColor colorWithHexString:@"#e5e5e5"].CGColor;
    [self.bgImageView setImage:[UIImage imageNamed:@"yp_recharge_icon_no"]];
