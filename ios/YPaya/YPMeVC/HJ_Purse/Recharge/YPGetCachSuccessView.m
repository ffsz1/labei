...
@implementation YPGetCachSuccessView

+ (void)show:(CachSuccessBlock)menuBlock cashNum:(NSString*)cashNum
{
    
    
    YPGetCachSuccessView *shareView = [[NSBundle mainBundle]loadNibNamed:@"YPGetCachSuccessView" owner:self options:nil][0];
