...
@implementation YPPublicRechargeView


+ (void)show:(PublicRechargeBlock)menuBlock
{
    YPPublicRechargeView *shareView = [[NSBundle mainBundle]loadNibNamed:@"YPPublicRechargeView" owner:self options:nil][0];
