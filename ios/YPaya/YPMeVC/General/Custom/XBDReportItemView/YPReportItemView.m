...
@implementation YPReportItemView
...
- (IBAction)reportAction:(id)sender {
    ...
    [YPUserHandler showReport:self.uid cancelFollowBlock:^{
...
- (IBAction)blackListAction:(id)sender {
    ...
    [YPUserHandler showAddBlackList:self.uid cancelFollowBlock:^{
        if (weakSelf.roomOwnerFollowBlock) {
            weakSelf.roomOwnerFollowBlock(NO);
        }
