...
@interface YPSendSysViewController ()<ZJScrollPageViewDelegate>
@property(strong, nonatomic)NSArray<NSString *> *titles;
@property (nonatomic, strong) YPZJScrollPageView *scrollPageView;
@end

@implementation YPSendSysViewController
...
- (UIViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(UIViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index {
    ...
    if (index == 0) {
        YPSendChildViewController *childVc = (YPSendChildViewController *)reuseViewController;
        if (childVc == nil) {
            childVc = [[YPSendChildViewController alloc] init];
