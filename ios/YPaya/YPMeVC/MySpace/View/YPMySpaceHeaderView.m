...
@implementation YPMySpaceHeaderView

- (void)updateNum:(NSInteger)num
{
    [self.giftBtn setTitle:[NSString stringWithFormat:@"礼物墙（%ld）",(long)num] forState:UIControlStateNormal];
