...
#import "YPAboutViewController.h"
#import "YYUtility.h"
#import "YPWKWebViewController.h"
@interface YPAboutViewController ()
@property (weak, nonatomic) IBOutlet UILabel *versionLabel;
@property (nonatomic, strong) UILabel *contactLabel;

@end

@implementation YPAboutViewController
...
- (void)updateControls {
    self.versionLabel.text = [NSString stringWithFormat:@"%@:%@",NSLocalizedString(XCMeVersion, nil),[YYUtility appVersion]];
