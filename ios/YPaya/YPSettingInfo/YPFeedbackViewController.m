...
#import "YPFeedbackViewController.h"
#import "SZTextView.h"
...
- (IBAction)onSubmitBtnClicked:(id)sender {
    ...
    [GetCore(YPFeedbackCore) requestFeedback:self.contentTextView.text contact:self.contactField.text];
}
