...
@implementation YPUnbindingWXVC
...
- (void)unbindingPost
{
    ...
    @weakify(self);
    [YPHttpRequestHelper untiedThird:self.isQQ?2:1 success:^{
        ...
        [GetCore(YPUserCoreHelp) getUserInfo:userId refresh:YES success:^(UserInfo *info) {
            ...
            [MBProgressHUD hideHUD];
            [YPAlterShower showText:@"解绑成功" sure:nil cancel:nil];
