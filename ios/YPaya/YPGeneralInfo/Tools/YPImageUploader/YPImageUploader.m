...
@implementation YPImageUploader
...
+ (NSString *)token{
    ...
    NSString *encodedString = [YPImageUploader urlSafeBase64Encode:jsonData];
    
    NSString *encodedSignedString = [YPImageUploader HMACSHA1:JX_QN_SK_KEY text:encodedString];
