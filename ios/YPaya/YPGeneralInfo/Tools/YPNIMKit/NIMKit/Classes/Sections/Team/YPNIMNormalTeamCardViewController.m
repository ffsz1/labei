...
@interface YPNIMNormalTeamCardViewController ()<NIMTeamManagerDelegate, NIMTeamMemberCardActionDelegate,UITableViewDataSource,UITableViewDelegate,NIMTeamSwitchProtocol,NIMContactSelectDelegate,NIMMemberGroupViewDelegate>{
...
@property (nonatomic,strong) YPNIMMemberGroupView *headerView;
...
@implementation YPNIMNormalTeamCardViewController
...
- (NSArray*)buildBodyData{
    ...
    YPNIMTeamCardRowItem *itemName = [[YPNIMTeamCardRowItem alloc] init];
...
- (void)updateTeamInfoName{
    _updateTeamNameAlertView = [[UIAlertView alloc] initWithTitle:@"" message:@"修改讨论组名称" delegate:self cancelButtonTitle:NSLocalizedString(XCRoomCancel, nil) otherButtonTitles:NSLocalizedString(XCRoomConfirm, nil), nil];
    _updateTeamNameAlertView.alertViewStyle = UIAlertViewStylePlainTextInput;
    [_updateTeamNameAlertView show];
}

- (void)quitTeam{
    _quitTeamAlertView = [[UIAlertView alloc] initWithTitle:@"" message:@"确认退出讨论组?" delegate:self cancelButtonTitle:NSLocalizedString(XCRoomCancel, nil) otherButtonTitles:NSLocalizedString(XCRoomConfirm, nil), nil];
...
- (void)setupTableHeader:(CGFloat)width{
    self.headerView = [[YPNIMMemberGroupView alloc] initWithFrame:CGRectZero];
