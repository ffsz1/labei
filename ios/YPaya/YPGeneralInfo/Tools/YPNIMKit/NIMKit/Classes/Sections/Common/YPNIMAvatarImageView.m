...
@interface YPNIMAvatarImageView()
@end

@implementation YPNIMAvatarImageView
...
- (void)setupRadius
{
    switch ([YPNIMKit sharedKit].config.avatarType)
    {
...
- (void)setAvatarBySession:(NIMSession *)session
{
    ...
    [self nim_setImageWithURL:[NSURL URLWithString:userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:default_avatar]];
//    YPNIMKitInfo *info = nil;
//    if (session.sessionType == NIMSessionTypeTeam)
//    {
//        info = [[YPNIMKit sharedKit] infoByTeam:session.sessionId option:nil];
//    }
//    else
//    {
//        YPNIMKitInfoFetchOption *option = [[YPNIMKitInfoFetchOption alloc] init];
//        option.session = session;
//        info = [[YPNIMKit sharedKit] infoByUser:session.sessionId option:option];
//    }
//
...
- (void)setAvatarByMessage:(NIMMessage *)message
{
    ...
    NIMUser *user = [[NIMSDK sharedSDK].userManager userInfo:from];
    NIMUserInfo *userInfo = user.userInfo;
    [self nim_setImageWithURL:[NSURL URLWithString:userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:default_avatar]];
...
//    YPNIMKitInfo *info = [[YPNIMKit sharedKit] infoByUser:from option:option];
//    NSURL *url = info.avatarUrlString ? [NSURL URLWithString:info.avatarUrlString] : nil;
//    [self nim_setImageWithURL:url placeholderImage:info.avatarImage];
}
...
@implementation YPNIMAvatarImageView (SDWebImageCache)
