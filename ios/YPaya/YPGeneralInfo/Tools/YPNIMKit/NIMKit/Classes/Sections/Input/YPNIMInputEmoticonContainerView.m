//
//  YPNIMInputEmoticonContainerView.m
//  YPNIMKit
//
//  Created by chris.
...
#import "UIView+NIM.h"
#import "YPNIMInputEmoticonButton.h"
#import "YPNIMInputEmoticonManager.h"
#import "YPNIMInputEmoticonTabView.h"
...
@interface YPNIMInputEmoticonContainerView()<NIMEmoticonButtonTouchDelegate,NIMInputEmoticonTabDelegate>
...
@implementation YPNIMInputEmoticonContainerView
...
{
    _emoticonPageView                  = [[YPNIMPageView alloc] initWithFrame:self.bounds];
...
- (UIView*)emojPageView:(YPNIMPageView*)pageView inEmoticonCatalog:(NIMInputEmoticonCatalog *)emoticon page:(NSInteger)page
{
    ...
    for (NSInteger index = begin; index < end; index ++)
    {
        ...
        YPNIMInputEmoticonButton *button = [YPNIMInputEmoticonButton iconButtonWithData:data catalogID:emoticon.catalogID delegate:self];
        //计算表情位置
...
{
    YPNIMInputEmoticonButton* deleteIcon = [[YPNIMInputEmoticonButton alloc] init];
...
{
    NIMInputEmoticonCatalog *emoticonCatalog = [[YPNIMInputEmoticonManager sharedManager] emoticonCatalog:NIMKit_EmojiCatalog];
    if (emoticonCatalog) {
...
#pragma mark - Get
- (YPNIMInputEmoticonTabView *)tabView
{
    if (!_tabView) {
        _tabView = [[YPNIMInputEmoticonTabView alloc] initWithFrame:CGRectMake(0, 0, self.nim_width, 0)];
