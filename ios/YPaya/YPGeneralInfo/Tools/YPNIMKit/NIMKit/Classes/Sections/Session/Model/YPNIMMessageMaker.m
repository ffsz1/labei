...
#import "YPNIMKitLocationPoint.h"
#import "YPNIMKit.h"
#import "YPNIMInputAtCache.h"

@implementation YPNIMMessageMaker
...
+ (NIMMessage*)msgWithImage:(UIImage*)image
{
    ...
    return [YPNIMMessageMaker generateImageMessage:imageObject];
}
                          ...
                          toRobot:(NSString *)robotId
{
    ...
    NSString *robotContent = [[YPNIMKit sharedKit] infoByUser:robotId option:nil].showName;
