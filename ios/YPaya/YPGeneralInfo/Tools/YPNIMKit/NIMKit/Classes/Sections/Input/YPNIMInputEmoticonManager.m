...
@interface YPNIMInputEmoticonManager ()
@property (nonatomic,strong)    NSArray *catalogs;
@end

@implementation YPNIMInputEmoticonManager
+ (instancetype)sharedManager
{
    static YPNIMInputEmoticonManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YPNIMInputEmoticonManager alloc]init];
    });
    return instance;
}
...
- (void)parsePlist
{
    ...
    NSURL *url = [[NSBundle mainBundle] URLForResource:[[YPNIMKit sharedKit] emoticonBundleName]
                                         withExtension:nil];
