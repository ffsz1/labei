...
- (NSString *)title{
    return NSLocalizedString(NIMKitChoosePerson, nil);
}
...
- (NSString *)selectedOverFlowTip{
    return NSLocalizedString(NIMKitChooseOutline, nil);
}

- (void)getContactData:(NIMContactDataProviderHandler)handler {
    YPNIMGroupedData *groupedData = [[YPNIMGroupedData alloc] init];
...
- (YPNIMKitInfo *)getInfoById:(NSString *)selectedId {
    YPNIMKitInfo *info = nil;
    info = [[YPNIMKit sharedKit] infoByUser:selectedId option:nil];
    return info;
}
...
- (NSString *)title{
    return NSLocalizedString(NIMKitChooseRoboite, nil);
}
...
- (NSString *)title{
    return NSLocalizedString(NIMKitChooseGroup, nil);
}
...
- (YPNIMKitInfo *)getInfoById:(NSString *)selectedId {
    YPNIMKitInfo *info = nil;
    info = [[YPNIMKit sharedKit] infoByTeam:selectedId option:nil];
    return info;
}
