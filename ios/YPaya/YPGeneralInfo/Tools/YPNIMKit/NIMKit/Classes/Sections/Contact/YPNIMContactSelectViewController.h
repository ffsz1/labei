//
//  YPNIMContactSelectViewController.h
//  YPNIMKit
//
...
@interface YPNIMContactSelectViewController : UIViewController

@property (nonatomic, strong, readonly) UITableView *tableView;

@property (nonatomic, strong, readonly) id<YPNIMContactSelectConfig> config;
