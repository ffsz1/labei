...
@interface YPNIMTeamMemberListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,NIMTeamCardHeaderCellDelegate, NIMTeamMemberCardActionDelegate>
...
@implementation YPNIMTeamMemberListViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[YPNIMTeamCardHeaderCell class] forCellWithReuseIdentifier:CollectionCellReuseId];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    YPNIMTeamCardHeaderCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CollectionCellReuseId forIndexPath:indexPath];
    cell.delegate = self;
...
- (void)cellDidSelected:(YPNIMTeamCardHeaderCell*)cell{
    ...
    NSInteger index = indexpath.section * self.collectionItemNumber;
    index += indexpath.row;
    YPNIMTeamMemberCardViewController *vc = [[YPNIMTeamMemberCardViewController alloc] init];
    vc.delegate = self;
