...
- (void)textViewDidBeginEditing:(YPNIMGrowingTextView *)growingTextView;

- (void)textViewDidChangeSelection:(YPNIMGrowingTextView *)growingTextView;
...
- (BOOL)textViewShouldEndEditing:(YPNIMGrowingTextView *)growingTextView;
...
@interface YPNIMGrowingTextView : UIScrollView
...
@interface YPNIMGrowingTextView(TextView)
