...
@interface YPNIMKitAudioCenter()<NIMMediaManagerDelegate>

@property (nonatomic,assign) NSInteger retryCount;

@end

@implementation YPNIMKitAudioCenter

+ (instancetype)instance
{
    static YPNIMKitAudioCenter *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YPNIMKitAudioCenter alloc] init];
    });
    return instance;
}
