...
@interface YPNIMSpellingCenter ()
- (NIMSpellingUnit *)calcSpellingOfString: (NSString *)source;
@end


@implementation YPNIMSpellingCenter
+ (YPNIMSpellingCenter *)sharedCenter
{
    static YPNIMSpellingCenter *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YPNIMSpellingCenter alloc]init];
    });
    return instance;
}
...
- (NIMSpellingUnit *)calcSpellingOfString:(NSString *)source
{
    ...
    for (NSInteger i = 0; i < [source length]; i++)
    {
        ...
        NSString *pinyin = [[YPNIMPinyinConverter sharedInstance] toPinyin:word];
