...
@implementation YPNIMKitNotificationFirer

- (instancetype)init{
    self = [super init];
    if (self) {
        _timer = [[YPNIMKitTimerHolder alloc] init];
        _timeInterval = 1.0f;
...
- (void)onNIMKitTimerFired:(YPNIMKitTimerHolder *)holder{
