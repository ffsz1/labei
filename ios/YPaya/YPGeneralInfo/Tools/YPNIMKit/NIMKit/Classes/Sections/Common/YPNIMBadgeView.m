...
@implementation YPNIMBadgeView

+ (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
    if (!badgeValue) {
        badgeValue = @"";
    }
    YPNIMBadgeView *instance = [[YPNIMBadgeView alloc] init];
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _badgeBackgroundColor = [UIColor colorWithRed:255/255.0 green:119/255.0 blue:175/255.0 alpha:1.0];
