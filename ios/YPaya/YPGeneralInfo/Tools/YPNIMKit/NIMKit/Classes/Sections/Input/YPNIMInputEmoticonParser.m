...
@interface YPNIMInputEmoticonParser ()
@property (nonatomic,strong)    NSCache *tokens;
@end


@implementation YPNIMInputEmoticonParser
+ (instancetype)currentParser
{
    static YPNIMInputEmoticonParser *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YPNIMInputEmoticonParser alloc] init];
    });
    return instance;
}
...
- (NSArray *)parseToken:(NSString *)text
{
    ...
    [exp enumerateMatchesInString:text
                       ...
                       usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                           ...
                           if ([[YPNIMInputEmoticonManager sharedManager] emoticonByTag:rangeText])
                           {
