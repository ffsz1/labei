//
//  YPNIMTeamNotifyUpdateViewController.m
//  YPNIMKit
//
...
@interface YPNIMTeamNotifyUpdateViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation YPNIMTeamNotifyUpdateViewController
...
- (NSArray*)buildBodyData
{
    ...
    YPNIMTeamCardRowItem *notifyAll = [[YPNIMTeamCardRowItem alloc] init];
    ...
    YPNIMTeamCardRowItem *notifyManager = [[YPNIMTeamCardRowItem alloc] init];
    ...
    YPNIMTeamCardRowItem *notifyNone = [[YPNIMTeamCardRowItem alloc] init];
