//
//  YPNIMTeamMemberCardHeaderCell.m
//  YPNIMKit
//
...
#import "YPNIMTeamMemberCardHeaderCell.h"
...
@interface YPNIMTeamMemberCardHeaderCell()

@property (nonatomic,strong) YPNIMAvatarImageView *avatarView;

@property (nonatomic,strong) UILabel *nickLabel;

@end

@implementation YPNIMTeamMemberCardHeaderCell
...
- (void)refreshData:(NIMCommonTableRow *)rowData tableView:(UITableView *)tableView;{
    ...
    self.nickLabel.text = [YPNIMKitUtil showNick:user.info.infoId inSession:session];
...
- (YPNIMAvatarImageView *)avatarView
{
    if (!_avatarView) {
        _avatarView = [[YPNIMAvatarImageView alloc] initWithFrame:CGRectMake(125, 52, 70, 70)];
