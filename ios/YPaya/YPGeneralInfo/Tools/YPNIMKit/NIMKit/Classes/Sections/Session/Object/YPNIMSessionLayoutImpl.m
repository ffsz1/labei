...
@interface YPNIMSessionLayoutImpl(){
...
@implementation YPNIMSessionLayoutImpl
...
- (void)adjustTableView
{
    ...
    switch (self.inputView.status)
    {
        case NIMInputStatusText:
            inputViewUp = [YPNIMKitKeyboardInfo instance].isVisiable;
            break;
...
{
    YPNIMMessageCell *cell = (YPNIMMessageCell *)[self.tableView cellForRowAtIndexPath:indexPath];
    if (cell) {
