...
#pragma mark - YPNIMMemberGroupView

@interface YPNIMMemberGroupView()<UICollectionViewDataSource,UICollectionViewDelegate,NIMTeamCardHeaderCellDelegate>
...
@implementation YPNIMMemberGroupView
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[YPNIMTeamCardHeaderCell class] forCellWithReuseIdentifier:CollectionCellReuseId];
    }
...
- (YPNIMTeamCardHeaderCell *)buildUserCell:(NSString *)uid indexPath:(NSIndexPath *)indexPath{
    YPNIMTeamCardHeaderCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:CollectionCellReuseId forIndexPath:indexPath];
    NIMMemebrGroupData *data = [self dataAtIndexPath:indexPath];
...
- (YPNIMTeamCardHeaderCell *)buildOperatorCell:(NIMKitCardHeaderOpeator)operator indexPath:(NSIndexPath *)indexPath{
    YPNIMTeamCardHeaderCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:CollectionCellReuseId forIndexPath:indexPath];
    YPNIMTeamCardOperationItem *item = [[YPNIMTeamCardOperationItem alloc] initWithOperation:operator];
