...
@interface YPNIMKitResourceResizer ()
@property (nonatomic,assign)    CGFloat   scale;
@end

@implementation YPNIMKitResourceResizer

+ (instancetype)sharedResizer
{
    static YPNIMKitResourceResizer *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YPNIMKitResourceResizer alloc] init];
    });
    return instance;
}
