//
//  YPNIMSessionListViewController.m
//  YPNIMKit
//
//  Created by NetEase.
...
#import "YPNIMSessionListViewController.h"
...
@interface YPNIMSessionListViewController ()

@end

@implementation YPNIMSessionListViewController
...
- (void)viewDidLoad {
    ...
    self.tableView.separatorColor = [UIColor colorWithRed:250/255.0 green:250/255.0 blue:250/255.0 alpha:1.0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    YPNIMSessionListCell * cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    if (!cell) {
        cell = [[YPNIMSessionListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
    ...
    [cell.avatarImageView nim_setImageWithURL:[NSURL URLWithString:userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:default_avatar]];
    ...
    cell.sexImageView.image = [UIImage imageNamed:userInfo.gender==2?@"yp_home_attend_woman":@"yp_home_attend_man"];
...
- (void)onSelectedRecent:(NIMRecentSession *)recentSession atIndexPath:(NSIndexPath *)indexPath{
    YPNIMSessionViewController *vc = [[YPNIMSessionViewController alloc] initWithSession:recentSession.session];
...
- (NSString *)nameForRecentSession:(NIMRecentSession *)recent{
    if (recent.session.sessionType == NIMSessionTypeP2P) {
        return [YPNIMKitUtil showNick:recent.session.sessionId inSession:recent.session];
    }else{
...
- (NSString *)timestampDescriptionForRecentSession:(NIMRecentSession *)recent{
    return [YPNIMKitUtil showTime:recent.lastMessage.timestamp showDetail:NO];
}
...
- (NSString *)messageContent:(NIMMessage*)lastMessage{
    ...
    else
    {
        ...
        NSString *nickName = [YPNIMKitUtil showNick:from inSession:lastMessage.session];
