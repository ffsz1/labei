...
#import "YPNIMGrowingInternalTextView.h"

@interface YPNIMGrowingTextView()<UITextViewDelegate>

@property (nonatomic,strong) YPNIMGrowingInternalTextView *textView;
...
@implementation YPNIMGrowingTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        YPNIMGrowingInternalTextView *textView = [[YPNIMGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        YPNIMGrowingInternalTextView *textView = [[YPNIMGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
@implementation YPNIMGrowingTextView(TextView)
