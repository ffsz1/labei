...
#import "YPNIMGrowingTextView.h"
#import "UIView+NIM.h"
#import "UIImage+YPNIMKit.h"
#import "NIMInputBarItemType.h"

@interface YPNIMInputToolBar()<NIMGrowingTextViewDelegate>
...
@property (nonatomic,strong) YPNIMGrowingTextView *inputTextView;

@property (nonatomic,assign) NIMInputStatus status;

@end

@implementation YPNIMInputToolBar
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_voiceButton setImage:[UIImage nim_imageInKit:@"yp_message_voice"] forState:UIControlStateNormal];
        [_voiceButton setImage:[UIImage nim_imageInKit:@"yp_message_voice_highlinght"] forState:UIControlStateHighlighted];
        ...
        _inputTextView = [[YPNIMGrowingTextView alloc] initWithFrame:CGRectZero];
...
{
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"yp_message_voice"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"yp_message_voice_highlinght"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
}
...
- (BOOL)textViewShouldBeginEditing:(YPNIMGrowingTextView *)growingTextView
{
    BOOL should = YES;
...
- (void)textViewDidEndEditing:(YPNIMGrowingTextView *)growingTextView
{
...
- (void)textViewDidChange:(YPNIMGrowingTextView *)growingTextView
{
...
@implementation YPNIMInputToolBar(InputText)
