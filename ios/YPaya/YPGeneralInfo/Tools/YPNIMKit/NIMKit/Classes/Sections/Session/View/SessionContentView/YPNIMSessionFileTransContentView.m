//
//  YPNIMSessionFileTransContentView.m
//  NIM
//
...
#import "YPNIMSessionFileTransContentView.h"
#import "UIView+NIM.h"
#import "YPNIMMessageModel.h"
#import "UIImage+YPNIMKit.h"
#import "YPNIMKit.h"

@interface YPNIMSessionFileTransContentView()
...
@implementation YPNIMSessionFileTransContentView
...
- (void)refresh:(YPNIMMessageModel *)data{
    ...
    self.titleLabel.font = [[YPNIMKit sharedKit].config setting:data.message].font;
    self.titleLabel.text = fileObject.displayName;
    [self.titleLabel sizeToFit];
    
    self.sizeLabel.font = [[YPNIMKit sharedKit].config setting:data.message].font;
