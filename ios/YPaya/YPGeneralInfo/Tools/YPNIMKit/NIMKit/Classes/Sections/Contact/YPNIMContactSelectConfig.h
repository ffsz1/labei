...
@protocol YPNIMContactSelectConfig <NSObject>
 ...
 *  内置配置-选择好友
 */
@interface NIMContactFriendSelectConfig : NSObject<YPNIMContactSelectConfig>
 ...
 *  内置配置-选择机器人
 */
@interface NIMContactRobotSelectConfig : NSObject<YPNIMContactSelectConfig>
 ...
 *  内置配置-选择群成员
 */
@interface NIMContactTeamMemberSelectConfig : NSObject<YPNIMContactSelectConfig>
 ...
 *  内置配置-选择群
 */
@interface NIMContactTeamSelectConfig : NSObject<YPNIMContactSelectConfig>
