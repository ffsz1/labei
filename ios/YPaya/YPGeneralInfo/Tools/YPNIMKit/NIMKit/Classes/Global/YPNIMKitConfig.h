...
@interface YPNIMKitConfig : NSObject
 ...
 *  文本类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *textSetting;

/**
 *  音频类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *audioSetting;

/**
 *  视频类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *videoSetting;

/**
 *  文件类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *fileSetting;

/**
 *  图片类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *imageSetting;

/**
 *  地理位置类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *locationSetting;

/**
 *  提示类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *tipSetting;

/**
 *  机器人类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *robotSetting;

/**
 *  无法识别类型消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *unsupportSetting;

/**
 *  群组通知类型通知消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *teamNotificationSetting;

/**
 *  聊天室类型类型通知消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *chatroomNotificationSetting;

/**
 *  网络电话类型类型通知消息设置
 */
@property (nonatomic, strong) YPNIMKitSetting *netcallNotificationSetting;
