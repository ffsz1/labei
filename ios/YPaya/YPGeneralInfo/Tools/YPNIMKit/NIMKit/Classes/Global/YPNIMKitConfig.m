...
{
    return @[[YPNIMMediaItem item:@"onTapMediaItemPicture:"
...
- (YPNIMKitSetting *)setting:(NIMMessage *)message
{
...
{
    _textSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _audioSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _videoSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _fileSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _imageSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _locationSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _tipSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _robotSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _unsupportSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _teamNotificationSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _chatroomNotificationSetting = [[YPNIMKitSetting alloc] init:_isRight];
...
{
    _netcallNotificationSetting = [[YPNIMKitSetting alloc] init:_isRight];
