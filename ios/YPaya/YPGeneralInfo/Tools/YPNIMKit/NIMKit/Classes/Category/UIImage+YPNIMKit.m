...
@implementation UIImage (YPNIMKit)
...
+ (UIImage *)nim_imageInKit:(NSString *)imageName{
    NSString *name = [[[YPNIMKit sharedKit] resourceBundleName] stringByAppendingPathComponent:imageName];
...
{
    NSString *name = [[[YPNIMKit sharedKit] emoticonBundleName] stringByAppendingPathComponent:imageName];
...
{
    CGFloat pixels = [[YPNIMKitDevice currentDevice] suggestImagePixels];
