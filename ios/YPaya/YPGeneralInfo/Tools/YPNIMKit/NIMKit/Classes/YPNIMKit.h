...
//! Project version number for YPNIMKit.
FOUNDATION_EXPORT double NIMKitVersionNumber;

//! Project version string for YPNIMKit.
FOUNDATION_EXPORT const unsigned char NIMKitVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <YPNIMKit/PublicHeader.h>
...
#import "YPNIMMediaItem.h"            //多媒体面板对象
#import "YPNIMMessageModel.h"         //message Wrapper
...
#import "YPNIMKitEvent.h"             //点击事件封装类
 ...
 *  独立聊天室模式下需注入的信息
 */
#import "YPNIMKitIndependentModeExtraInfo.h"

@interface YPNIMKit : NSObject
 ...
 *  UI 配置器
 */
@property (nonatomic,strong) YPNIMKitConfig *config;
 ...
 *
 *  此字段需要配合默认的 NIMKitDataProvider ( YPNIMKitDataProviderImpl ) 使用，如果上层自己定义了 provider ， 则忽略此字段。
 */
@property (nonatomic,strong)  YPNIMKitIndependentModeExtraInfo *independentModeExtraInfo;
 ...
 *  机器人消息模板解析器
 */
@property (nonatomic,strong)    YPNIMKitRobotDefaultTemplateParser *robotTemplateParser;
