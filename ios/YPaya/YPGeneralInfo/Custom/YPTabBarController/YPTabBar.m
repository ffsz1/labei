...
- (void)initView{
    ...
    //  设定button大小为适应图片
    UIImage *normalImage = [UIImage imageNamed:@"yp_tabBar_center"];
...
//            YPFirstHomeViewController YPMessageVC YPSpeedMatchVC YPMyViewController
            
            NSString *vcName = [self topViewController].className;
            
            if (![vcName isEqualToString:@"YPFirstHomeViewController"]
                &&![vcName isEqualToString:@"YPMessageVC"]
                &&![vcName isEqualToString:@"YPSpeedMatchVC"]
                &&![vcName isEqualToString:@"YPMyViewController"]) {
                return view;
            }
