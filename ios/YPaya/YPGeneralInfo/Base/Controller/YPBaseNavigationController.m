...
@interface YPBaseNavigationController () <UIGestureRecognizerDelegate>
...
- (void)initNavWithVC:(UIViewController *)viewController {
    UIBarButtonItem *leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"yp_nav_bar_back"] style:UIBarButtonItemStylePlain target:self action:@selector(backClick)];
