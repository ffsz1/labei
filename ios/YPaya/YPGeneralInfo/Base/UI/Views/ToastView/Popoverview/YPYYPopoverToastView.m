...
#import "YPYYPopoverToastView.h"
#import "YPUIViewUtils.h"

const static NSInteger kPopoverViewTag = 12345678;

@interface YPYYPopoverToastView ()
...
@implementation YPYYPopoverToastView
...
//    imageView.layer.cornerRadius = 6;
    ...
    // 多颜色
    UIColor *color = [[YPYYTheme defaultTheme] getColorWithColorString:COLOR_3];
...
//    [wrapperView addSubview:imageView];
    ...
    switch (side) {
        case YYPopoverSideUp:
            ...
            toastRect.origin.y = inView.y - wrapperHeight;
        ...
        case YYPopoverSideDown:
            ...
            toastRect.origin.y = inView.y + inView.height + 15;
            toastRect.origin.x = rc.origin.x - wrapperWidth + rc.size.width;
...
- (void)hidePopoverView {
    ...
    [YPYYPopoverToastView YYPopoverToastViewHide];
}
