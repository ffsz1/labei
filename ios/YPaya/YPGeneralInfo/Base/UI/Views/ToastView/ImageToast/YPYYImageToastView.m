...
@implementation YPYYImageToastView

+ (instancetype)ImageToastViewWithMessage:(NSString *)message Image:(UIImage*)image
{
    
    YPYYImageToastView *view = [[YPYYImageToastView alloc] initWithMessage:message image:image];
