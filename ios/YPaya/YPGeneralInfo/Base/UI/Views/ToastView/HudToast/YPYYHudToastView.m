...
@implementation YPYYHudToastView

+ (instancetype)HudToastViewWithAttributedMessage:(NSAttributedString *)attributed
                                           inRect:(CGRect)lastViewRect {
    
    YPYYHudToastView *view = [[YPYYHudToastView alloc] initWithAttributedMessage:attributed inRect:lastViewRect];
