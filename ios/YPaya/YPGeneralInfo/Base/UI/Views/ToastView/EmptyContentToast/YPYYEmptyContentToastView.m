...
@interface YPYYEmptyContentToastView ()
...
@implementation YPYYEmptyContentToastView

@synthesize titleLabel = _titleLabel;

+ (instancetype)instantiateEmptyContentToast
{
    YPYYEmptyContentToastView *view = [[[NSBundle mainBundle] loadNibNamed:@"YYEmptyContentToast" owner:nil options:nil] firstObject];
...
{
    YPYYEmptyContentToastView *view = [[[NSBundle mainBundle] loadNibNamed:@"YYEmptyContentToast"
                                                                   owner:nil
