...
@interface YPRedPacketView() <CALayerDelegate,CAAnimationDelegate>
//已打开
...
@implementation YPRedPacketView

+ (instancetype)loadFromNib {
    return [[NSBundle mainBundle]loadNibNamed:@"YPRedPacketView" owner:self options:nil].lastObject;
}
...
- (IBAction)goCheckButtonClick:(UIButton *)sender {
    ...
    TYAlertController *alert = (TYAlertController *)[[YPRoomViewControllerCenter defaultCenter]getCurrentVC];
    if (needPop) {
        [alert dismissViewControllerAnimated:YES completion:^{
            UINavigationController *nav = [[YPRoomViewControllerCenter defaultCenter]currentNavigationController];
