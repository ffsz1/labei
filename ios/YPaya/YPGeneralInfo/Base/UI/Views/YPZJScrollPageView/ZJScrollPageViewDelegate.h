...
@class YPZJContentView;
@class YPZJTitleView;
@class YPZJCollectionView;
...
- (BOOL)scrollPageController:(UIViewController *)scrollPageController contentScrollView:(YPZJCollectionView *)scrollView shouldBeginPanGesture:(UIPanGestureRecognizer *)panGesture;

- (void)setUpTitleView:(YPZJTitleView *)titleView forIndex:(NSInteger)index;
