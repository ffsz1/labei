...
@interface YPZJSegmentStyle : NSObject
...
@property (assign, nonatomic) BOOL setSpLineWidth;
...
@property (nonatomic, strong) UIView *rightView;//滚动栏左右视图
@property (nonatomic, strong) UIView *leftView; //左边视图，可用来撑开左边距离

@property (nonatomic, assign) CGFloat titleViewTopSpace;//头部内容距离顶部空间

@property (nonatomic, strong) UIImage *scrollLineImage; //底部滚动的线条改为图片
@property (nonatomic, strong) UIColor *scrollSegmentViewBgColor;
@property (nonatomic, strong) UIColor *scrollContentViewBgColor;

//选择时下标滚动条设置为背景（在礼物排行榜中用）
@property (nonatomic, assign) BOOL scrollLineIsBackground;
