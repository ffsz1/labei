...
@implementation YPSDBrowserImageView
{
    __weak YPSDWaitingView *_waitingView;
    BOOL _didCheckSize;
...
{
    YPSDWaitingView *waiting = [[YPSDWaitingView alloc] init];
    ...
    __weak YPSDBrowserImageView *imageViewWeak = self;
