...
- (id)init {
    ...
    if(self) {
        ...
        if ([YPYCXMenu hasShadow]) {
            self.layer.shadowOpacity = 0.5;
            self.layer.shadowColor = [YPYCXMenu tintColor].CGColor;
...
- (void)setupFrameInView:(UIView *)view fromRect:(CGRect)fromRect {
    ...
    const CGFloat widthPlusArrow = contentSize.width + [YPYCXMenu arrowSize];
    const CGFloat heightPlusArrow = contentSize.height + [YPYCXMenu arrowSize];
    ...
    if (heightPlusArrow < (outerHeight - rectY1)) {
        ...
        _contentView.frame = (CGRect){0, [YPYCXMenu arrowSize], contentSize};

        self.frame = (CGRect) {

            point,
            contentSize.width,
            contentSize.height + [YPYCXMenu arrowSize]
        };
        ...
        _contentView.frame = (CGRect){[YPYCXMenu arrowSize], 0, contentSize};

        self.frame = (CGRect) {

            point,
            contentSize.width + [YPYCXMenu arrowSize],
            contentSize.height
        };
...
- (void)dismissMenu:(BOOL)animated {
    ...
    [YPYCXMenu sharedMenu].isShow = NO;
}

- (void)performAction:(id)sender {
    [self dismissMenu:YES];
    UIButton *button = (UIButton *)sender;
    YPYCXMenuItem *menuItem = _menuItems[button.tag];
...
- (UIView *)mkContentView {
    ...
    UIFont *titleFont = [YPYCXMenu titleFont];

    CGFloat maxImageWidth = 0;
    CGFloat maxItemHeight = 0;
    CGFloat maxItemWidth = 0;

    for (YPYCXMenuItem *menuItem in _menuItems) {
    ...
    for (YPYCXMenuItem *menuItem in _menuItems) {
        ...
        const CGFloat itemHeight = MAX(titleSize.height, imageSize.height) + [YPYCXMenu menuItemMarginY] * 2;
    ...
    UIImage *gradientLine = [YCXMenuView gradientLineWithColor:[YPYCXMenu separatorColor]];
    ...
    for (YPYCXMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.title.length) {
            ...
            if (!menuItem.enabled && !menuItem.image) {
                ...
                titleFrame = (CGRect){
                    kMarginX * 2,
                    [YPYCXMenu menuItemMarginY],
                    maxItemWidth - kMarginX * 4,
                    maxItemHeight - [YPYCXMenu menuItemMarginY] * 2
                };
        ...
        if (menuItem.image) {
            ...
            const CGRect imageFrame = {kMarginX * 2, [YPYCXMenu menuItemMarginY], maxImageWidth, maxItemHeight - [YPYCXMenu menuItemMarginY] * 2};
...
+ (UIImage *)selectedImage:(CGSize)size {
    ...
    CGContextSetFillColorWithColor(context, [[YPYCXMenu selectedColor] CGColor]);
...
- (void)drawBackground:(CGRect)frame inContext:(CGContextRef) context {
    ...
    UIColor *tintColor = [YPYCXMenu tintColor];
    if (tintColor) {
        CGFloat a;
    ...
    if ([YPYCXMenu backgrounColorEffect] == YCXMenuBackgrounColorEffectGradient) {
        R1-=0.2;
        G1-=0.2;
        B1-=0.2;
    }
    ...
    if (_arrowDirection == YCXMenuViewArrowDirectionUp) {
        ...
        const CGFloat arrowX0 = arrowXM - [YPYCXMenu arrowSize];
        const CGFloat arrowX1 = arrowXM + [YPYCXMenu arrowSize];
        const CGFloat arrowY0 = Y0;
        const CGFloat arrowY1 = Y0 + [YPYCXMenu arrowSize] + kEmbedFix;
        ...
        const CGFloat arrowX0 = arrowXM - [YPYCXMenu arrowSize];
        const CGFloat arrowX1 = arrowXM + [YPYCXMenu arrowSize];
        const CGFloat arrowY0 = Y1 - [YPYCXMenu arrowSize] - kEmbedFix;
        ...
        Y1 -= [YPYCXMenu arrowSize];

    } else if (_arrowDirection == YCXMenuViewArrowDirectionLeft) {

        const CGFloat arrowYM = _arrowPosition;
        const CGFloat arrowX0 = X0;
        const CGFloat arrowX1 = X0 + [YPYCXMenu arrowSize] + kEmbedFix;
        const CGFloat arrowY0 = arrowYM - [YPYCXMenu arrowSize];;
        const CGFloat arrowY1 = arrowYM + [YPYCXMenu arrowSize];
        ...
        X0 += [YPYCXMenu arrowSize];

    } else if (_arrowDirection == YCXMenuViewArrowDirectionRight) {

        const CGFloat arrowYM = _arrowPosition;
        const CGFloat arrowX0 = X1;
        const CGFloat arrowX1 = X1 - [YPYCXMenu arrowSize] - kEmbedFix;
        const CGFloat arrowY0 = arrowYM - [YPYCXMenu arrowSize];;
        const CGFloat arrowY1 = arrowYM + [YPYCXMenu arrowSize];
    ...
    UIBezierPath *borderPath = [UIBezierPath bezierPathWithRoundedRect:bodyFrame
                                                          cornerRadius:[YPYCXMenu cornerRadius]];
...
#pragma mark - YPYCXMenu
/// MenuView
static YPYCXMenu                      *gMenu;

@implementation YPYCXMenu {
