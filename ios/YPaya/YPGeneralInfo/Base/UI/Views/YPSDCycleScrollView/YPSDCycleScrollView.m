...
#import "YPSDCollectionViewCell.h"
#import "UIView+SDExtension.h"
#import "YPTAPageControl.h"
...
@interface YPSDCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation YPSDCycleScrollView
...
{
    YPSDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[YPSDCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize
{
    ...
    if ([self.pageControl isKindOfClass:[YPTAPageControl class]]) {
        YPTAPageControl *pageContol = (YPTAPageControl *)_pageControl;
...
- (void)setCurrentPageDotColor:(UIColor *)currentPageDotColor
{
    ...
    if ([self.pageControl isKindOfClass:[YPTAPageControl class]]) {
        YPTAPageControl *pageControl = (YPTAPageControl *)_pageControl;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        {
            YPTAPageControl *pageControl = [[YPTAPageControl alloc] init];
...
{
    YPSDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
    ...
    if (!self.onlyDisplayText && [imagePath isKindOfClass:[NSString class]]) {
        if ([imagePath hasPrefix:@"http"]) {
            ...
            [cell.imageView sd_setImageWithURL:[NSURL URLWithString:imagePath] placeholderImage:self.placeholderImage completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
                if ([weakSelf.delegate respondsToSelector:@selector(cycleScrollView:didDownloadImage:currentDisplayIndex:)] && image) {
                    [weakSelf.delegate cycleScrollView:weakSelf didDownloadImage:image currentDisplayIndex:itemIndex];
                }
            }];
        } else {
