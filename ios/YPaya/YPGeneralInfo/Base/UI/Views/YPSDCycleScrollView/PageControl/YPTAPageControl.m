...
#import "YPTAAnimatedDotView.h"
#import "YPTADotView.h"
...
@implementation YPTAPageControl
...
- (void)initialization
{
    self.dotViewClass           = [YPTAAnimatedDotView class];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (touch.view != self) {
        ...
        if ([self.delegate respondsToSelector:@selector(YPTAPageControl:didSelectPageAtIndex:)]) {
            [self.delegate YPTAPageControl:self didSelectPageAtIndex:index];
        }
    }
}
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[YPTAAnimatedDotView class]] && self.dotColor) {
            ((YPTAAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        YPTAAbstractDotView *abstractDotView = (YPTAAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [YPTAAbstractDotView class]);
        }
