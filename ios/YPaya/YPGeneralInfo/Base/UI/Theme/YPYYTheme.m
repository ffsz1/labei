...
+ (instancetype)defaultTheme
{
    ...
    dispatch_once(&onceToken, ^{
        defaultTheme = [[YPYYDefaultTheme alloc] init];
    });
    return defaultTheme;
}
...
- (void)_applyNavigationConfiguration
{
    ...
    UIImage *backIndicator = [UIImage imageNamed:@"yp_sex_female_logo"];
    [[UINavigationBar appearanceWhenContainedIn:[YPYYNavigationController class], nil] setBackIndicatorImage:backIndicator];
    [[UINavigationBar appearanceWhenContainedIn:[YPYYNavigationController class], nil] setBackIndicatorTransitionMaskImage:backIndicator];
}
