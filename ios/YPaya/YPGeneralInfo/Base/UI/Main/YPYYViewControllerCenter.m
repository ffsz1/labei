...
@implementation YPYYViewControllerCenter
...
+ (UIViewController *)currentViewController{
    ...
    if ([result isKindOfClass:[YPBaseNavigationController class]]) {
        result = [(YPBaseNavigationController *)result topViewController];
    }
