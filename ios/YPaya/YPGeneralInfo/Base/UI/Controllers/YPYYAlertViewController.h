...
@class YPYYAlertViewController;

typedef void (^YYAlertViewControllerButtonBlock)(YPYYAlertViewController *controller);
...
@interface YPYYAlertViewController : UIViewController
