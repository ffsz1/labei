...
@interface YPYYTableViewController ()

@end

@implementation YPYYTableViewController
{
...
- (void)viewDidLoad
{
    ...
    self.tableView.backgroundColor = [YPYYTheme defaultTheme].viewControllerBackgroundColor;
    self.navigationController.navigationBar.titleTextAttributes = @{UITextAttributeTextColor: [[YPYYDefaultTheme defaultTheme] colorWithHexString:@"#333333" alpha:1.0],
