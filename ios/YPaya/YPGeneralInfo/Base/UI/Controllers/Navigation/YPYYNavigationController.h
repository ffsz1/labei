...
#import "YPYYNavigationBar.h"
#import "YPYYInteractivePopTransition.h"

@class YPYYNavigationController;

@protocol YYNavigationControllerDelegate <UINavigationControllerDelegate>

@end

@interface YPYYNavigationController : UINavigationController

@property (nonatomic, weak) id<YYNavigationControllerDelegate> delegate;

@property (nonatomic, strong, readonly) YPYYInteractivePopTransition *interativePopTransition;

@property (nonatomic, readonly) YPYYNavigationBar *navigationBar;
