...
- (void)yy_viewDidLoad
{
    ...
    [UINavigationBar appearance].backIndicatorTransitionMaskImage = [UIImage imageNamed:@"yp_nav_bar_back"];
    [UINavigationBar appearance].backIndicatorImage = [UIImage imageNamed:@"yp_nav_bar_back"];
...
- (YPYYNavigationController *)yy_navigationController
{
    return [self.navigationController isKindOfClass:[YPYYNavigationController class]] ? (YPYYNavigationController *)self.navigationController : nil;
}
