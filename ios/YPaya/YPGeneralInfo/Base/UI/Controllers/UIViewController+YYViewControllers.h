...
@property (nonatomic, weak, readonly) YPYYNavigationController *yy_navigationController;
...
#pragma mark - YPViewController-Based Navigation Bar Appearance
