...
@property (weak, nonatomic) IBOutlet YPYYPhotoListView *photoListView;
...
{
    YPYYPhotoListDataProvider *provider = [[YPYYPhotoListDataProvider alloc] init];
        ...
        [assetLibrary enumerateGroupsWithTypes:ALAssetsGroupSavedPhotos usingBlock:^(ALAssetsGroup *group, BOOL *stop) {
            ...
            switch (error.code) {
                ...
                case ALAssetsLibraryAccessGloballyDeniedError:
                {
                    ...
                    YPYYAlertView *alertView = [[YPYYAlertView alloc] initWithTitle:title message:message];
