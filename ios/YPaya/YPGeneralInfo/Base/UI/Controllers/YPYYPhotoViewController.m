...
@interface YPYYPhotoViewController ()
{
...
@implementation YPYYPhotoViewController
...
- (BOOL) zoomScaleChanged
{
    ...
    [self.view.subviews enumerateObjectsUsingBlock:^(YPImPageImageView* imageView, NSUInteger idx, BOOL *stop) {
        if (imageView && [imageView isKindOfClass:[YPImPageImageView class]]) {
