...
final class LogImpl {
    ...
    public static void i_p(String tag, String msg) {
        i_p(tag, msg, null);
    }

    public static void i_p(String tag, String msg, Throwable tr) {
        o_p(Log.INFO, tag, msg, tr);
    }

    public static void o_p(final int priority, final String tag, final String msg, final Throwable tr) {
