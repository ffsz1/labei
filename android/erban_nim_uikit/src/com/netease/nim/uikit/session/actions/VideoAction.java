...
//    protected VideoMessageHelper videoMessageHelper;
    ...
    public VideoAction() {
        super(R.drawable.icon_video_action, R.string.input_panel_video);

    }

    @Override
    public void onClick() {
        initVideoMessageHelper().showVideoSource(makeRequestCode(RequestCode.GET_LOCAL_VIDEO), makeRequestCode(RequestCode.CAPTURE_VIDEO));
    }

    /**
     * ********************** 视频 *******************************
     */
    private VideoMessageHelper initVideoMessageHelper() {
        VideoMessageHelper videoMessageHelper = new VideoMessageHelper(getActivity(), new VideoMessageHelper.VideoMessageHelperListener() {
