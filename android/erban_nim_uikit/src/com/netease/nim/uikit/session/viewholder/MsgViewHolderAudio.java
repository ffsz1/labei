...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {
            ...
            containerView.setBackgroundResource(R.drawable.nim_message_item_left_new);
            ...
            durationLabel.setTextColor(ContextCompat.getColor(durationLabel.getContext(), R.color.color_316AFF));
            ...
            containerView.setBackgroundResource(R.drawable.nim_message_item_right_new);
