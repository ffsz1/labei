...
/**
 * 创建者     polo
 * 创建时间   2017/8/18 10:05
 * 描述
 * <p>
 * 更新者     $Author$
 * 更新时间   $Date$
 * 更新描述
 * 用于写入保存本地的日志工具类，记录重要的日志信息
 */
public class LogUtils {

    public static void log_d(String title, Object o) {
        Log.d(title, o + "");
    }

    private static Boolean LOG_SWITCH = true; // 日志文件总开关
    private static Boolean LOG_TO_FILE = false; // 日志写入文件开关
    private static String LOG_TAG = "kdys"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + "com.jx.sprout";
        LOG_FILE_NAME = "Log";
    }
