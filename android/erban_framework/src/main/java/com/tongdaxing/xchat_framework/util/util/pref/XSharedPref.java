...
public abstract class XSharedPref
{
    /**
     * 保存在手机里面的文件名
     */
    protected static final String FILE_NAME = "share_data";


    protected final SharedPreferences mPref;

    public XSharedPref(SharedPreferences pref) {
        mPref = pref;
    }
...
//
//	public static void setQuickReply(Context context, Object obj){
//		saveObject(context, "quickReply", obj);
//	}
//
//	public static ArrayList<QuickReply> getQuickReply(Context context){
//		return (ArrayList<QuickReply>) readObject(context,"quickReply");
//	}
//
