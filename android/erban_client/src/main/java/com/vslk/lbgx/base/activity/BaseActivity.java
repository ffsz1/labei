 ...
 * @author alvin hwang
 */
public abstract class BaseActivity extends UI implements IDataStatus, ConnectiveChangedReceiver.ConnectiveChangedListener, EasyPermissions.PermissionCallbacks ,View.OnClickListener,IDisposableAddListener{
