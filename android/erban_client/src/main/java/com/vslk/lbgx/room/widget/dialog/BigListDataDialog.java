...
//                        Log.e("onResponse ", "onResponse: " + data.size());
    ...
    private void setThirdData(List<RoomConsumeInfo> list) {
        ...
        if (list.size() <= 0) {
            goldNick.setText("？？？");
            goldNum.setText(String.valueOf(0));
            ...
            silverNick.setText("？？？");
            silverNum.setText(String.valueOf(0));
            if (type == 1)
            ...
            copperNick.setText("？？？");
            copperNum.setText(String.valueOf(0));
            if (type == 1)
        ...
        if (list.size() == 1) {
            ...
            goldNum.setText(String.valueOf(gold.getSumGold()));
            ...
            silverNum.setText(String.valueOf(silver.getSumGold()));
            ...
            copperNum.setText(String.valueOf(copper.getSumGold()));
    ...
    private void showUserDialog(long account) {
        UserInfoDialog.showUserDialog(getContext(), account);
    }
