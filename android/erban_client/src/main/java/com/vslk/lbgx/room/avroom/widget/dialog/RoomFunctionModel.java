...
public class RoomFunctionModel {
     ...
     * @return
     */
    public RoomFunctionEnum[] getRoomFunctionByType(int roleType, int publicChatSwitch, int vehicleSwitch, int giftSwitch) {
        ...
        switch (roleType) {
            case 0://房主 房间设置 关闭公屏 关闭座驾 关闭礼物 进房提示 管理员 最小化  退出
                return new RoomFunctionEnum[]{RoomFunctionEnum.ROOM_SETTING,
