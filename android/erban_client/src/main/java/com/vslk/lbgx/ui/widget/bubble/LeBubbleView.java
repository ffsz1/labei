...
//        }
        ...
        initContent(radius, backgroundColor, textColor, textSize, contents);
    ...
    private void initContent(float radius, final int backgroundColor, int textColor, float textSize, String... contents) {
        ...
        initChildView(radius, backgroundColor, textColor, textSize, contents);
