...
public class GiftDialog extends BottomSheetDialog implements View.OnClickListener, BaseQuickAdapter.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateData();
        CoreManager.getCore(IPayCore.class).getWalletInfo(CoreManager.getCore(IAuthCore.class).getCurrentUid());//fixme 即时刷新金币，临时解决方案
    ...
    private void showUserDialog(long uid) {
        UserInfoDialog.showUserDialog(context, uid);
    }
