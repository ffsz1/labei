...
//    public static final String BASE_APP_TAG = UriProvider.JAVA_WEB_URL + "";
     ...
     * 首页推荐榜-绿色公约图片
     */
    public static final String HOME_RECOMMEND_GREEN_CONVERTION =  "https://pic.hnyueqiang.com//bg_green_convention.png";
    /**
     * 首页推荐榜-绿色公约URL
     */
    public static final String HOME_RECOMMEND_GREEN_CONVERTION_URL = UriProvider.JAVA_WEB_URL + "/front/convention/index.html";
    /**
     * 首页推荐榜-虚位以待
     */
    public static final String HOME_RECOMMEND_PLACEHOLDER = "https://pic.hnyueqiang.com//bg_placeholder.png";
    /**
     * 首页推荐榜-虚位以待URL
     */
    public static final String HOME_RECOMMEND_PLACEHOLDER_URL = "http://hnyueqiang.com/front/hotroom/index.html";
    //用户协议
    public static final String USER_AGREEMENT = UriProvider.JAVA_WEB_URL + "/front/agreement/agreement.html";
    //用户隐私
    public static final String USER_POLICY = UriProvider.JAVA_WEB_URL + "/front/agreement/privacy.html";
    //常见问题
    ...
    //提现规则
    public static final String WITTH_DRAW = UriProvider.JAVA_WEB_URL + "/front/diamond/index.html";
    //幸运点点抽
    ...
    //直播协议
    public static final String LIVE_RULE = UriProvider.JAVA_WEB_URL + "/front/agreement/live.html";
    //注销账号
    public static final String DELE_NUM = UriProvider.JAVA_WEB_URL + "/front/sign_out/index.html";
}
