...
@interface HJFamilyChatSetVC ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,NIMChatManagerDelegate,NIMTeamManagerDelegate>
...
@implementation HJFamilyChatSetVC
...
- (IBAction)moreMemberBtnAction:(id)sender {
    ...
    HJFamilyChatMemberVC *vc = [[UIStoryboard storyboardWithName:@"HJFamily" bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"HJFamilyChatMemberVC"];
