//
//  HJFamilyAnnouncementViewController.m
//  HJLive
//
...
@interface HJFamilyAnnouncementViewController ()<HJFamilyCoreClient>
...
@implementation HJFamilyAnnouncementViewController
...
- (void)saveAnnouncement {
    ...
    [GetCore(HJFamilyCore) familyEditFamilyTeamWithFamilyId:self.familyId logo:self.familyLogo backgroundImage:self.familyBackground notice:self.textView.text];
}
