...
@interface HJFamilyMemberSettingCell ()
...
@implementation HJFamilyMemberSettingCell
...
- (UIButton *)actionButon {
    if (!_actionButon) {
        ...
        [_actionButon setImage:[UIImage imageNamed:@"hj_family_icon_delete"] forState:UIControlStateNormal];
        @weakify(self);
