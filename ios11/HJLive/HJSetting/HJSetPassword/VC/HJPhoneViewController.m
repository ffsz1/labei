...
@interface HJPhoneViewController ()
...
@implementation HJPhoneViewController
...
//        }];
        ...
        [HJHttpRequestHelper requestSmsCode:self.phoneTextField.text type:self.isBindingPhone?@3:@2 success:^{
...
- (IBAction)bindingBtnAction:(id)sender {
    ...
    if (self.isBindingPhone) {
        ...
        __weak typeof(self)weakSelf = self;
        [HJHttpRequestHelper requestConfirmCode:self.phoneTextField.text smsCode:self.codeTextField.text success:^{
            
            HJSetPasswordViewController *vc = HJSetPasswordtoryBoard(@"HJSetPasswordViewController");
        ...
        __weak typeof(self)weakSelf = self;
        [HJHttpRequestHelper bindingPhoneNumber:self.phoneTextField.text verifyCode:self.codeTextField.text Success:^(BOOL result) {
