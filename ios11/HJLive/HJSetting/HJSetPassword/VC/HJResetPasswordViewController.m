//
//  HJResetPasswordViewController.m
//  HJLive
//
...
#import "HJResetPasswordViewController.h"

#import "HJHttpRequestHelper+Auth.h"
#import "HJUserCoreHelp.h"
#import "UserInfo.h"

@interface HJResetPasswordViewController ()
...
@implementation HJResetPasswordViewController
...
- (IBAction)commitBtnAction:(id)sender {
    ...
    [HJHttpRequestHelper requestResetPwd:self.changePswTextField.text oldPwd:self.nowPasswordTextField.text confirmPwd:self.surePswTextField.text success:^{
