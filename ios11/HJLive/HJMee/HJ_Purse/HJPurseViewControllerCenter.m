...
@interface HJPurseViewControllerCenter()<HJBalanceErrorClient>

@end
@implementation HJPurseViewControllerCenter
...
- (void)showRechargeAlert
{
    ...
    // 呈现警告视图
    UIViewController *current = [YYViewControllerCenter currentVisiableRootViewController];
