...
@interface HJAlerVerificationCodeView()
...
@end
@implementation HJAlerVerificationCodeView


+ (void)show:(HJAlerVerificationCodeBlock)menuBlock content:(NSString*)content nick:(NSString*)nick isAttribute:(BOOL)isAttribute
{
    HJAlerVerificationCodeView *shareView = [[NSBundle mainBundle]loadNibNamed:@"HJAlerVerificationCodeView" owner:self options:nil][0];
