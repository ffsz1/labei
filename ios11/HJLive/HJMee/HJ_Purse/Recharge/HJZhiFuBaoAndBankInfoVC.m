...
@interface HJZhiFuBaoAndBankInfoVC ()<UITextFieldDelegate>
...
@implementation HJZhiFuBaoAndBankInfoVC
...
-(void)getFinancialAccountData{
    ...
    [HJHttpRequestHelper requestGetFinancialAccount:[GetCore(HJAuthCoreHelp).getUid userIDValue] success:^(HJFinancialAccountDataModel *model) {
...
- (IBAction)zhifubaoBtnAction:(id)sender {
    ...
    _zhifubaoBtn.selected = YES;
    [_zhifubaoBtn setImage:[UIImage imageNamed:@"hj_tixianway_icon_yes"] forState:UIControlStateNormal];
     [_bankBtn setImage:[UIImage imageNamed:@"hj_tixianway_icon_no"] forState:UIControlStateNormal];
...
- (IBAction)bankBtnAction:(id)sender {
    ...
    _bankBtn.selected = YES;
     ...
     [_bankBtn setImage:[UIImage imageNamed:@"hj_tixianway_icon_yes"] forState:UIControlStateNormal];
     [_zhifubaoBtn setImage:[UIImage imageNamed:@"hj_tixianway_icon_no"] forState:UIControlStateNormal];
