...
@interface FYCashBindingView()
@property (weak, nonatomic) IBOutlet UIView *cashBindView;
//XBDverticalButton *wxCashButton;

@property (weak, nonatomic) IBOutlet HJverticalButton *wxCashBtn;

@property (weak, nonatomic) IBOutlet HJverticalButton *bankButton;
...
@end
@implementation FYCashBindingView


+ (void)show:(RoomMenuBlock)menuBlock
{
    FYCashBindingView *shareView = [[NSBundle mainBundle]loadNibNamed:@"FYCashBindingView" owner:self options:nil][0];
