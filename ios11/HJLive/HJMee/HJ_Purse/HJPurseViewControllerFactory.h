//
//  HJPurseViewControllerFactory.h
//  HJLive
//
...
@interface HJPurseViewControllerFactory : YYStoryboardViewControllerFactory
...
- (UIViewController *)instantiateFYExchangeGoldVC;//兑换开心
