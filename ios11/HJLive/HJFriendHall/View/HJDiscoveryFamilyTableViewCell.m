//
//  HJDiscoveryFamilyTableViewCell.m
//  HJLive
//
...
@interface HJDiscoveryFamilyTableViewCell ()
...
@implementation HJDiscoveryFamilyTableViewCell
...
- (void)setupAvatar:(NSString *)avatar
    ...
    if (index == 0) {
        [self.bgContenView setImage:[[UIImage imageNamed:@"hj_discovery_icon_diyimin"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,100,0,100) resizingMode:UIImageResizingModeStretch]];
    } else {
        [self.bgContenView setImage:[[UIImage imageNamed:@"hj_discovery_icon_qita"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,100,0,100) resizingMode:UIImageResizingModeStretch]];
    }
...
- (UIImageView *)bgContenView {
    if (!_bgContenView) {
        _bgContenView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"hj_discovery_icon_qita"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,100,0,100) resizingMode:UIImageResizingModeStretch]];
...
- (UIImageView *)countLabelIcon {
    if (!_countLabelIcon) {
        _countLabelIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"hj_discovery_icon_jinbin"]];
    }
