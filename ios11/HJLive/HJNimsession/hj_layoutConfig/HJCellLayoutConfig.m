...
@interface HJCellLayoutConfig()
@property (nonatomic,strong)    NSArray    *types;
@property (nonatomic,strong) HJSessionCustomContentConfig *sessionCustomconfig;
@end

@implementation HJCellLayoutConfig
- (instancetype)init
{
    if (self = [super init])
    {
        _types =  @[
                    @"HJOpenLiveAttachment",
                    @"HJRedPacketInfoAttachment",
                    @"HJNewsInfoAttachment",
                    @"HJGiftAttachment",
                    @"HJInviteMicAttachment",
                    @"TurntableAttachment"
                    ];
        _sessionCustomconfig = [[HJSessionCustomContentConfig alloc] init];
    }
    return self;
}
