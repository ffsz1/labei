...
@interface HJImagePreViewVC ()

@end

@implementation HJImagePreViewVC
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = NSLocalizedString(XCMesseageImageLookingTitle, nil);
    ...
    [self.imageView qn_setImageImageWithUrl:self.ImageUrl placeholderImage:default_bg type:ImageTypeUserLibaryDetail];
