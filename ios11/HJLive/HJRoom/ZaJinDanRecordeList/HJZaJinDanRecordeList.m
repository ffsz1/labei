...
@interface HJZaJinDanRecordeList ()<UITableViewDelegate,UITableViewDataSource,HJRoomCoreClient>
...
@implementation HJZaJinDanRecordeList
...
- (void)awakeFromNib {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"HJZaJinDanRecordeCell" bundle:nil] forCellReuseIdentifier:@"HJZaJinDanRecordeCell"];
    
    self.tableView.mj_header = [HJRefreshFactory headerRefreshWithTarget:self refreshingAction:@selector(requestForNewData)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HJZaJinDanRecordeCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HJZaJinDanRecordeCell"];
...
- (void)requestForData {
    ...
    [GetCore(HJRoomCoreV2Help) userGiftPurseRecordWithPageNum:self.page pageSize:self.pageSize];
}
