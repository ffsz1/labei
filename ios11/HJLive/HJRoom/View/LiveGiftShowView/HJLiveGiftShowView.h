...
@interface HJLiveGiftShowView : UIView
...
@property (nonatomic ,strong) HJLiveGiftShowModel * model;

@property (nonatomic ,weak) HJLiveGiftShowNumberView * numberView;
...
@property (nonatomic ,copy) void(^HJLiveGiftShowViewTimeOut)(HJLiveGiftShowView *);
