...
#import "HJLiveGiftShowNumberView.h"
#import "Masonry.h"

@interface HJLiveGiftShowNumberView ()
...
@implementation HJLiveGiftShowNumberView
...
- (void)changeNumber:(NSInteger)numberStr{
    ...
    self.digitIV.image = [UIImage imageNamed:[NSString stringWithFormat:@"hj_w_%zi",ge]];
    ...
    if (qian > 0) {
        ...
        self.thousandIV.image = [UIImage imageNamed:[NSString stringWithFormat:@"hj_w_%zi",qian]];
        self.hundredIV.image = [UIImage imageNamed:[NSString stringWithFormat:@"hj_w_%zi",bai]];
        self.ten_digitIV.image = [UIImage imageNamed:[NSString stringWithFormat:@"hj_w_%zi",shi]];
...
- (UIImageView *)xIV{
    if (!_xIV) {
        _xIV = [self creatIV];
        _xIV.image = [UIImage imageNamed:@"hj_w_x"];
    }
    return _xIV;
}
