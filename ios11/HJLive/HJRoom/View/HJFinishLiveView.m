...
@implementation HJFinishLiveView
+ (instancetype)loadFromNIB
{
    return [[NSBundle mainBundle] loadNibNamed:@"HJFinishLiveView" owner:nil options:nil].firstObject;
}
...
- (void)onHomePageClicked:(id) tap
{
    ...
    [[YYViewControllerCenter currentViewController].navigationController pushViewController:vc animated:YES];
