...
typedef void(^TapCallTypeBlock)(HJCallType type,HJDaCallIntoModel* _Nullable model);
NS_ASSUME_NONNULL_BEGIN

@interface HJCallView : UIView
@property (nonatomic,strong) HJDaCallIntoModel* intoModel;
...
@property (nonatomic,strong) HJIMQueueItem *queueItem;
@property (nonatomic,strong) HJIMQueueItem *queueItem2;
@property (nonatomic,strong) HJIMQueueItem *queueItem3;
@property (nonatomic,strong) HJIMQueueItem *queueItem4;
@property (nonatomic,strong) HJIMQueueItem *queueItem5;
@property (nonatomic,strong) HJIMQueueItem *queueItem6;
@property (nonatomic,strong) HJIMQueueItem *queueItem7;
@property (nonatomic,strong) HJIMQueueItem *queueItem8;
...
@property (weak, nonatomic) IBOutlet UILabel *jinbiNumLabel;//开心数量
