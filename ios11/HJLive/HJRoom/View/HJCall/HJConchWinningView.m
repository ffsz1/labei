...
#import "HJConchWinningView.h"
#import "HJConchWinModel.h"
@interface HJConchWinningView()<UICollectionViewDelegate,
UICollectionViewDataSource,
UICollectionViewDelegateFlowLayout>

@end

@implementation HJConchWinningView
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    HJConchWinModel *tag = [self.tagList safeObjectAtIndex:indexPath.row];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    HJConchWinModel *tag = [self.tagList safeObjectAtIndex:indexPath.row];
    HJConchWinCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"HJConchWinCollectionCell" forIndexPath:indexPath];
