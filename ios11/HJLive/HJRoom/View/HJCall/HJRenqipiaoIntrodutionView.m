...
@implementation HJRenqipiaoIntrodutionView

+ (void)showRenqipiaoIntrodutionView
{
    HJRenqipiaoIntrodutionView *shareView = [[NSBundle mainBundle]loadNibNamed:@"HJRenqipiaoIntrodutionView" owner:self options:nil][0];
