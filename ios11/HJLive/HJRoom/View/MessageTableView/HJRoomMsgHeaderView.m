...
#import "HJRoomMsgHeaderView.h"

#import "HJGiftCore.h"

@implementation HJRoomMsgHeaderView
...
- (void)setModel:(GiftReceiveInfo *)model {
    ...
    GiftInfo *giftInfo = [GetCore(HJGiftCore) findGiftInfoByGiftId:model.giftId giftyType:GiftTypeNormal];
