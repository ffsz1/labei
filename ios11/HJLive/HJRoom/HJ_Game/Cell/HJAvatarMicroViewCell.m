...
#import "HJAvatarMicroViewCell.h"

@interface HJAvatarMicroViewCell ()
...
@implementation HJAvatarMicroViewCell
...
- (void)resetAvatarSelectStyle {
    ...
    self.avatarImageView.layer.borderWidth = 0.5;
    self.avatarImageView.layer.borderColor = UIColorHex(FF0267).CGColor;
    [self.avatarImageView setImage:[UIImage imageNamed:@"hj_login_logo"]];
}
