...
@interface HJRoomBackgroundSeetingCell ()
...
@implementation HJRoomBackgroundSeetingCell
...
- (UIButton *)tickButton {
    if (!_tickButton) {
        ...
        [_tickButton setImage:[UIImage imageNamed:@"g (1)"] forState:UIControlStateNormal];
