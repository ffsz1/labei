...
@implementation HJHttpRequestHelper (PK)
...
+ (void)pk_getProbability:(void (^)(NSArray* arr))success
    ...
    [HJHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        NSArray *arr = [NSArray yy_modelArrayWithClass:[HJRoomPKProbability class] json:data];
...
+ (void)pk_getMoraInfo:(NSInteger)probability
    ...
    [HJHttpRequestHelper GET:method params:params success:^(id data) {
        ...
        if ([[data allKeys] containsObject:@"giftInfoVOList"]) {
            arr = [NSArray yy_modelArrayWithClass:[HJRoomPKGiftModel class] json:data[@"giftInfoVOList"]];
        }
