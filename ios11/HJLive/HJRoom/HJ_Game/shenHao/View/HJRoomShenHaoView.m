...
@implementation HJRoomShenHaoView

+ (void)show:(HJRoomBounsListInfo *)info
{
    HJRoomShenHaoView *shareView = [[NSBundle mainBundle]loadNibNamed:@"HJRoomShenHaoView" owner:self options:nil][0];
