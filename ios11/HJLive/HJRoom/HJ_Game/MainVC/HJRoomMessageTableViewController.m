//
//  HJRoomMessageTableViewController.m
//  HJLive
//
...
@interface HJRoomMessageTableViewController ()

@property (nonatomic, strong) UIView *bV;

@end

@implementation HJRoomMessageTableViewController
...
//    self.bV.frame = self.view.bounds;
    ...
    HJRoomMessageview *messageview = [[NSBundle mainBundle] loadNibNamed:@"HJRoomMessageview" owner:nil options:nil][0];
...
//    }];
    ...
    HJSessionViewController *vc = [[HJSessionViewController alloc] initWithSession:self.recentSession.session];
    ;
