...
#import "HJRoomPopupCollectionViewCell.h"

#define HJRoomPopupViewItemH (100)
#define HJRoomPopupViewItemW ((XC_SCREE_W-(20*5))/4)

@interface HJRoomPopupView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation HJRoomPopupView
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    HJRoomPopupCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"HJRoomPopupCollectionViewCell" forIndexPath:indexPath];
    HJRoomPopupItem *item = [self.items safeObjectAtIndex:indexPath.row];
...
- (void)setItems:(NSArray<HJRoomPopupItem *> *)items {
    _items = items;
...
- (UICollectionView *)collectionView {
    ...
    if (!_collectionView) {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:@"HJRoomPopupCollectionViewCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"HJRoomPopupCollectionViewCell"];
    }
