...
@implementation HJLoginRegisterView
...
- (void)awakeFromNib
{
    ...
    _codeImgView.layer.borderColor = [UIColor colorWithHexString:@"#EFEFF4"].CGColor;
...
- (IBAction)codeBtnAction:(id)sender {
    ...
    [GetCore(HJAuthCoreHelp) requestRegistSmsCode:self.phoneTextF.text];
...
- (IBAction)registerbtnAction:(id)sender {
    ...
    [GetCore(HJAuthCoreHelp) regist:self.phoneTextF.text password:self.passwordTextF.text smsCode:self.codeTextF.text];
}
