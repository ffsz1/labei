...
@implementation HJLoginBindingPhoneView
...
- (IBAction)codeBtnAction:(id)sender {
    ...
    @weakify(self)
    [HJHttpRequestHelper requestSmsCode:self.phoneTextF.text type:@2 success:^{
        @strongify(self)
...
- (IBAction)nextBtnAction:(id)sender {
    ...
    @weakify(self);
    [HJHttpRequestHelper bindingPhoneNumber:self.phoneTextF.text verifyCode:self.codeTextF.text Success:^(BOOL success) {
