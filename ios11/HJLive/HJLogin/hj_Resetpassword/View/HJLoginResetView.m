...
@implementation HJLoginResetView
...
- (void)awakeFromNib
{
    ...
    _yanzhengImgView.layer.borderColor = [UIColor colorWithHexString:@"#EFEFF4"].CGColor;
    _yanzhengImgView.layer.borderWidth = 1;
    _rePassImgView.layer.borderColor = [UIColor colorWithHexString:@"#EFEFF4"].CGColor;
...
- (IBAction)codeBtnAction:(id)sender {
    ...
    [GetCore(HJAuthCoreHelp) requestResetSmsCode:self.phoneTextF.text];
...
- (IBAction)changeBtnAction:(id)sender {
    ...
    [GetCore(HJAuthCoreHelp) requestResetPwd:self.phoneTextF.text newPwd:self.passwordTextF.text smsCode:self.codeTextF.text];
