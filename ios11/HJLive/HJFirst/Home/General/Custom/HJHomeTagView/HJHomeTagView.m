...
#import "HJHomeTagCCell.h"

#import "HJHomeTag.h"
@implementation HJHomeTagView
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HJHomeTag *tag = [self.roomTagList safeObjectAtIndex:indexPath.item];
...
{
    HJHomeTagCCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"HJHomeTagCCell" forIndexPath:indexPath];
...
- (void)setScrollTag:(NSInteger)item
{
    ...
    //复位上一次选中的cell样式
    HJHomeTagCCell *cell = (HJHomeTagCCell *)[self.collectView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:self.sel inSection:0]];
    ...
    //设置当前选择cell样式
    //    GGHomeTagCCell *cell_sel = (GGHomeTagCCell *)[self.collectView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:self.sel inSection:0]];
    //    cell_sel.isSel = YES;
}
...
- (void)setStytle:(HJFirstHomeTagStytleModel *)stytle
{
    _stytle = stytle;
    [self.collectView reloadData];
}
...
- (UICollectionView *)collectView
{
    if (!_collectView) {
        ...
        [_collectView registerNib:[UINib nibWithNibName:@"HJHomeTagCCell" bundle:nil] forCellWithReuseIdentifier:@"HJHomeTagCCell"];
