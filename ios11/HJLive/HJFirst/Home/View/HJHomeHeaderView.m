...
- (void)awakeFromNib {
    [super awakeFromNib];
    self.bannerContainerView.placeholderImage = [UIImage imageNamed:@"hj_home_weekStar"];
   self.hj_jiaoyou_trailing_layout.constant= iPhoneX?92:55;
      if (kScreenWidth>380) {
           self.hj_jiaoyou_trailing_layout.constant= 92;
      }
...
- (void)scrollNextMsgView
{
    ...
    if (self.index<self.imRoomMsgArr.count) {
        ...
        HJIMMessage *message = [self.imRoomMsgArr safeObjectAtIndex:self.index];
        ...
        HJIMMessage *nexMessage = [self.imRoomMsgArr safeObjectAtIndex:nextIndex];
...
- (void)setIMMessageModel1:(HJIMMessage *)message
{
    
    if (message == nil) {
        return;
    }
     Attachment *attachment = [Attachment yy_modelWithJSON:message];
...
//            Attachment *attachment = (Attachment *)obj.attachment;
            ...
            if (dic) {
                ...
                if ([dic containsObjectForKey:@"params"]) {
                    ...
                    if (uid == miamiaoUid) {
                        // hj官方
                        self.avatarImageView2.image = [UIImage imageNamed:@"hj_guanfang"];
                    }
                }
...
- (void)setIMMessageModel2:(HJIMMessage *)message
{
    if (message == nil) {
        return;
    }
...
//            Attachment *attachment = (Attachment *)obj.attachment;
            ...
            if (dic) {
                ...
                if ([dic containsObjectForKey:@"params"]) {
                    ...
                    if (uid == miamiaoUid) {
                        // HJ官方
                        self.avatarImage3.image = [UIImage imageNamed:@"hj_guanfang"];
                    }
                }
...
- (void)setIMMessageModel3:(HJIMMessage *)message
{
    if (message == nil) {
        return;
    }
...
//            Attachment *attachment = (Attachment *)obj.attachment;
            ...
            if (dic) {
                ...
                if ([dic containsObjectForKey:@"params"]) {
                    ...
                    if (uid == miamiaoUid) {
                        // hj官方
                        self.avatar2.image = [UIImage imageNamed:@"hj_guanfang"];
                    }
                }
...
- (void)setIMMessageModel4:(HJIMMessage *)message
{
    if (message == nil) {
        return;
    }
...
//            Attachment *attachment = (Attachment *)obj.attachment;
            ...
            if (dic) {
                ...
                if ([dic containsObjectForKey:@"params"]) {
                    ...
                    if (uid == miamiaoUid) {
                        // hj官方
                        self.avatar3.image = [UIImage imageNamed:@"hj_guanfang"];
                    }
                }
