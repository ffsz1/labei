...
@interface HJHomePeipeiTableCell()
...
@end
@implementation HJHomePeipeiTableCell
...
- (void)initData
{
    if (self.roomArr.count>0) {
          HJHomePeipeiModel  *room = self.roomArr[0];
        ...
        if (room.gender == 1) {
            _sexImageView.image = [UIImage imageNamed:@"hj_home_attend_man"];
             ...
             _sexImageView.image = [UIImage imageNamed:@"hj_home_attend_woman"];
        }
        
    }
    
    if (self.roomArr.count>1) {
        HJHomePeipeiModel *room = self.roomArr[1];
        ...
        if (room.gender == 1) {
             _sexImageView2.image = [UIImage imageNamed:@"hj_home_attend_man"];
             _roomImageView2.layer.borderColor = [UIColor colorWithHexString:@"#7ECDFF"].CGColor;
        }else{
             _sexImageView2.image = [UIImage imageNamed:@"hj_home_attend_woman"];
