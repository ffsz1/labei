...
#import "FYTool.h"
@implementation HJFirstHomeSectionView
...
{
    if (!_arrowImageView) {
        _arrowImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"hj_home_attend_arrow"]];
...
//        [_leftBtn setTitleColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"hj_wenzhi_img_80"]] forState:UIControlStateNormal];
...
//         _lineView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"hj_colorTitleBG"]];
//         [_lineView.layer addSublayer:[FYTool gradientLayerFromColorStrForPoint:@"#60A6FF" toColorStr:@"#E27CFF" height:2 width:64 endpoint:CGPointMake(1.0, 0)]];
...
//         _lineView2.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"hj_colorTitleBG"]];
//         [_lineView2.layer addSublayer:[FYTool gradientLayerFromColorStrForPoint:@"#60A6FF" toColorStr:@"#E27CFF" height:2 width:64 endpoint:CGPointMake(1.0, 0)]];
...
//        _lineView3.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"hj_colorTitleBG"]];
//         [_lineView3.layer addSublayer:[FYTool gradientLayerFromColorStrForPoint:@"#60A6FF" toColorStr:@"#E27CFF" height:2 width:64 endpoint:CGPointMake(1.0, 0)]];
