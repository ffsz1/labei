...
@interface HJHomeRecommedTableCell()
...
@end
@implementation HJHomeRecommedTableCell
...
//           make.height.mas_equalTo(JXHomeRecommedCellWidth*(152/110.0));
...
//       }];
    ...
    [self.roomImageView2 mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake((kScreenWidth-48)/3, (kScreenWidth-48)/3));
        make.top.mas_equalTo(self.contentView).offset(0);
        make.centerX.equalTo(self.contentView);
//        make.left.mas_equalTo(self.roomImageView.mas_right).offset(4);
    }];
    [self.roomImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake((kScreenWidth-48)/3, (kScreenWidth-48)/3));
        make.right.mas_equalTo(self.roomImageView2.mas_left).offset(-12);
        make.top.mas_equalTo(self.contentView).offset(0);
    }];
    ...
    [self.roomImageView3 mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake((kScreenWidth-48)/3, (kScreenWidth-48)/3));
        make.top.mas_equalTo(self.contentView).offset(0);
        make.left.mas_equalTo(self.roomImageView2.mas_right).offset(12);
    }];
    ...
    [self.nameLabel3 mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.roomImageView3.mas_bottom).offset(10);
    }];
    
    [self.peopleView mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(50, 16));
        make.left.mas_equalTo(self.roomImageView).offset(6);
    ...
    [self.peopleView2 mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(50, 16));
        make.left.mas_equalTo(self.roomImageView2).offset(6);
    ...
    [self.peopleView3 mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(50, 16));
        make.left.mas_equalTo(self.roomImageView3).offset(6);
    ...
    [self.flagImgView3 mas_remakeConstraints:^(MASConstraintMaker *make) {
           make.size.mas_equalTo(CGSizeMake(30, 16));
           make.top.mas_equalTo(self.roomImageView3.mas_top).offset(0);
           make.left.mas_equalTo(self.roomImageView3).offset(0);
       }];
...
//        HJHomeRecommedRoomModel *room = self.roomArr[0];
...
//        self.roomImageView2.image = [UIImage imageNamed:@"hj_home_greenDelegate"];//绿色公约
...
//        self.roomImageView3.image = [UIImage imageNamed:@"hj_home_xuweiyidai"];
...
{
    if (self.roomArr.count>0) {
        HJHomeRecommedRoomModel *room = [self.roomArr safeObjectAtIndex:0];
...
//        [self pushToGreenH5];
    ...
    HJHomeRecommedRoomModel *room = [self.roomArr safeObjectAtIndex:1];
    [self pushRoom:room.uid];
}
...
//        [self pushToH5];
    ...
    HJHomeRecommedRoomModel *room = [self.roomArr safeObjectAtIndex:2];
    [self pushRoom:room.uid];
}
...
- (void)pushToGreenH5
{
    HJWKWebViewController *webView = [[HJWKWebViewController alloc]init];
     NSString *urlSting = [NSString stringWithFormat:@"%@/front/convention/index.html",[HJHttpRequestHelper getHostUrl]];
...
{
    HJWKWebViewController *webView = [[HJWKWebViewController alloc]init];
    NSString *urlSting = [NSString stringWithFormat:@"%@/front/hotroom/index.html",[HJHttpRequestHelper getHostUrl]];
    webView.url = [NSURL URLWithString:urlSting];
    [[self topViewController].navigationController pushViewController:webView animated:YES];
}
...
- (UIImageView *)shadowImageView
{
    if (!_shadowImageView) {
        ...
        _shadowImageView.image = [UIImage imageNamed:@"hj_home_tuijian_bg"];
...
- (UIImageView *)shadowImageView2
{
    if (!_shadowImageView2) {
        ...
        _shadowImageView2.image = [UIImage imageNamed:@"hj_home_tuijian_bg"];
...
- (UIImageView *)shadowImageView3
{
    if (!_shadowImageView3) {
        ...
        _shadowImageView3.image = [UIImage imageNamed:@"hj_home_tuijian_bg"];
...
- (UILabel *)nameLabel
{
    if (!_nameLabel) {
        ...
        _nameLabel.font = JXFontPingFangSCRegular(12);
...
- (UILabel *)nameLabel2
{
    if (!_nameLabel2) {
        ...
        _nameLabel2.font = JXFontPingFangSCRegular(12);
...
- (UILabel *)nameLabel3
{
    if (!_nameLabel3) {
        ...
        _nameLabel3.font = JXFontPingFangSCRegular(12);
        _nameLabel3.textColor = UIColorHex(333333);
        _nameLabel3.textAlignment = NSTextAlignmentLeft;
...
- (UIView *)peopleView3
{
    if (!_peopleView3) {
        ...
        _peopleView3.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.42];
