...
@interface HJPersonalVoiceEditVC ()<HJMediaCoreClient, HJFileCoreClient>
...
@implementation HJPersonalVoiceEditVC
...
- (IBAction)onSaveBtnClicked:(id)sender {
    if (self.filePath.length > 0) {
        ...
        [GetCore(HJFileCore) uploadVoice:self.filePath];
    }
}
...
- (void) initView
{
    ...
    bg.image = [UIImage imageNamed:@"hj_voice_record_bg"];
