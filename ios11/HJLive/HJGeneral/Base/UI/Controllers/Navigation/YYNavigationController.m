...
@interface YYNavigationController () <UIGestureRecognizerDelegate, YYNavigationControllerDelegate>
...
- (YYNavigationBar *)navigationBar
{
    return (YYNavigationBar *)[super navigationBar];
}
...
- (void)handleNavigationTransition:(UIScreenEdgePanGestureRecognizer *)recognizer
{
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        _interativePopTransition = [[YYInteractivePopTransition alloc] init];
...
- (void)navigationController:(YYNavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self != navigationController) {
        return;
    }
