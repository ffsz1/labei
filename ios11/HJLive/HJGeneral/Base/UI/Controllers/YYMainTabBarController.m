...
@interface YYMainTabBarController () <YYNavigationControllerDelegate, UITabBarControllerDelegate, UIScrollViewDelegate, AssistiveTouchDelegate>
{
    NSTimer *_checkBrokenNetworkTimer;
}

@property (nonatomic, strong) YYNavigationController        *selectChatNavController;
@property (nonatomic, strong) YYNavigationController        *squareNavController;
@property (nonatomic, strong) YYNavigationController        *recentNavController;
@property (nonatomic, strong) YYNavigationController        *mineNavController;

@property (nonatomic, weak, readonly) YYMainTabBar          *mainTabBar;

@property (nonatomic, strong) UIScrollView                  *scrollDisplay;
@property (nonatomic, strong) GameVoicePageControl          *pageControl;
...
//    deleage.assistiveTouch = [[AssistiveTouch alloc] initWithFrame:CGRectMake(100, 100, self.floatingView.frame.size.width, self.floatingView.frame.size.height) view:self.floatingView];
...
- (void)configTabBarItem
{
    ...
    [[UITabBarItem appearanceWhenContainedIn:[YYMainTabBar class], nil] setTitleTextAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:11],NSForegroundColorAttributeName:[[YYTheme defaultTheme] globalTintColor]} forState:UIControlStateSelected];
    
    [[UITabBarItem appearanceWhenContainedIn:[YYMainTabBar class], nil] setTitlePositionAdjustment:UIOffsetMake(0, -4)];

    self.selectChatNavController.tabBarItem = [[YYMainTabBarItem alloc] initWithTitle:@"抢聊" image:[[UIImage imageNamed:@"hj_selectchat_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"hj_selectchat_lighted_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    [self.selectChatNavController.tabBarItem setImageInsets:UIEdgeInsetsMake(-2, 0, 2, 0)];

    self.squareNavController.tabBarItem = [[YYMainTabBarItem alloc] initWithTitle:@"广场" image:[[UIImage imageNamed:@"hj_square_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"hj_square_lighted_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    [self.squareNavController.tabBarItem setImageInsets:UIEdgeInsetsMake(-2, 0, 2, 0)];
    
    self.recentNavController.tabBarItem = [[YYMainTabBarItem alloc] initWithTitle:@"消息" image:[[UIImage imageNamed:@"hj_recent_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"hj_recent_lighted_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    [self.recentNavController.tabBarItem setImageInsets:UIEdgeInsetsMake(-2, 0, 2, 0)];
    
    self.mineNavController.tabBarItem = [[YYMainTabBarItem alloc] initWithTitle:@"我" image:[[UIImage imageNamed:@"hj_mine_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"mine_lighted_nav"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
