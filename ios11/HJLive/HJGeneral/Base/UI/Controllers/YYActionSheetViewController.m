...
@interface YYActionSheetViewController ()<UITableViewDelegate, UITableViewDataSource, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning, UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    if (self.separatorLineColor != nil) {
        ...
        [self.tableView setSeparatorColor:[[YYDefaultTheme alloc] colorWithHexString:@"#d9d9d9" alpha:1.0]];
    }
         ...
         if ([NSStringFromClass([rootView class]) isEqualToString:@"UITransitionView"]) {
             ...
             [aSubViews enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
                 ...
                 if ([nextResponder isKindOfClass:[UIViewController class]]) {
                     if (![nextResponder isKindOfClass:[YYMainTabBarController class]]) {
