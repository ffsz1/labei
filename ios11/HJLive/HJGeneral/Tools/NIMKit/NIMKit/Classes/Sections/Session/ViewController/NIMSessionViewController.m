...
- (NSMutableAttributedString *)sessionTitle
{
    ...
    switch (type) {
        ...
        case NIMSessionTypeP2P:{
            title = [[NSMutableAttributedString alloc]initWithString:[NIMKitUtil showNick:self.session.sessionId inSession:self.session]];
        }
            break;
        default:
            break;
...
{
    if ([GetCore(HJUserCoreHelp) checkUserHasBanned:0]) {
