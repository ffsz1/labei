...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_voiceButton setImage:[UIImage nim_imageInKit:@"hj_message_voice"] forState:UIControlStateNormal];
        [_voiceButton setImage:[UIImage nim_imageInKit:@"hj_message_voice_highlinght"] forState:UIControlStateHighlighted];
...
{
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"hj_message_voice"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"hj_message_voice_highlinght"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
}
