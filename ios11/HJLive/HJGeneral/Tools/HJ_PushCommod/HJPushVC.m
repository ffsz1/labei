...
@implementation HJPushVC

+ (instancetype)shared {
    static HJPushVC *push = nil;
...
//            url
            ...
            [[HJRoomViewControllerCenter defaultCenter]presentRoomViewWithRoomOwnerUid:url.userIDValue succ:^(ChatRoomInfo *roomInfo) {
                if (roomInfo != nil) {
            ...
            if (url.length > 0) {
                ...
                HJWKWebViewController *web = [[HJWKWebViewController alloc]init];
