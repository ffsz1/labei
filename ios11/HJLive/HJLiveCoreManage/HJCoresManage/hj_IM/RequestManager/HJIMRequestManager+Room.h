...
typedef void(^JXIMRequestEnterRoomSuccessHander)(ChatRoomInfo *roomInfo, ChatRoomMember *member, NSArray<HJIMQueueItem *> *queueInfos);
typedef void(^JXIMRequestRoomInfoSuccessHander)(ChatRoomInfo *roomInfo);
typedef void(^JXIMRequestRoomMembersSuccessHander)(NSArray<ChatRoomMember *> *roomMembers);

/**
 房间管理接口
 */
@interface HJIMRequestManager (Room)
