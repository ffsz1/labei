 ...
 *  聊天室通知内容
 */
@interface JXIMChatroomNotificationContent : BaseObject
...
/**
 自定义消息内容
 */
@interface JXIMCustomObject : BaseObject

@property (nonatomic, strong) Attachment *attachment; ///< 自定义消息附件内容
@property (nonatomic, strong) JXIMChatroomNotificationContent *notificationContent; ///< 聊天室通知内容

@end


@interface JXIMSession : BaseObject
...
@interface HJIMMessage : BaseObject<HJIMMessage>
...
@property (nonatomic, strong) ChatRoomMember *member;          ///< 消息来源(房间)
