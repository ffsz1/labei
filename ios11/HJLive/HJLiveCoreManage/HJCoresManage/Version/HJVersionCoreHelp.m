...
@implementation HJVersionCoreHelp
...
- (void)configJson {
    [HJHttpRequestHelper configClientSuccess:^(id json) {
...
- (void)getVersionData
{
    ...
    [HJHttpRequestHelper checkVersion:[YYUtility appVersion] success:^(VersionInfo *info) {
