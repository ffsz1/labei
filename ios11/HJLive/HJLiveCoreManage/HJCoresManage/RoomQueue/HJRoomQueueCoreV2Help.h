...
@interface HJRoomQueueCoreV2Help : BaseCore

@property (nonatomic, strong) HJRoomMicInfo *micState;
...
- (ChatRoomMember *)findTheMemberByUserId:(UserID)uid;//通过uid查找member
- (HJRoomQueueInfo *)findTheRoomQueueMemberInfo:(UserID)uid;//通过uid查找麦序信息
