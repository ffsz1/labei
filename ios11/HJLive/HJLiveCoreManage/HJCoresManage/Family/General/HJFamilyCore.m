...
- (void)familyGetListWithFamilyId:(NSString *)familyId page:(NSInteger)page{
    ...
    [HJHttpRequestHelper familyGetListWithFamilyId:familyId page:page success:^(NSMutableDictionary *data) {
...
- (void)familyCreateFamilyTeamWithBgImg:(NSString *)bgImg
    ...
    [HJHttpRequestHelper familyCreateFamilyTeamWithBgImg:bgImg logo:logo name:name notice:notice hall:hall success:^{
...
- (void)familyGetJoinFamilyInfo {
    ...
    [HJHttpRequestHelper familyGetJoinFamilyInfoWithSuccess:^(id data) {
...
- (void)familyGetFamilyInfoByFamilyId:(NSString *)familyId {
    [HJHttpRequestHelper familyGetFamilyInfoWithFamilyId:familyId success:^(id data) {
        HJFamilyInfoDetail *detail = [HJFamilyInfoDetail yy_modelWithJSON:data];
...
- (void)familyMemberInfoByFamilyID:(NSString *)familyId page:(NSInteger)page onceStr:(NSString *)onceStr{
    ...
    [HJHttpRequestHelper familyGetFamilyTeamJoinWithFamilyId:familyId page:page success:^(id data) {
...
- (void)applyJoinFamilyWithFamilyId:(NSString *)familyId{
    [HJHttpRequestHelper applyJoinFamilyWithFamilyId:familyId Success:^(id data) {
...
- (void)applyExitFamilyWithFamilyId:(NSString *)familyId{
    [HJHttpRequestHelper applyExitFamilyWithFamilyId:familyId Success:^(id data) {
...
- (void)setApplyJoinMethodWithFamilyId:(NSString *)familyId joinmode:(NSString *)joinmode{
    [HJHttpRequestHelper setApplyJoinMethodWithFamilyId:familyId joinmode:joinmode Success:^(id data) {
...
- (void)setManagerWithFamilyId:(NSString *)familyId uid:(NSString *)uid {
    ...
    [HJHttpRequestHelper setManagerWithFamilyId:familyId uid:uid Success:^(id data) {
...
- (void)setManagerWithFamilyId:(NSString *)familyId uids:(NSString *)uids {
    ...
    [HJHttpRequestHelper setManagerWithFamilyId:familyId uids:uids Success:^(id data) {
        NotifyCoreClient(HJFamilyCoreClient, @selector(setManagerSuccessWithData:), setManagerSuccessWithData:data);
    } failure:^(NSNumber *code, NSString *msg) {
        NotifyCoreClient(HJFamilyCoreClient, @selector(setManagerFailedWithDataFailedWithMessage:), setManagerFailedWithDataFailedWithMessage:msg);
    }];
...
- (void)removeManagerWithFamilyId:(NSString *)familyId userID:(NSString *)userID {
    ...
    [HJHttpRequestHelper removeManagerWithFamilyId:familyId userId:userID Success:^(id data) {
...
- (void)setOutWithFamilyId:(NSString *)familyId userID:(NSString *)userID {
    ...
    [HJHttpRequestHelper setOutWithFamilyId:familyId userId:userID Success:^(id data) {
...
- (void)familyGetFamilyMessageWithFamilyId:(NSString *)familyId page:(NSInteger)page count:(NSInteger)count {
    ...
    [HJHttpRequestHelper familyGetFamilyMessageWithFamilyId:familyId page:page count:count success:^(NSArray *dataArr) {
...
- (void)familyApplyFamilyWithFamilyId:(NSString *)familyId
    ...
    [HJHttpRequestHelper familyApplyFamilyWithFamilyId:familyId userId:userId type:type status:status success:^{
...
- (void)homeV2FamilyBanner {
    ...
    [HJHttpRequestHelper homeV2FamilyBannerWithSuccess:^(NSArray *dataArr) {
...
- (void)familyEditFamilyTeamWithFamilyId:(NSString *)familyId
                         ...
                         backgroundImage:(NSString *)backgroundImage
                                  notice:(NSString *)notice {
    [HJHttpRequestHelper familyEditFamilyTeamWithFamilyId:familyId logo:logo backgroundImage:backgroundImage notice:notice success:^{
...
- (void)familyCheckFamilyJoin {
    [HJHttpRequestHelper familyCheckFamilyJoinSuccess:^(id data) {
        HJFamilyModel *model = [HJFamilyModel yy_modelWithJSON:data];
