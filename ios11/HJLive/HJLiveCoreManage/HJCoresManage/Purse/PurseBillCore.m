...
#import "HJHttpRequestHelper+Bill.h"
...
- (void)getOutGiftListPageNo:(NSInteger)pageNo time:(NSInteger)time pageSize:(NSInteger)pageSize {
    [HJHttpRequestHelper getGiftOutBillWithPageNo:pageNo time:time pageSize:pageSize Success:^(NSMutableArray *arr,NSMutableArray *keys) {
...
- (void)getInGiftListPageNo:(NSInteger)pageNo time:(NSInteger)time pageSize:(NSInteger)pageSize {
    [HJHttpRequestHelper getGiftInBillWithPageNo:pageNo time:time pageSize:pageSize Success:^(NSMutableArray *arr,NSMutableArray *keys) {
...
- (void)getChatListPageNo:(NSInteger)pageNo time:(NSInteger)time pageSize:(NSInteger)pageSize  {
    [HJHttpRequestHelper getChatBillWithPageNo:pageNo time:time pageSize:pageSize Success:^(NSMutableArray *arr,NSMutableArray *keys) {
...
- (void)getRechargeListPageNo:(NSInteger)pageNo time:(NSInteger)time pageSize:(NSInteger)pageSize {
    [HJHttpRequestHelper getRechargeBillWithPageNo:pageNo time:time pageSize:pageSize Success:^(NSMutableArray *arr,NSMutableArray *keys) {
...
- (void)getWithdrawListPageNo:(NSInteger)pageNo time:(NSInteger)time pageSize:(NSInteger)pageSize {
    [HJHttpRequestHelper getWithdrawBillWithPageNo:pageNo time:time pageSize:pageSize Success:^(NSMutableArray *arr,NSMutableArray *keys) {
