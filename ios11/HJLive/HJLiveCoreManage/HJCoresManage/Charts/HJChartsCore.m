...
#import "HJChartsCore.h"

#import "HJChartsCoreClient.h"
#import "HJHttpRequestHelper+Charts.h"

@implementation HJChartsCore
...
- (void)allrankWithUid:(UserID)uid
    ...
    [HJHttpRequestHelper requestaAllrankWithUid:uid type:type datetype:datetype pageSize:pageSize success:^(NSArray *allrankList) {
