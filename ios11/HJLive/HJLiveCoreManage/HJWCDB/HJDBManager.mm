...
- (NSString *)getDBPath {
    NSString *path = [NSString stringWithFormat:@"Documents/database/%@",[GetCore(HJAuthCoreHelp) getUid]];
    NSString *databasePath = [NSHomeDirectory() stringByAppendingPathComponent:path];
    NSString *dbName = [NSString stringWithFormat:@"%@.db",[GetCore(HJAuthCoreHelp)getUid]];
