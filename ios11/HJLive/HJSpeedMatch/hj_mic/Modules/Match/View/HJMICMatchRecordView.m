...
@interface HJMICMatchRecordView ()
...
@implementation HJMICMatchRecordView
...
- (void)configureWithAudioInfo:(HJMICPlayInfoModel *)audioInfo {
    ...
    switch (audioInfo.playState) {
        ...
        {
            playName = @"hj_mic_icon_play";
            self.musiceLogoView.hidden = NO;
        }
            break;
        case MICPlayStateBegin:
        {
            playName = @"hj_mic_icon_pause";
...
- (UIImageView *)playView {
    if (!_playView) {
        ...
        _playView.image = [UIImage imageNamed:@"hj_mic_icon_play"];
...
- (UIImageView *)imgBG {
    if (!_imgBG) {
        ...
        _imgBG.image = [UIImage imageNamed:@"hj_match_music_imgBG"];
        ...
        label.textColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"hj_wenzhi_img"]];
        ...
        flagimg.image = [UIImage imageNamed:@"hj_music_flag_icon"];
...
- (SVGAImageView *)animationView {
    if (!_animationView) {
        ...
        _animationView.imageName = @"hj_mic_effect_match_record_white";
    }
