...
{
    dispatch_async(self.ioQueue, ^{
        [YYLogger info:TBase message:@"[+] begin clean cache."];
        ...
        [YYLogger info:TBase message:@"[-] finished clean cache, %lu files removed, costs: %.2f", (unsigned long)filesToDelete.count, endTimestamp - beginTimestamp];
    });
}
