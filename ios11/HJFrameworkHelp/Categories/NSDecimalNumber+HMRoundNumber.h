//
//  NSDecimalNumber+HMRoundNumber.h
//  Pods
//
...
@interface NSDecimalNumber (HMRoundNumber)
...
/**
 ...
 @return NSDecimalNumber对象
 */
+ (NSDecimalNumber *)hm_decimalNumberWithFloat:(float)value
...
/**
 ...
 @return NSDecimalNumber对象
 */
+ (NSDecimalNumber *)hm_decimalNumberWithDouble:(double)value
                                  roundingScale:(short)scale
                                   roundingMode:(NSRoundingMode)mode;
