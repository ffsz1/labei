...
typedef enum {
	/** No error. */
	JXKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	JXKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	JXKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	JXKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	JXKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	JXKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	JXKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	JXKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	JXKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	JXKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	JXKeychainErrorFailedToDecode = errSecDecode
} JXKeychainErrorCode;

extern NSString *const kJXKeychainErrorDomain;

/** Account name. */
extern NSString *const kJXKeychainAccountKey;
 ...
 */
extern NSString *const kJXKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kJXKeychainClassKey;

/** Item description. */
extern NSString *const kJXKeychainDescriptionKey;

/** Item label. */
extern NSString *const kJXKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kJXKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kJXKeychainWhereKey;
...
/**
 ...
 JXKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in JXKeychain.h for a list of keys that can be used when accessing the
