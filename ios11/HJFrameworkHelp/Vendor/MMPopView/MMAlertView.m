...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.defaultTextOK      = NSLocalizedString(MMPopViewOk, nil);
        self.defaultTextCancel  = NSLocalizedString(MMPopViewCancel, nil);
        self.defaultTextConfirm = NSLocalizedString(MMPopViewConfirm, nil);
    }
