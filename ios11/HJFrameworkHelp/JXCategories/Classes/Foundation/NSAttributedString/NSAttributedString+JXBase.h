...
@interface NSAttributedString (JXBase)
 ...
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id> *jx_attributes;
 ...
 */
- (nullable id)jx_attribute:(NSString *)attrName atIndex:(NSUInteger)index;
 ...
 */
- (nullable id)jx_attribute:(NSString *)attrName inRange:(NSRange)range;
 ...
 */
- (nullable id)jx_attribute:(NSString *)attrName;
 ...
 */
@property (nonatomic, readonly) UIFont *jx_font;
 ...
 */
@property (nonatomic, readonly) NSParagraphStyle *jx_paragraphStyle;
 ...
 */
@property (nonatomic, readonly) UIColor *jx_foregroundColor;
 ...
 */
@property (nonatomic, readonly) UIColor *jx_backgroundColor;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_ligature;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_kern;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_strikethroughStyle;
...
/**
 获取NSAttributedString的共有删除线类型(NSUnderlineStyle), 若无返回nil
 */
@property (nonatomic, readonly) NSNumber *jx_underlineStyle;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_strokeColor;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_strokeWidth;
 ...
 */
@property (nonatomic, readonly) NSShadow *jx_shadow;
 ...
 */
@property (nonatomic, readonly) NSString *jx_textEffect;
 ...
 */
@property (nonatomic, readonly) NSTextAttachment *jx_attachment;
 ...
 */
@property (nonatomic, readonly) id jx_link;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_baselineOffset;
 ...
 */
@property (nonatomic, readonly) UIColor *jx_underlineColor;
 ...
 */
@property (nonatomic, readonly) UIColor *jx_strikethroughColor;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_obliqueness;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_expansion;
 ...
 */
@property (nonatomic, readonly) NSArray<NSNumber *> *jx_writingDirection;
 ...
 */
@property (nonatomic, readonly) NSNumber *jx_verticalGlyphForm;

@end


@interface NSMutableAttributedString (JXBase)
...
/**
 ...
 @param range 设置范围
 */
- (void)jx_setAttribute:(NSString *)name
                  value:(id)value
                  range:(NSRange)range;
...
/**
 根据移除位置, 移除NSMutableAttributedString的非连续属性集(非连续属性集Keys, 参见jx_allDiscontinuousAttributeKeys)
