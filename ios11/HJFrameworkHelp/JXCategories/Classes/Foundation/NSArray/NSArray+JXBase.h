...
@interface NSArray<ObjectType> (JXBase)

#pragma mark - Base
/**
 获取数组的范围
 */
@property (nonatomic, readonly) NSRange jx_rangeOfAll;

/**
 获取数组的索引集
 */
@property (nonatomic, readonly) NSIndexSet *jx_indexesOfAll;
 ...
 */
- (nullable ObjectType)jx_objectOrNilAtIndex:(NSUInteger)index;
 ...
 */
- (nullable ObjectType)jx_randomObject;
 ...
 */
- (NSArray<ObjectType> *)jx_randomObjectsInCount:(NSUInteger)count;
 ...
 */
- (void)jx_enumerateObjectsWithOptions:(NSEnumerationOptions)opts
...
/**
 ...
 @param block 遍历处理回调(obj:元素, indexPath:绝对索引[元素在完整维度数组中的索引, 例:0-2-1], idx:相对索引[元素在当前维度数组的索引, 例:1], *stop:是否停止遍历)
 */
- (void)jx_enumerateObjectsAtIndexes:(NSIndexSet *)indexes
...
/**
 ...
 @return 包含返回YES, 否则返回NO
 */
- (BOOL)jx_containsObjectUsingBlock:(BOOL (^)(ObjectType obj, NSUInteger idx))block;
...
/**
 ...
 @return 包含返回YES, 否则返回NO
 */
- (BOOL)jx_containsObjectWithOptions:(NSEnumerationOptions)opts usingBlock:(BOOL (^)(ObjectType obj, NSUInteger idx))block;
...
/**
 ...
 @return 包含返回YES, 否则返回NO
 */
- (BOOL)jx_containsObjects:(NSArray<ObjectType> *)otherObjects;
...
/**
 ...
 @return 去重后的数组
 */
- (NSArray<ObjectType> *)jx_deduplicatedArray;
...
/**
 ...
 @return 过滤处理的新数组
 */
- (NSArray<ObjectType> *)jx_filteredArray:(BOOL (^)(ObjectType obj, NSUInteger idx, BOOL *stop))block;
...
/**
 ...
 @return 元素随机排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayAtRandomInCount:(NSUInteger)count;
...
/**
 ...
 @return 元素随机排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayAtRandom;
...
/**
 ...
 @return 元素反转排序后的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayByReversed;
...
/**
 ...
 @return 元素升序排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayInAscending;
...
/**
 ...
 @return 元素降序排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayInDescending;
...
/**
 ...
 @return 元素升序排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayInAscendingWithKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return 元素降序排序的新数组
 */
- (NSArray<ObjectType> *)jx_sortedArrayInDescendingWithKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return 包含属性列表元素的数组
 */
+ (nullable NSArray<id> *)jx_arrayWithPlistData:(NSData *)plist;
...
/**
 ...
 @return 包含属性列表元素的数组
 */
+ (nullable NSArray<id> *)jx_arrayWithPlistString:(NSString *)plist;
...
@interface NSMutableArray<ObjectType> (JXBase)
...
/**
 ...
 @return 可变数组
 */
+ (instancetype)jx_mutableArrayWithArray:(NSArray<ObjectType> *)array;
...
/**
 ...
 @param anObject 元素
 */
- (void)jx_addObject:(ObjectType)anObject;
...
/**
 ...
 @param objects 元素集
 */
- (void)jx_addObjectsFromArray:(NSArray<ObjectType> *)objects;
...
/**
 ...
 @param index 索引
 */
- (void)jx_insertObject:(ObjectType)anObject atIndex:(NSUInteger)index;
...
/**
 ...
 @param index 索引
 */
- (void)jx_insertObjects:(NSArray<ObjectType> *)objects atIndex:(NSUInteger)index;
...
/**
 ...
 @param indexes 索引集
 */
- (void)jx_insertObjects:(NSArray<ObjectType> *)objects atIndexes:(NSIndexSet *)indexes;
...
/**
 ...
 @param anObject 元素
 */
- (void)jx_removeObject:(ObjectType)anObject;
...
/**
 ...
 @param range 范围
 */
- (void)jx_removeObject:(ObjectType)anObject inRange:(NSRange)range;
...
/**
 ...
 @param range 范围
 */
- (void)jx_removeObjectIdenticalTo:(ObjectType)anObject inRange:(NSRange)range;
...
/**
 ...
 @param anObject 指定元素
 */
- (void)jx_removeObjectIdenticalTo:(ObjectType)anObject;
 ...
 */
- (void)jx_removeObjectsInArray:(NSArray<ObjectType> *)otherArray;
...
/**
 ...
 @param anObject 元素
 */
- (void)jx_replaceObjectAtIndex:(NSUInteger)index withObject:(ObjectType)anObject;
 ...
 */
- (void)jx_replaceObjectsInRange:(NSRange)range withObjectsFromArray:(NSArray<ObjectType> *)otherArray range:(NSRange)otherRange;
...
/**
 ...
 @param otherArray 其他数组
 */
- (void)jx_replaceObjectsInRange:(NSRange)range withObjectsFromArray:(NSArray<ObjectType> *)otherArray;
...
/**
 ...
 @param objects 元素集
 */
- (void)jx_replaceObjectsAtIndexes:(NSIndexSet *)indexes withObjects:(NSArray<ObjectType> *)objects;
 ...
 */
- (nullable ObjectType)jx_popFirstObject;
 ...
 */
- (nullable ObjectType)jx_popLastObject;
...
/**
 ...
 @param anObject 单个元素
 */
- (void)jx_appendObject:(ObjectType)anObject;
...
/**
 ...
 @param anObject 单个元素
 */
- (void)jx_prependObject:(ObjectType)anObject;
...
/**
 ...
 @param objects 一组元素
 */
- (void)jx_appendObjects:(NSArray<ObjectType> *)objects;
...
/**
 ...
 @param objects 一组元素
 */
- (void)jx_prependObjects:(NSArray<ObjectType> *)objects;
...
/**
 ...
 @param block 过滤回调处理(返回NO, 元素移除出数组, 否则不移除, obj:元素, idx:索引, *stop:是否停止过滤)
 */
- (void)jx_filter:(BOOL (^)(ObjectType obj, NSUInteger idx, BOOL *stop))block;
...
/**
 ...
 @param block 过滤回调处理(返回NO, 元素移除出数组, 否则不移除, obj:元素, idx:索引, *stop:是否停止过滤)
 */
- (void)jx_filterWithOptions:(NSEnumerationOptions)opts usingBlock:(BOOL (^)(ObjectType obj, NSUInteger idx, BOOL *stop))block;
