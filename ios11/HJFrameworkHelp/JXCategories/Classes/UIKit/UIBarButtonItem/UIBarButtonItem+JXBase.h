...
@interface UIBarButtonItem (JXBase)
 ...
 */
+ (UIBarButtonItem *)jx_barButtonItemWithImage:(UIImage *)image
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (UIBarButtonItem *)jx_barButtonItemWithTitle:(NSString *)title
                                         style:(UIBarButtonItemStyle)style
                                        target:(id)target
                                        action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (UIBarButtonItem *)jx_barButtonItemWithBarButtonSystemItem:(UIBarButtonSystemItem)systemItem
                                                      target:(id)target
                                                      action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (nullable UIBarButtonItem *)jx_barButtonItemWithCustomView:(UIView *)customView
                                             target:(id)target
                                             action:(SEL)action;
...
/**
 ...
 @return UIBarButtonItem对象
 */
+ (nullable UIBarButtonItem *)jx_barButtonItemWithCustomView:(UIView *)customView actionBlock:(void (^)(id sender))actionBlock;
