...
//typedef NS_ENUM(NSInteger, JXUIImageResizeModel) {
//    JXUIImageResizeModeleScaleToFill,
//    JXUIImageResizeModeleScaleAspectFit,
//    JXUIImageResizeModeleScaleAspectFill,
//    JXUIImageResizeModeleScaleAspectFillTop,
//    JXUIImageResizeModeleScaleAspectFillBottom,
//};

@interface UIImage (JXBase)

#pragma mark - Base
@property (nonatomic, readonly) CGSize jx_sizeInPixel; ///< 获取图片的像素大小(根据图片倍数调整)
@property (nullable, nonatomic, readonly) UIColor *jx_averageColor; ///< 获取图片的均色(error -> nil)
...
/**
 ...
 @return 新图片(error -> nil)
 */
+ (nullable UIImage *)jx_imageWithSize:(CGSize)size
                                opaque:(BOOL)opaque
                                 scale:(CGFloat)scale
...
/**
 ...
 @param clips       是否裁切图片
 */
- (void)jx_drawInRect:(CGRect)rect
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByAddingImage:(UIImage *)image toPoint:(CGPoint)point;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByResizeToWidth:(CGFloat)width;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByResizeToWidth:(CGFloat)width scale:(CGFloat)scale;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByResizeToSize:(CGSize)size scale:(CGFloat)scale;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
...
/**
 ...
 @return 新图片(error -> nil)
 */
- (nullable UIImage *)jx_imageByFixToOrientationUp;
