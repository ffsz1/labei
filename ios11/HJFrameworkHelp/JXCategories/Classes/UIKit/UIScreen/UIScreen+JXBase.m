...
const CGSize JXUIScreenSizeInPoint320X480 = {320, 480};
const CGSize JXUIScreenSizeInPoint320X568 = {320, 568};
const CGSize JXUIScreenSizeInPoint375X667 = {375, 667};
const CGSize JXUIScreenSizeInPoint375X812 = {375, 812};
const CGSize JXUIScreenSizeInPoint414X736 = {414, 736};
const CGSize JXUIScreenSizeInPoint414X896 = {414, 896};

@implementation UIScreen (JXBase)
...
- (CGFloat)jx_currentWidth {
    return [self jx_currentBounds].size.width;
}

- (CGFloat)jx_currentHeight {
    return [self jx_currentBounds].size.height;
}

- (CGSize)jx_currentSize {
    return [self jx_currentBounds].size;
}

- (CGRect)jx_currentBounds {
    return [self jx_boundsForOrientation:[[UIApplication sharedApplication] statusBarOrientation]];
}
...
- (CGSize)jx_sizeInPoint {
    CGSize size = CGSizeZero;
    
    CGFloat scale = [UIScreen jx_screenScale];
...
- (CGSize)jx_sizeInPixel {
    ...
    if ([[UIScreen mainScreen] isEqual:self]) {
        NSString *model = [UIDevice currentDevice].jx_machineModel;
