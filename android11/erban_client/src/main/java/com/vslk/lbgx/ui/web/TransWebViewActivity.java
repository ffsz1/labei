 ...
 * @author dell
 */
public class TransWebViewActivity extends TakePhotoActivity implements ShareDialog.OnShareDialogItemClick {
    ...
    public void takeSuccess(TResult result) {
        getDialogManager().showProgressDialog(TransWebViewActivity.this, "请稍后");
...
//        toast(msg);
    ...
    private void takePhoto() {
        ...
        File cameraOutFile = JXFileUtils.getTempFile(TransWebViewActivity.this, mCameraCapturingName);
    ...
    public static void start(Context context, String url) {
        Intent intent = new Intent(context, TransWebViewActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trans_web_view);
    ...
    private TransJSInterface jsInterface;
    ...
    private void initData() {
        ...
        jsInterface = new TransJSInterface(webView, this);
