...
public class EasyDialog
{
    ...
    private void initDialog(final Context context)
    {
        ...
        View dialogView = layoutInflater.inflate(R.layout.dialog_easy, null);
    ...
    public EasyDialog setGravity(int gravity)
    {
        ...
        llContent.setBackgroundResource(R.drawable.shape_black_solid_round);
...
//            Toast.makeText(EasyDialogActivityDemo.this, "x:" + location[0] + " y:" + location[1], Toast.LENGTH_SHORT).show();
//            new EasyDialog(EasyDialogActivityDemo.this)
//                    .setLayoutResourceId(R.layout.layout_tip_content_horizontal)
//                    .setBackgroundColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.background_color_black))
//                    .setLocation(location)
//                    .setGravity(EasyDialog.GRAVITY_TOP)
//                    .setTouchOutsideDismiss(true)
//                    .setMatchParent(false)
//                    .setMarginLeftAndRight(24, 24)
//                    .setOutsideColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.outside_color_gray))
//                    .show();
//            return false;
//        }
//    });
...
//                    .setMatchParent(true)
//                    .setMarginLeftAndRight(24, 24)
//                    .setOutsideColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.outside_color_trans))
//                    .show();
//            break;
//
...
//            new EasyDialog(EasyDialogActivityDemo.this)
//                    .setLayoutResourceId(R.layout.layout_tip_content_horizontal)
//                    .setBackgroundColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.background_color_blue))
...
//                    .setMatchParent(false)
//                    .setMarginLeftAndRight(24, 24)
//                    .setOutsideColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.outside_color_pink))
//                    .show();
//            break;
...
//                    .setLayoutResourceId(R.layout.layout_tip_content_horizontal)
//                    .setGravity(EasyDialog.GRAVITY_BOTTOM)
//                    .setBackgroundColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.background_color_brown))
...
//                    .setBackgroundColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.background_color_pink))
...
//            new EasyDialog(EasyDialogActivityDemo.this)
//                    .setLayoutResourceId(R.layout.layout_tip_image_text)
//                    .setBackgroundColor(EasyDialogActivityDemo.this.getResources().getColor(R.color.background_color_yellow))
