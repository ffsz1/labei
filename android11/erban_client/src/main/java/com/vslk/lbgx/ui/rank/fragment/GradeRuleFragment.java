...
public class GradeRuleFragment extends BaseMvpFragment<IRankingListView, RankingListPresenter> implements
    ...
    public void onFindViews() {
        startGrade.setTextColor(isCharm ? getResources().getColor(R.color.color_FF81A4) : getResources().getColor(R.color.color_81A6FF));
//        endGrade.changeSoildColor(isCharm ? getResources().getColor(R.color.color_FF8686) : getResources().getColor(R.color.color_9E86FF));

        gradeBgLlt.setBackgroundResource(isCharm ? R.drawable.shape_ef8686_16dp : R.drawable.shape_81a6ff_16dp);
        ...
        imgLvDes.setBackgroundResource(isCharm ? R.mipmap.img_cflv_des : R.mipmap.img_mllv_des);
        tvLvdesc.setText(isCharm ?"1开心=1魅力值": "1开心=1财富值");
