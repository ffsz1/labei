            ...
            if (supportCombo) {
                ...
                for (int i = 0; i < mGiftLayoutList.size(); i++) {
                    ...
                    if(giftFrameLayout.isShowing()){
                        if (giftFrameLayout.getCurrentGiftId().equals(gift.getGiftId()) && giftFrameLayout.getCurrentSendUserId().equals(gift.getSendUserId()) && giftFrameLayout.getCurrentGiftGroup() == gift.getGiftGroup()) {
                            //连击
