...
public class WithDrawModel extends BaseMvpModel {
     ...
     * 绑定微信支付账号
     */
    public void bindWithdrawWeixin(String accessToken, String openId, String unionId, String phoneNumber, String code,
            String nickName, String realName, OkHttpManager.MyCallBack myCallBack) {
