 ...
 * @author dell
 */
public class PayWebViewActivity extends BaseActivity implements ShareDialog.OnShareDialogItemClick {
...
//                super.onReceivedSslError(view, handler, error); //一定要去掉
    ...
    public void ShowWebView(String url) {
        if (!BizUtils.isAliPayInstalled(this)) {
            SingleToastUtil.showToast("请先安装支付宝App");
            finish();
            return;
        }
        webView.loadUrl(url);
