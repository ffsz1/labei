package com.vslk.lbgx.room.gift.anim;
...
import com.vslk.lbgx.room.gift.widget.StrokeTextView;
...
//    private Timer mTimer;
    ...
    private void initView() {
        ...
        giftGroup = (TextView) rootView.findViewById(R.id.gift_group);
...
//                    .transform(new GlideCircleTransform(mContext))
        ...
        if (mGift.getGiftGroup() == 1) {
            giftGroup.setVisibility(GONE);
        } else {
            giftGroup.setVisibility(VISIBLE);
            giftGroup.setText("X" + mGift.getGiftGroup());
        }
            ...
            GlideApp.with(BasicConfig.INSTANCE.getAppContext())
                    ...
                    .into(new SimpleTarget<Drawable>() {
                        ...
                        public void onResourceReady(Drawable drawable, Transition<? super Drawable> transition) {
                            anim_gift.setImageDrawable(drawable);
                        }
                    });
        } else {
            Bitmap bitmap = null;
