...
public class MagicTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_mstrokeColor)){
                float strokeWidth = a.getFloat(R.styleable.MagicTextView_mstrokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_mstrokeColor, 0xff000000);
                float strokeMiter = a.getFloat(R.styleable.MagicTextView_mstrokeMiter, 10);
