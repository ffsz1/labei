...
import com.vslk.lbgx.ui.me.shopping.fragment.MyBagFragment;
...
public class MyBagActivity extends BaseMvpActivity<IMvpBaseView, DressUpPresenter> implements IMvpBaseView, ViewPager.OnPageChangeListener {
    ...
    public List<Fragment> getFragmentsList() {
        ...
        fragments.add(MyBagFragment.newInstance(DRESS_CAR, isMySelf, targetUid));
        fragments.add(MyBagFragment.newInstance(DRESS_HEADWEAR, isMySelf, targetUid));
        return fragments;
    }
