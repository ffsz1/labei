    ...
    public String getDigestOfAttachment(RecentContact recent, MsgAttachment attachment) {
        if (attachment instanceof CustomAttachment) {
            ...
            if (customAttachment.getFirst() == CustomAttachment.CUSTOM_MSG_HEADER_TYPE_OPEN_ROOM_NOTI) {
                ...
                return "[房间邀请]";
            } else if (customAttachment.getFirst() == CustomAttachment.CUSTOM_MSG_HEADER_TYPE_TRANSFER_FIRST) {
                TransferAttachment ta = (TransferAttachment) customAttachment;
                return "[转账：" + ta.getGoldNum() + "]";
            }
