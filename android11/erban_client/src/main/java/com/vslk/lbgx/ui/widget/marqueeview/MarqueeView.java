...
public class MarqueeView extends ViewFlipper {
    ...
    @AnimRes
    protected int inAnimResId = R.anim.anim_bottom_in;
    @AnimRes
    protected int outAnimResId = R.anim.anim_top_out;
    ...
    protected boolean start(@AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        removeAllViews();
        clearAnimation();
     ...
     * @param outAnimResID 离开动画的resID
     */
    protected void setInAndOutAnimation(@AnimRes int inAnimResId, @AnimRes int outAnimResID) {
