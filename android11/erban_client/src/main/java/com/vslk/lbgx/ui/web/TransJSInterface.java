...
public class TransJSInterface {
    private static final String TAG = TransJSInterface.class.getSimpleName();
    private WebView mWebView;
    private TransWebViewActivity mActivity;
    private int mPosition;

    public TransJSInterface(WebView webView, TransWebViewActivity activity) {
        mWebView = webView;
        mActivity = activity;
    }
