...
import com.netease.nim.uikit.team.ui.SquareImageView;
...
public abstract class MsgViewHolderBase extends RecyclerViewHolder<BaseMultiItemFetchLoadAdapter, BaseViewHolder, IMMessage> {
    ...
    private SquareImageView avatarLeft;
    private SquareImageView avatarRight;
    ...
    protected int leftBackground() {
        return R.drawable.nim_message_item_left_new;
    }

    // 当是发送出去的消息时，内容区域背景的drawable id
    protected int rightBackground() {
        return R.drawable.nim_message_item_right_new;
    }
    ...
    private void setHeadImageView() {
        SquareImageView show = isReceivedMessage() ? avatarLeft : avatarRight;
        SquareImageView hide = isReceivedMessage() ? avatarRight : avatarLeft;
