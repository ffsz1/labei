    ...
    protected void choosePictureFromLocal() {
        ...
        new AsyncTask<String, Integer, Boolean>() {
            ...
            protected void onPreExecute() {
                Toast.makeText(PreviewImageFromCameraActivity.this, R.string.waitfor_image_local, Toast.LENGTH_LONG)
                        .show();
            }
            ...
            protected void onPostExecute(Boolean result) {
                ...
                try {
                    ...
                    Toast.makeText(PreviewImageFromCameraActivity.this, R.string.gallery_invalid, Toast.LENGTH_LONG)
                            .show();
                }
            }
        }.execute();
