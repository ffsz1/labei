...
public class AppToolBar extends LinearLayout {
    ...
    private void initContentView(Context context) {
        ...
        if (tvRightTitle == null && hasRightTitle) {
            ...
            RelativeLayout.LayoutParams tvRightRl = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
...
//            vRl.addRule(ALIGN_PARENT_BOTTOM);
     ...
     * @param leftImgRes
     */
    public void setRightBtnTitleBg(int leftImgRes) {
        if (tvRightTitle != null) {
            tvRightTitle.setBackgroundResource(leftImgRes);
        }
    }
