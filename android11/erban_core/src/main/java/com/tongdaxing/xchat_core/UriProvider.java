...
public class UriProvider {
     ...
     * 服务器地址
     */
    public static final String PRODUCT = "http://lbapi.haijiaoxingqiu.cn";
    public static final String PRODUCT_18 = "http://lbapi.haijiaoxingqiu.cn";
    public static final String DEBUG = "http://lbapi.haijiaoxingqiu.cn";
    /**
     * 房间公聊屏IM地址
     */
    private static final String PRODUCT_WS_URL = "ws://lbim.haijiaoxingqiu.cn/";//房间IM正式服
    private static final String PRODUCT_18_WS_URL = "ws://lbim.haijiaoxingqiu.cn/";//房间IM预发服
    private static final String DEBUG_WS_URL = "ws://lbim.haijiaoxingqiu.cn/";//房间IM测试服
     ...
     * 转账权限
     */
    public static String givegoldcheck() {
        return IM_SERVER_URL.concat("/change/givegoldcheck");
    }

    /**
     * 获取红包弹窗活动类型
     */
    public static String getGold2gold() {
