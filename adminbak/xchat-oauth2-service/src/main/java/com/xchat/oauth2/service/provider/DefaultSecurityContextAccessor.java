 ...
 * 
 */
public class DefaultSecurityContextAccessor implements com.xchat.oauth2.service.provider.SecurityContextAccessor {
	...
	private Authentication getUserAuthentication() {
		...
		if (authentication instanceof com.xchat.oauth2.service.provider.OAuth2Authentication) {
			com.xchat.oauth2.service.provider.OAuth2Authentication oauth = (OAuth2Authentication) authentication;
