 ...
 * @author Dave Syer
 */
public class JdbcClientTokenServices implements com.xchat.oauth2.service.client.token.ClientTokenServices {
	...
	private com.xchat.oauth2.service.client.token.ClientKeyGenerator keyGenerator = new DefaultClientKeyGenerator();
