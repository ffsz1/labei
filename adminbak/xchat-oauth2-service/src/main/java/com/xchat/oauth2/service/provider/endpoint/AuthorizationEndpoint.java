...
import com.xchat.oauth2.service.common.exceptions.BadClientCredentialsException;
import com.xchat.oauth2.service.common.exceptions.ClientAuthenticationException;
...
import com.xchat.oauth2.service.common.exceptions.UnapprovedClientAuthenticationException;
import com.xchat.oauth2.service.common.exceptions.UnsupportedResponseTypeException;
import com.xchat.oauth2.service.common.exceptions.UserDeniedAuthorizationException;
...
import com.xchat.oauth2.service.provider.approval.DefaultUserApprovalHandler;
...
import com.xchat.oauth2.service.provider.implicit.ImplicitTokenRequest;
 ...
 * {@link com.xchat.oauth2.service.provider.endpoint.TokenEndpoint Token Endpoint}, except in the implicit grant type (where they come from the Authorization
...
public class AuthorizationEndpoint extends AbstractEndpoint {
	...
	private com.xchat.oauth2.service.provider.endpoint.RedirectResolver redirectResolver = new DefaultRedirectResolver();
	...
	public void setImplicitGrantService(
			com.xchat.oauth2.service.provider.implicit.ImplicitGrantService implicitGrantService) {
	}
