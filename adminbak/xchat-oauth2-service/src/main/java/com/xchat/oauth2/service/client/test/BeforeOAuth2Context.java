...
/**
 * Marker annotation for methods to be run before the OAuth2Context is setup by the {@link com.xchat.oauth2.service.client.test.OAuth2ContextSetup} rule, and
