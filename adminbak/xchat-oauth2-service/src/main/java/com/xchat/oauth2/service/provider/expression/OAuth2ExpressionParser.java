...
/**
 * <p>
 * A custom {@link org.springframework.expression.ExpressionParser} that automatically wraps SpEL expression with
 * {@link com.xchat.oauth2.service.provider.expression.OAuth2SecurityExpressionMethods#throwOnError(boolean)}. This makes it simple for users to specify an
