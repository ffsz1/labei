 ...
 * @author Dave Syer
 */
public class DefaultRedirectResolver implements com.xchat.oauth2.service.provider.endpoint.RedirectResolver {
	 ...
	 * @throws com.xchat.oauth2.service.common.exceptions.RedirectMismatchException if no match was found
	 */
