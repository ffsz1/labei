package com.xchat.oauth2.service.client.token.auth;
 ...
 * @author Dave Syer
 */
public class DefaultClientAuthenticationHandler implements com.xchat.oauth2.service.client.token.auth.ClientAuthenticationHandler {
