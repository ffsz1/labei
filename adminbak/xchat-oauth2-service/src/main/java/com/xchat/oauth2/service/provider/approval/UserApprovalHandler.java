...
public interface UserApprovalHandler {
	 ...
	 * {@link com.xchat.oauth2.service.provider.AuthorizationRequest#setApprovalParameters(java.util.Map) approval parameters} are set
	 ...
	 * the {@link com.xchat.oauth2.service.provider.AuthorizationRequest} before a token is generated from it.
	 * </p>
	 * 
	 * @param authorizationRequest the authorization request.
	 * @param userAuthentication the user authentication
