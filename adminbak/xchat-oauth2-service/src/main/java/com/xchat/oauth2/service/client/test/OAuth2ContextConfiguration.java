 ...
 * or class). Used at the class level it will apply to all test methods (and {@link com.xchat.oauth2.service.client.test.BeforeOAuth2Context} initializers).
...
public @interface OAuth2ContextConfiguration {
	 ...
	 * {@link com.xchat.oauth2.service.client.resource.OAuth2ProtectedResourceDetails}. An instance will be constructed by the test framework and used to set up
	 ...
	 * 
	 * @see com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration.Password
	 * @see com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration.Implicit
	 * @see com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration.ClientCredentials
	 * 
	...
	/**
	 * The resource type to use when obtaining an access token. Defaults to {@link com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration.Password}. Intended to be used as an
	...
	static class ClientCredentials extends ClientCredentialsResourceDetails {
		public ClientCredentials(com.xchat.oauth2.service.client.test.TestAccounts testAccounts) {
	...
	static class Password extends ResourceOwnerPasswordResourceDetails {
		public Password(com.xchat.oauth2.service.client.test.TestAccounts testAccounts) {
	...
	static class Implicit extends ImplicitResourceDetails {
		public Implicit(com.xchat.oauth2.service.client.test.TestAccounts testAccounts) {
