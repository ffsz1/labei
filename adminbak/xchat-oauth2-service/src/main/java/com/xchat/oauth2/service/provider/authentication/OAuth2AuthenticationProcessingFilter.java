 ...
 * uses it to populate the Spring Security context with an {@link com.xchat.oauth2.service.provider.OAuth2Authentication} (if used in conjunction with an
 * {@link com.xchat.oauth2.service.provider.authentication.OAuth2AuthenticationManager}).
 * 
 * @author Dave Syer
 * 
 */
public class OAuth2AuthenticationProcessingFilter implements Filter, InitializingBean {
	...
	private AuthenticationDetailsSource<HttpServletRequest, ?> authenticationDetailsSource = new com.xchat.oauth2.service.provider.authentication.OAuth2AuthenticationDetailsSource();

	private com.xchat.oauth2.service.provider.authentication.TokenExtractor tokenExtractor = new BearerTokenExtractor();
