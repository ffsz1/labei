 ...
 * @author Dave Syer
 */
public class DefaultOAuth2RefreshToken implements Serializable, com.xchat.oauth2.service.common.OAuth2RefreshToken {
	...
	/* (non-Javadoc)
	 * @see com.xchat.oauth2.service.common.IFOO#getValue()
	 */
	@JsonValue
