...
import com.xchat.oauth2.service.common.exceptions.InsufficientScopeException;
...
public class OAuth2SecurityExpressionMethods {
	 ...
	 * automatically wraps any expressions when using {@link com.xchat.oauth2.service.provider.expression.OAuth2MethodSecurityExpressionHandler} or
	 * {@link com.xchat.oauth2.service.provider.expression.OAuth2WebSecurityExpressionHandler}.
	 * 
	 * OAuth2Example usage:
	 * 
	 * <pre>
	 ...
	 * @throws com.xchat.oauth2.service.common.exceptions.InsufficientScopeException if the scope is invalid and we the flag is set to throw the exception
	 */
	...
	public boolean clientHasAnyRole(String... roles) {
		return com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.clientHasAnyRole(authentication, roles);
	}
	 ...
	 * @return true if the OAuth2 token has one of these scopes
	 * @throws org.springframework.security.access.AccessDeniedException if the scope is invalid and we the flag is set to throw the exception
	 */
	public boolean hasAnyScope(String... scopes) {
		boolean result = com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.hasAnyScope(authentication, scopes);
		if (!result) {
	...
	public boolean hasAnyScopeMatching(String... scopesRegex) {
		...
		boolean result = com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.hasAnyScopeMatching(authentication, scopesRegex);
		if (!result) {
	...
	public boolean denyOAuthClient() {
		return !com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.isOAuth(authentication);
	}
	...
	public boolean isUser() {
		return com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.isOAuthUserAuth(authentication);
	}
	...
	public boolean isClient() {
		return com.xchat.oauth2.service.provider.expression.OAuth2ExpressionUtils.isOAuthClientAuth(authentication);
	}
}
