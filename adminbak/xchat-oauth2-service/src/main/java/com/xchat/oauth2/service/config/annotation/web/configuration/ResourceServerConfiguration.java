...
import com.xchat.oauth2.service.config.annotation.web.configurers.ResourceServerSecurityConfigurer;
...
public class ResourceServerConfiguration extends WebSecurityConfigurerAdapter implements Ordered {
	...
	private List<com.xchat.oauth2.service.config.annotation.web.configuration.ResourceServerConfigurer> configurers = Collections.emptyList();
	 ...
	 */
	@Autowired(required = false)
	public void setConfigurers(List<com.xchat.oauth2.service.config.annotation.web.configuration.ResourceServerConfigurer> configurers) {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		for (com.xchat.oauth2.service.config.annotation.web.configuration.ResourceServerConfigurer configurer : configurers) {
