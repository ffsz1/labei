...
import com.xchat.oauth2.service.provider.ClientRegistrationException;
 ...
 * 
 */
public class ApprovalStoreUserApprovalHandler implements com.xchat.oauth2.service.provider.approval.UserApprovalHandler, InitializingBean {
	...
	private com.xchat.oauth2.service.provider.approval.ApprovalStore approvalStore;
	 ...
	 * 
	 * @param scopePrefix the prefix (default {@link com.xchat.oauth2.service.common.util.OAuth2Utils#SCOPE_PREFIX})
	 */
	 ...
	 */
	public void setApprovalStore(com.xchat.oauth2.service.provider.approval.ApprovalStore store) {
	...
	public AuthorizationRequest checkForPreApproval(AuthorizationRequest authorizationRequest,
		...
		Collection<com.xchat.oauth2.service.provider.approval.Approval> userApprovals = approvalStore.getApprovals(userAuthentication.getName(), clientId);

		// Look at the scopes and see if they have expired
		Date today = new Date();
		for (com.xchat.oauth2.service.provider.approval.Approval approval : userApprovals) {
	 ...
	 * have been denied). The {@link com.xchat.oauth2.service.provider.approval.ApprovalStore} will be updated to reflect the inputs.
	 * 
	...
	public AuthorizationRequest updateAfterApproval(AuthorizationRequest authorizationRequest,
		...
		Set<String> approvedScopes = new HashSet<String>();
		Set<com.xchat.oauth2.service.provider.approval.Approval> approvals = new HashSet<com.xchat.oauth2.service.provider.approval.Approval>();
		...
		for (String requestedScope : requestedScopes) {
			...
			if ("true".equals(value) || value.startsWith("approve")) {
				...
				approvals.add(new com.xchat.oauth2.service.provider.approval.Approval(userAuthentication.getName(), authorizationRequest.getClientId(),
