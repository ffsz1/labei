...
public abstract class AbstractOAuth2SecurityExceptionHandler {
	...
	private com.xchat.oauth2.service.provider.error.WebResponseExceptionTranslator exceptionTranslator = new com.xchat.oauth2.service.provider.error.DefaultWebResponseExceptionTranslator();

	private com.xchat.oauth2.service.provider.error.OAuth2ExceptionRenderer exceptionRenderer = new DefaultOAuth2ExceptionRenderer();

	// This is from Spring MVC.
	private HandlerExceptionResolver handlerExceptionResolver = new DefaultHandlerExceptionResolver();

	public void setExceptionTranslator(com.xchat.oauth2.service.provider.error.WebResponseExceptionTranslator exceptionTranslator) {
	 ...
	 * {@link #setExceptionTranslator(com.xchat.oauth2.service.provider.error.WebResponseExceptionTranslator) exception translator}.
