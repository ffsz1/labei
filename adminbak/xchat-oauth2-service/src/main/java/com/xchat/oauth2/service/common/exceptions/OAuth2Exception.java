...
public class OAuth2Exception extends RuntimeException {
    ...
    public static final String INVALID_THIRD_TOKEN = "ivalid_third_token";
    public static final String THIRD_ACCOUNT_HAS_BIND = "third_account_have_bind";
    public static final String USER_HAS_SIGNED_UP = "user_has_sign_up";
    public static final String SERVICE_ERROR = "service_err";
    public static final String INVALID_IDENTIFYING_CODE = "invalid_identify_code";
    public static final String UNBIND_OPENID_NOT_MATCH = "unbind_openid_not_match";
    public static final String UNBIND_MAIN_ACCOUNT = "unbind_main_account";
    public static final String SIGN_IP_TO_OFTEN = "注册过于频繁";
    public static final String SMS_IP_TO_OFTEN = "短信操作过于频繁";
    public static final String ACCOUNT_ERROR = "account_error";
    public static final String DECEIVE_ERROR = "deceive_error";
    public static final String VERSION_ERROR = "version_error";
    public static final String MULTI_ACCOUNT = "该手机号有多个绑定账号，请使用ID登录";
    ...
    /**
     * Creates an {@link com.xchat.oauth2.service.common.exceptions.OAuth2Exception} from a Map<String,String>.
     *
     * @param errorParams
     * @return
     */
