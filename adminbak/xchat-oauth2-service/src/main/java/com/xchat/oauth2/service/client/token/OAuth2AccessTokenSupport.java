...
import com.xchat.oauth2.service.client.token.auth.ClientAuthenticationHandler;
import com.xchat.oauth2.service.client.token.auth.DefaultClientAuthenticationHandler;
...
import com.xchat.oauth2.service.converter.FormOAuth2AccessTokenMessageConverter;
import com.xchat.oauth2.service.converter.FormOAuth2ExceptionHttpMessageConverter;
...
public abstract class OAuth2AccessTokenSupport {
	...
	private com.xchat.oauth2.service.client.token.RequestEnhancer tokenRequestEnhancer = new com.xchat.oauth2.service.client.token.DefaultRequestEnhancer();
	...
	protected OAuth2AccessToken retrieveToken(com.xchat.oauth2.service.client.token.AccessTokenRequest request, OAuth2ProtectedResourceDetails resource,
	...
	/**
	 * Set the request factory that this template uses for obtaining {@link org.springframework.http.client.ClientHttpRequest HttpRequests}.
	 */
