...
import com.xchat.oauth2.service.client.filter.state.DefaultStateKeyGenerator;
import com.xchat.oauth2.service.client.filter.state.StateKeyGenerator;
...
import com.xchat.oauth2.service.client.token.DefaultRequestEnhancer;
import com.xchat.oauth2.service.client.token.OAuth2AccessTokenSupport;
import com.xchat.oauth2.service.client.token.RequestEnhancer;
...
public class AuthorizationCodeAccessTokenProvider extends OAuth2AccessTokenSupport implements AccessTokenProvider {
	...
	public boolean supportsResource(OAuth2ProtectedResourceDetails resource) {
		return resource instanceof com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails
	...
	public String obtainAuthorizationCode(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
		...
		com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails resource = (com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails) details;
	...
	public OAuth2AccessToken refreshAccessToken(OAuth2ProtectedResourceDetails resource,
		...
		try {
			...
			throw getRedirectForAuthorization((com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails) resource, request);
		}
	}
	...
	private MultiValueMap<String, String> getParametersForTokenRequest(
			com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails resource,
	...
	protected UserApprovalRequiredException getUserApprovalSignal(com.xchat.oauth2.service.client.token.grant.code.AuthorizationCodeResourceDetails resource,
			AccessTokenRequest request) {
