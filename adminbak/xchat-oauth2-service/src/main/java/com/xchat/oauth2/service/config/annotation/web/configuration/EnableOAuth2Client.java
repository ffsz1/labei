 ...
 * global servlet filter in your application of the {@link org.springframework.web.filter.DelegatingFilterProxy} that delegates to a bean named
 * "oauth2ClientContextFilter". Once that filter is in place your client app can use another bean provided by this
 * annotation (an {@link com.xchat.oauth2.service.client.token.AccessTokenRequest}) to create an {@link com.xchat.oauth2.service.client.OAuth2RestTemplate}, e.g.
 * 
 * <pre>
 * &#064;Configuration
 * &#064;EnableOAuth2Client
