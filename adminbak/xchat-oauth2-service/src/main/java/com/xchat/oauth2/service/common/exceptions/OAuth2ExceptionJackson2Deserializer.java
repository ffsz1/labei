...
public class OAuth2ExceptionJackson2Deserializer extends StdDeserializer<OAuth2Exception> {
	...
	@Override
	public com.xchat.oauth2.service.common.exceptions.OAuth2Exception deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
		...
		com.xchat.oauth2.service.common.exceptions.OAuth2Exception ex;
		if ("invalid_client".equals(errorCode)) {
			ex = new com.xchat.oauth2.service.common.exceptions.InvalidClientException(errorMessage);
		}
			...
			if (errorMessage.toLowerCase().contains("redirect") && errorMessage.toLowerCase().contains("match")) {
				ex = new com.xchat.oauth2.service.common.exceptions.RedirectMismatchException(errorMessage);
			}
			else {
