 ...
 * authorization server. Callers add any additional form parameters they need to the {@link com.xchat.oauth2.service.client.token.DefaultAccessTokenRequest}
...
public class ImplicitAccessTokenProvider extends OAuth2AccessTokenSupport implements AccessTokenProvider {
	...
	public boolean supportsResource(OAuth2ProtectedResourceDetails resource) {
		return resource instanceof com.xchat.oauth2.service.client.token.grant.implicit.ImplicitResourceDetails && "implicit".equals(resource.getGrantType());
	}
	...
	public OAuth2AccessToken obtainAccessToken(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
		...
		com.xchat.oauth2.service.client.token.grant.implicit.ImplicitResourceDetails resource = (com.xchat.oauth2.service.client.token.grant.implicit.ImplicitResourceDetails) details;
		try {
	...
	private MultiValueMap<String, String> getParametersForTokenRequest(
			com.xchat.oauth2.service.client.token.grant.implicit.ImplicitResourceDetails resource,
