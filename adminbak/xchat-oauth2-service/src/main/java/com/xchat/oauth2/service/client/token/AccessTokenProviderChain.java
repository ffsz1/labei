 ...
 * @author Dave Syer
 */
public class AccessTokenProviderChain extends OAuth2AccessTokenSupport implements com.xchat.oauth2.service.client.token.AccessTokenProvider {

	private final List<com.xchat.oauth2.service.client.token.AccessTokenProvider> chain;

	private com.xchat.oauth2.service.client.token.ClientTokenServices clientTokenServices;

	public AccessTokenProviderChain(List<? extends com.xchat.oauth2.service.client.token.AccessTokenProvider> chain) {
		this.chain = chain == null ? Collections.<com.xchat.oauth2.service.client.token.AccessTokenProvider> emptyList() : Collections
	 ...
	 */
	public void setClientTokenServices(com.xchat.oauth2.service.client.token.ClientTokenServices clientTokenServices) {
		this.clientTokenServices = clientTokenServices;
	}

	public boolean supportsResource(OAuth2ProtectedResourceDetails resource) {
		for (com.xchat.oauth2.service.client.token.AccessTokenProvider tokenProvider : chain) {
	...
	public OAuth2AccessToken obtainAccessToken(OAuth2ProtectedResourceDetails resource, com.xchat.oauth2.service.client.token.AccessTokenRequest request)
	...
	protected OAuth2AccessToken obtainNewAccessTokenInternal(OAuth2ProtectedResourceDetails details,
			com.xchat.oauth2.service.client.token.AccessTokenRequest request) throws UserRedirectRequiredException, AccessDeniedException {
	 ...
	 * @throws com.xchat.oauth2.service.client.resource.UserRedirectRequiredException
	 */
