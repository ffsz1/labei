 ...
 * Also acts as a {@link com.xchat.oauth2.service.provider.token.TokenEnhancer} when tokens are granted.
 * 
 * @see com.xchat.oauth2.service.provider.token.TokenEnhancer
 * @see com.xchat.oauth2.service.provider.token.AccessTokenConverter
 * 
 * @author Dave Syer
 * @author Luke Taylor
 */
