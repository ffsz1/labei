...
import com.xchat.oauth2.service.common.util.DefaultJdbcListFactory;
import com.xchat.oauth2.service.common.util.JdbcListFactory;
import com.xchat.oauth2.service.provider.ClientAlreadyExistsException;
import com.xchat.oauth2.service.provider.ClientDetails;
import com.xchat.oauth2.service.provider.ClientDetailsService;
import com.xchat.oauth2.service.provider.ClientRegistrationService;
import com.xchat.oauth2.service.provider.NoSuchClientException;
...
public class JdbcClientDetailsService implements ClientDetailsService, ClientRegistrationService {
	...
	private static class ClientDetailsRowMapper implements RowMapper<ClientDetails> {
		...
		public ClientDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
			com.xchat.oauth2.service.provider.client.BaseClientDetails details = new com.xchat.oauth2.service.provider.client.BaseClientDetails(rs.getString(1), rs.getString(3), rs.getString(4),
