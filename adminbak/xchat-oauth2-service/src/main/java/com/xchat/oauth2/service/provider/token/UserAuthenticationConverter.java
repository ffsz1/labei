...
public interface UserAuthenticationConverter {
	...
	final String AUTHORITIES = com.xchat.oauth2.service.provider.token.AccessTokenConverter.AUTHORITIES;
	...
	/**
	 * Inverse of {@link #convertUserAuthentication(org.springframework.security.core.Authentication)}. Extracts an Authentication from a map.
	 * 
