...
import com.xchat.oauth2.service.common.*;
 ...
 * on 3/16/15.
 */
public class XchatTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    private TokenStore tokenDbStore;
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        if (existingAccessToken != null) {
            if (existingAccessToken.isExpired()) {
                ...
                //同时移除该accessToken分配的ticket
                ticketStore.removeTicketUsingAccessToken(existingAccessToken);
            } else {
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest) throws AuthenticationException {
        ...
        //同时删除有该refreshToken分配的tickets
        ticketStore.removeTicketUsingRefreshToken(refreshToken);
    ...
    public boolean revokeToken(String tokenValue) {
        ...
        // Long uid=accountDetails.getAccount().getUid();
        // tokenStore.removeAccessToken(accessToken);
        // tokenDbStore.removeAccessToken(accessToken);
        // 同时移除accessToken分配的tickets
        // ticketStore.removeTicketUsingAccessToken(accessToken);
        removeAccessTokenCacheByUid(uid);
        return true;
    }

    public void removeAccessTokenCacheByUid(Long uid) {
    ...
    public void setTokenDbStore(TokenStore tokenDbStore) {
        this.tokenDbStore = tokenDbStore;
    }
