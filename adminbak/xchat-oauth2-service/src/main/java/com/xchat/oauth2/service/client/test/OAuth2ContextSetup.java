...
import com.xchat.oauth2.service.client.DefaultOAuth2ClientContext;
import com.xchat.oauth2.service.client.OAuth2ClientContext;
import com.xchat.oauth2.service.client.OAuth2RestTemplate;
...
import com.xchat.oauth2.service.client.token.DefaultAccessTokenRequest;
 ...
 * combination with the {@link com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration} annotation provides a number of different strategies for
 * configuring an {@link com.xchat.oauth2.service.client.resource.OAuth2ProtectedResourceDetails} instance that will be used to create the OAuth2 context for
 * tests. Example:
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * @see com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration
 * @see com.xchat.oauth2.service.client.test.BeforeOAuth2Context
 * 
 * @author Dave Syer
 * 
 */
...
public class OAuth2ContextSetup extends TestWatchman {
	...
	private final com.xchat.oauth2.service.client.test.TestAccounts testAccounts;
	...
	/**
	 * Create a new client that can inject a {@link com.xchat.oauth2.service.client.test.TestAccounts} instance into its protected resource details.
	 * 
	 * @param clientHolder receives an OAuth2RestTemplate with the authenticated client for the duration of a test
	 ...
	 * @return a rule that wraps test methods in an OAuth2 context
	 */
	public static OAuth2ContextSetup withTestAccounts(RestTemplateHolder clientHolder, com.xchat.oauth2.service.client.test.TestAccounts testAccounts) {
	...
	private OAuth2ContextSetup(RestTemplateHolder clientHolder, com.xchat.oauth2.service.client.test.TestAccounts testAccounts, Environment environment) {
	 ...
	 * {@link com.xchat.oauth2.service.client.test.OAuth2ContextConfiguration &#64;OAuth2ContextConfiguration}.
	 * 
	...
	private OAuth2ProtectedResourceDetails creatResource(Object target, OAuth2ContextConfiguration contextLoader) {
		...
		Constructor<? extends OAuth2ProtectedResourceDetails> constructor = ClassUtils.getConstructorIfAvailable(type,
				com.xchat.oauth2.service.client.test.TestAccounts.class);
