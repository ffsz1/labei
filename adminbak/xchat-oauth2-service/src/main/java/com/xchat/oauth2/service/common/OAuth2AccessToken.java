 ...
 *
 */
@org.codehaus.jackson.map.annotate.JsonSerialize(using = CustomOAuth2AccessTokenJackson1Serializer.class)
@org.codehaus.jackson.map.annotate.JsonDeserialize(using = CustomOAuth2AccessTokenJackson1Deserializer.class)
