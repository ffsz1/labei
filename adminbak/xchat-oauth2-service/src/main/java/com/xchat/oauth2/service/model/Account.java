...
public class Account {
    ...
    public void setAppleUser(String appleUser) {
    ...
    public Byte getIsShuijun() {
        return isShuijun;
    }

    public void setIsShuijun(Byte isShuijun) {
        this.isShuijun = isShuijun;
    }
