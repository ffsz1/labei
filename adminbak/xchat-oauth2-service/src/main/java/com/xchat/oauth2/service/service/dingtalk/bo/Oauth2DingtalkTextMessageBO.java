 ...
 * @time 09:58
 */
public class Oauth2DingtalkTextMessageBO implements Oauth2DingtalkMessageBO {

    private String text;
    private List<String> atMobiles;
    private boolean isAtAll = false;

    public Oauth2DingtalkTextMessageBO() {
    }

    public Oauth2DingtalkTextMessageBO(String text, List<String> atMobiles, boolean isAtAll) {
        this.text = text;
