...
import static com.xchat.oauth2.service.provider.approval.Approval.ApprovalStatus.APPROVED;
 ...
 * 
 */
public class JdbcApprovalStore implements com.xchat.oauth2.service.provider.approval.ApprovalStore {

	private final JdbcTemplate jdbcTemplate;

	private final Log logger = LogFactory.getLog(getClass());

	private final RowMapper<com.xchat.oauth2.service.provider.approval.Approval> rowMapper = new AuthorizationRowMapper();
	...
	@Override
	public boolean addApprovals(final Collection<com.xchat.oauth2.service.provider.approval.Approval> approvals) {
	...
	public boolean revokeApprovals(Collection<com.xchat.oauth2.service.provider.approval.Approval> approvals) {
		...
		boolean success = true;
		for (final com.xchat.oauth2.service.provider.approval.Approval approval : approvals) {
	...
	@Override
	public List<com.xchat.oauth2.service.provider.approval.Approval> getApprovals(String userName, String clientId) {
		return jdbcTemplate.query(findApprovalStatement, rowMapper, userName, clientId);
	}

	private boolean updateApproval(final String sql, final com.xchat.oauth2.service.provider.approval.Approval approval) {
	...
	private static class AuthorizationRowMapper implements RowMapper<com.xchat.oauth2.service.provider.approval.Approval> {

		@Override
		public com.xchat.oauth2.service.provider.approval.Approval mapRow(ResultSet rs, int rowNum) throws SQLException {
