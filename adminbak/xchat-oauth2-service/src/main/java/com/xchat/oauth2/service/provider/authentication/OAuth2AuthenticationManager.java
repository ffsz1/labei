 ...
 */
package com.xchat.oauth2.service.provider.authentication;
...
/**
 * An {@link org.springframework.security.authentication.AuthenticationManager} for OAuth2 protected resources.
 * 
 * @author Dave Syer
 * 
 */
public class OAuth2AuthenticationManager implements AuthenticationManager, InitializingBean {
	 ...
	 * authorization header). Loads an authentication from the {@link com.xchat.oauth2.service.provider.token.ResourceServerTokenServices} and checks that the
	 * resource id is contained in the {@link com.xchat.oauth2.service.provider.AuthorizationRequest} (if one is specified). Also copies authentication
	 ...
	 * @return an {@link com.xchat.oauth2.service.provider.OAuth2Authentication}
	 * 
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		if (authentication.getDetails() instanceof com.xchat.oauth2.service.provider.authentication.OAuth2AuthenticationDetails) {
			com.xchat.oauth2.service.provider.authentication.OAuth2AuthenticationDetails details = (com.xchat.oauth2.service.provider.authentication.OAuth2AuthenticationDetails) authentication.getDetails();
