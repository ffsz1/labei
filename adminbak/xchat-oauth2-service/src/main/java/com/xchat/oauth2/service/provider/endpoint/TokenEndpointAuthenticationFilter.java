...
import com.xchat.oauth2.service.provider.error.OAuth2AuthenticationEntryPoint;
...
/**
 * <p>
 * An optional authentication filter for the {@link com.xchat.oauth2.service.provider.endpoint.TokenEndpoint}. It sits downstream of another filter (usually
 * {@link org.springframework.security.web.authentication.www.BasicAuthenticationFilter}) for the client, and creates an {@link com.xchat.oauth2.service.provider.OAuth2Authentication} for the Spring
 * {@link org.springframework.security.core.context.SecurityContext} if the request also contains user credentials, e.g. as typically would be the case in a
...
public class TokenEndpointAuthenticationFilter implements Filter {
	 ...
	 * {@link com.xchat.oauth2.service.provider.error.OAuth2AuthenticationEntryPoint}.
	 * 
	...
	protected Authentication extractCredentials(HttpServletRequest request) {
		...
		try {
			...
			throw new BadCredentialsException("账号或密码输入错误!");
		}
