                ...
                <div class="box-body pad">
                    <form id="form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content2" name="content" class="form-control" style="width:100%;height:550px;"></textarea>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $(function () {
        ...
        $.ajax({
            type: "post",
            url: "/admin/main/getArticleById.action?id="+$("#blgId").val(),
            dataType: "json",
            success: function(json){
                keditor.html(json.bean.content);
            }
        })
