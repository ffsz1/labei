...
setTimeout(function(){$.ajax({url:allUrl()+"/statpacket/rank",data:{uid:info.uid},success:function(a){if(200===a.code){$(".list-header-avatar").attr("src",a.data.me.avatar);1E3<=a.data.me.seqNo&&(a.data.me.seqNo="1000+");$(".list-header").html('<span>    <p class="list-header-title">\u6392\u540d</p>    <p>'+a.data.me.seqNo+'</p></span><span>    <p></p>    <p class="text-hidden list-header-name">'+
a.data.me.nick+'</p></span><span>    <p class="list-header-title">\u5956\u52b1\u91d1</p>    <p class="FF3B3B">'+a.data.me.packetNum+'\u5143</p></span><i class="list-header-bottom list-header-bottom1"></i><i class="list-header-bottom list-header-bottom2"></i>\n                ');var b="";a.data.rankList.forEach(function(a,c){b=3>c?b+('    <li>        <span class="list-rank-member">            <img src="images/no'+
...
(c+1)+'</text>            <img src="'+a.avatar+'" class="rank-member-avatar">            <p class="text-hidden">'+a.nick+"</p>        </span>        <span>            <p>"+a.packetNum+"\u5143</p>        </span>    </li>   ")});$(".list-content").html(b)}}});$("#btn-share").click(function(){browser.app&&(browser.android?window.androidJsObj.openSharePage():
browser.ios&&window.webkit.messageHandlers.openSharePage.postMessage(null))})},50);
