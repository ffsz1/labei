...
public class WxPubOAuthExample {
     ...
     */
    private static String appId="app_KaPO844ej1G8T40a";

    /**
     * 微信公共号里面获取 openid 时的回跳 URL
     */
    public static String redirectUrl = "http://www.daxiaomao.com/com.xchat.common.wx/config";
    /**
     * 微信公共号的 appId，通常为 `com.xchat.common.wx` 开头的字符串
     */
    public static String wxAppId="wx009d793f92c24eec";
    /**
     * 微信公共号的 secret
     */
    public static String wxAppSecret ="d99ac5ed29071943d1654a40bb0adb68";
