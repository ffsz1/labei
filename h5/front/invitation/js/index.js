...
setTimeout(function() {
    $.ajax({
        ...
        success: function(a) {
            if (200 === a.code) {
                $("#todayRegisterCount").html(a.data.inviteDetail.todayRegisterCount);
                $("#totalRegisterCount").html(a.data.inviteDetail.totalRegisterCount);
                $("#packetNum").html("\uffe5" + a.data.inviteDetail.packetNum);
                var b = "";
                a.data.inviteList.forEach(function(a) {
                    a.createTime = formatDate(new Date(a.createTime));
                    b += '<li>    <span>        <span class="list-member">            <p>\u4f60\u9080\u8bf7\u7684*</p>            <p class="text-hidden">' +
                        a.nick + '</p>            <p>*\u6ce8\u518c\u6210\u529f</p>        </span>        <span class="list-time">            <p>' + a.createTime[0] + "</p>            <p>" + a.createTime[1] + "</p>        </span>    </span>    <span>+" + a.packetNum + "\u5143</span></li>"
                });
                $(".list").html(b)
            }
        }
