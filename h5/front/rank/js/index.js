                ...
                if (200 === a.code) {
                    ...
                    a.data.rankVoList.forEach(function(a, b, e) {
                        3 > b ? c += '<li class="list-top-' + b + '" onclick="memberDetail(' + a.uid + ')">    <img src="images/no' + b + '.png">    <img src="' + a.avatar + '">    <img src="images/no-' + b + '.png">    <p class="text-hiden">' + a.nick + '</p>    <span class="list-top-id">    <img src="images/cl' + a.charmLevel + '.png" class="img-cl" style="display:' +
                            (0 === a.charmLevel ? "none" : "block") + '">    <span>ID:' + a.erbanNo + '</span>    </span>    <span class="list-top-total">    <span>' + (b == 0 ? '' : a.distance) + '</span><span>' + (b == 0 ? '' : '距离前一名') + '</span></span></li>' : d += '<li onclick="memberDetail(' + a.uid + ')">    <span>' + (b + 1) + '</span>    <span class="list-content">    <span>        <img src="' + a.avatar + '">        <span class="list-user">        <span>            <img src="images/cl' + a.charmLevel + '.png" class="img-cl" style="display:' + (0 === a.charmLevel ?
                                "none" : "block") + '">            <p class="text-hiden">' + a.nick + "</p>        </span>        <p>ID:" + a.erbanNo + "</p>        </span>    </span>    <span>        <p>" + a.distance + "</p>        <p>\u8ddd\u79bb\u524d\u4e00\u540d</p>    </span>    </span></li>"
                    });
                ...
                if (200 === a.code) {
                    ...
                    a.data.rankVoList.forEach(function(a, b, e) {
                        3 > b ? c += '<li class="list-top-' + b + '" onclick="memberDetail(' + a.uid + ')">    <img src="images/no' + b + '.png">    <img src="' + a.avatar + '">    <img src="images/no-' + b + '.png">    <p class="text-hiden">' + a.nick + '</p>    <span class="list-top-id">    <span>ID:' +
                            a.erbanNo + '</span>    </span>    <span class="list-top-total">    <span>' + (b == 0 ? '' : a.distance) + '</span><span>' + (b == 0 ? '' : '距离前一名') + '</span></span></li>' : d += '<li onclick="memberDetail(' + a.uid + ')">    <span>' + (b + 1) + '</span>    <span class="list-content">    <span>        <img src="' + a.avatar + '">        <span class="list-user">        <span>             <p class="text-hiden">' + a.nick + "</p>        </span>        <p>ID:" + a.erbanNo + "</p>        </span>    </span>    <span>        <p>" + a.distance + "</p>        <p>\u8ddd\u79bb\u524d\u4e00\u540d</p>    </span>    </span></li>"
                    });
