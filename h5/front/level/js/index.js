...
function init() {
    ...
    tabsSwiper = new Swiper(".swiper-container", {
        ...
        onSlideChangeStart: function onSlideChangeStart() {
            ...
            setTimeout(function() { $("#tabbar-bottom").removeClass().addClass("active" + index) }, 500)
        }
    });
    ...
    $.ajax({ url: allUrl() + "/level/charm/get", data: { uid: info.uid }, success: function(res) { if (res.code === 200) { $(".banner2").html(("\n                    <p>" + res.data.levelName + "</p>\n                    <p>离升级还需增加" + res.data.leftGoldNum + "魅力</p>\n                ")) } } });
}