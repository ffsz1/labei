$(function () {
  ...
  var chargeList = [];
  if (EnvCheck() == 'test') {
    successUrl = 'http://beta.hulelive.com/mm/charge/success.html';
  } else {
    successUrl = 'https://www.hulelive.com/mm/charge/success.html';
  }
  function getBaseMsg() {
    ...
    $.when(ajaxMonList, ajaxUserPurse).done(function (ajax2, ajax3) {
      // var res1 = ajax1[0],
        res2 = ajax2[0],
        res3 = ajax3[0];
