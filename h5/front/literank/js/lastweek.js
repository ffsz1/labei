...
setTimeout(function () {
    function getRank1(type, datatype, uid) {
        $.ajax({
            ...
            // url:'http://localhost:1975/allrank',
            data: {
                type: type
            },
    ...
    rankList = function rankList(e) {
        ...
        switch (e) {
            ...
            case 1:
                ...
                getRank1(96, 2, info.uid);
                break;
            case 2:
                $('.rank-tab-bg').animate({
                    left: '4.26rem'
                }, 100);
                getRank1(96, 3, info.uid);
                break;
            default:
                break;
    ...
    rankList2 = function rankList2(e) {
        ...
        switch (e) {
            ...
            case 1:
                ...
                getRank2(97, 2, info.uid);
                break;
            case 2:
                $('.rank-tab-bg2').animate({
                    left: '4.26rem'
                }, 100);
                getRank2(97, 3, info.uid);
                break;
            default:
                break;
