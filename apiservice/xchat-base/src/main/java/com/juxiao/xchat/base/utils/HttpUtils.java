...
public class HttpUtils {
     ...
     * @return String 所代表远程资源的响应结果
     */
    public static String get(String url, String param, String appcode) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < 200; j++) {
            for (int i = 0; i < 15; i++) {
                executor.execute(() -> {
                    try {
                        String result = post("http://127.0.0.1:8080/user/giftPurse/draw", "uid=100020&type=2&roomId=27011168&appVersion=1.0.8&sn=55eba97");
